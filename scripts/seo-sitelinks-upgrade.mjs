...
const pages = [
  ...
  {
    file: "EN/projects/isa-grimes-interview.html",
    url: "https://www.estivanayramia.com/projects/isa-grimes-interview",
    pageName: "Isa Grimes Interview | Estivan Ayramia",
    shortName: "Isa Grimes Interview",
    type: "WebPage",
    ogType: "article",
    breadcrumb: [
      { name: "Home", item: "https://www.estivanayramia.com/" },
      { name: "Projects", item: "https://www.estivanayramia.com/projects/" },
      { name: "Isa Grimes Interview", item: "https://www.estivanayramia.com/projects/isa-grimes-interview" },
    ],
    description:
      "Read a people-first conversation with Isa Grimes about leadership, support systems, perspective, and how to think about your 20s without forcing the fastest path.",
  },
  {
...
const imageEntries = new Map([
  ...
  ["https://www.estivanayramia.com/projects/isa-grimes-interview", { loc: "https://www.estivanayramia.com/assets/img/logo-ea.webp", title: "Isa Grimes interview project" }],
