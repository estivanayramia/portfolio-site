...
function generateRedirects() {
    ...
    // Optional: keep the directory form of hobbies-games from being indexed directly.
    generatedLines.push('/EN/hobbies-games/    /hobbies-games/    301');
    ...
    const headerLines = [
        ...
        '/index.html                  /                            301',
        '# Root serve (200) - serves a stable directory target (avoids /index.html -> / canonicalization)',
        '/                            /__root/                     200',
        '',
    ...
    const footerLines = [
        '',
        '# Static assets passthrough (prevents 404 capture)',
        '/assets/*                    /assets/:splat              200',
        '/theme.css                   /theme.css                  200',
        '/sw.js                       /sw.js                      200',
