...
├── reference/analytics-implementation.md         # Analytics events reference
├── guides/testing.md           # Local testing guide
├── /es/                 # Spanish versions
│   └── index.html
...
- [ ] Test service worker locally (see guides/testing.md)
...
See `reference/analytics-implementation.md` for complete event reference.
...
See `guides/testing.md` for local testing instructions.
...
- **guides/deployment.md**: Complete deployment guide, troubleshooting
- **reference/analytics-implementation.md**: All analytics events reference
- **guides/testing.md**: Local testing instructions for PWA
