 ...
 */let __userInteracting=!1,__userInteractingTimer=null;const __markUserInteraction=()=>{__userInteracting=!0,__userInteractingTimer&&clearTimeout(__userInteractingTimer),__userInteractingTimer=setTimeout(()=>{__userInteracting=!1},1e3)};["touchstart","touchmove","wheel","scroll"].forEach(r=>{try{window.addEventListener(r,__markUserInteraction,{passive:!0})}catch{window.addEventListener(r,__markUserInteraction)}});const __initDeferredStylesheets=()=>{try{document.querySelectorAll('link[rel="stylesheet"][media="print"][data-media]').forEach(i=>{const t=i.getAttribute("data-media")||"all",o=()=>{try{i.media=t}catch{}};try{i.addEventListener("load",o,{once:!0})}catch{i.addEventListener("load",o)}try{i.addEventListener("error",o,{once:!0})}catch{i.addEventListener("error",o)}setTimeout(()=>{try{i.sheet&&o()}catch{}},0)})}catch{}};__initDeferredStylesheets();const __initPreloadStylesheets=()=>{try{document.querySelectorAll('link[rel="preload"][as="style"][data-onload-rel]').forEach(i=>{const t=i.getAttribute("data-onload-rel")||"stylesheet",o=()=>{try{i.rel=t,i.removeAttribute("data-onload-rel")}catch{}};try{i.addEventListener("load",o,{once:!0})}catch{i.addEventListener("load",o)}try{if(typeof performance<"u"&&typeof performance.getEntriesByName=="function"){const n=i.href,e=n?performance.getEntriesByName(n):[];if(e&&e.length){const s=e[0];s&&typeof s.responseEnd=="number"&&s.responseEnd>0&&o()}}}catch{}})}catch{}};__initPreloadStylesheets();const __initCarouselAndLightbox=()=>{try{const r=document.getElementById("carouselTrack");if(!r||r.dataset&&r.dataset.carouselInit==="1")return;const i=!!(r.dataset&&r.dataset.carouselWrap==="1"),t=Array.from(document.querySelectorAll(".note-card img")),o=t.length>0,n=Array.from(document.querySelectorAll(".carousel-slide"));if(!n.length)return;const e=document.getElementById("carouselPrev"),s=document.getElementById("carouselNext"),u=document.getElementById("carouselDots"),h=document.getElementById("lightbox"),g=document.getElementById("lightbox-image"),C=document.querySelector(".lightbox-close"),M=document.querySelector(".lightbox-prev"),v=document.querySelector(".lightbox-next");if(!e||!s||!u||!h||!g||!C||!M||!v)return;const _=n.map(x=>x.querySelector("img")).filter(Boolean),f=o?t:_;if(!f.length)return;let b=0,L=0;const A=()=>o?window.innerWidth>=1024?5:window.innerWidth>=768?4:window.innerWidth>=640?3:2:window.innerWidth>=768?3:2;let a=A();const $=()=>{try{u.innerHTML=""}catch{for(;u.firstChild;)u.removeChild(u.firstChild)}},U=()=>{try{h.classList.remove("active"),h.setAttribute("aria-hidden","true")}catch{}},D=()=>Math.ceil(n.length/a),R=()=>{try{const x=(n[0]&&n[0].offsetWidth?n[0].offsetWidth:0)+16,I=D();if(o){const j=Math.max(0,n.length-a);b=Math.max(0,Math.min(b,j)),r.style.transform=`translateX(-${b*x}px)`}else b=Math.max(0,Math.min(b,I-1)),r.style.transform=`translateX(-${b*x*a}px)`;Array.from(document.querySelectorAll(".carousel-dot")).forEach((j,W)=>{const k=o?Math.floor(b/a):b;j.classList.toggle("active",W===k)})}catch{}},O=()=>{$();const x=D();for(let I=0;I<x;I++){const j=document.createElement("button");j.className="carousel-dot"+(I===0?" active":"");try{j.setAttribute("aria-label",`Go to page ${I+1}`)}catch{}j.addEventListener("click",()=>{if(o){const W=Math.max(0,n.length-a);b=Math.max(0,Math.min(I*a,W))}else b=i?(I+x)%x:Math.max(0,Math.min(I,x-1));R()}),u.appendChild(j)}R()};e.addEventListener("click",()=>{const x=D();if(o){const I=Math.max(0,n.length-a);i?(b=b-a,b<0&&(b=I)):b=Math.max(0,b-a)}else b=i?(b-1+x)%x:Math.max(0,Math.min(b-1,x-1));R()}),s.addEventListener("click",()=>{const x=D();if(o){const I=Math.max(0,n.length-a);i?(b=b+a,b>I&&(b=0)):b=Math.min(I,b+a)}else b=i?(b+1)%x:Math.max(0,Math.min(b+1,x-1));R()});const q=x=>{const I=f[x];if(I){L=x,g.src=I.src,g.alt=I.alt||"";try{g.style.transform=I.style&&I.style.transform?I.style.transform:""}catch{}if(o){try{M.style.display=x>0?"block":"none"}catch{}try{v.style.display=x<f.length-1?"block":"none"}catch{}}}},B=x=>{q(x),h.classList.add("active"),h.setAttribute("aria-hidden","false")};o?f.forEach((x,I)=>{x.addEventListener("click",()=>B(I))}):n.forEach((x,I)=>{x.addEventListener("click",()=>B(I))}),C.addEventListener("click",U),h.addEventListener("click",x=>{x.target===h&&U()}),M.addEventListener("click",x=>{x&&x.stopPropagation&&x.stopPropagation(),o?L>0&&q(L-1):q((L-1+f.length)%f.length)}),v.addEventListener("click",x=>{x&&x.stopPropagation&&x.stopPropagation(),o?L<f.length-1&&q(L+1):q((L+1)%f.length)}),document.addEventListener("keydown",x=>{h.classList.contains("active")&&(x.key==="Escape"&&U(),x.key==="ArrowLeft"&&M.click(),x.key==="ArrowRight"&&v.click())}),window.addEventListener("resize",()=>{const x=A();x!==a?(a=x,O()):R()});try{r.dataset.carouselInit="1"}catch{}O()}catch{}};document.readyState==="loading"?document.addEventListener("DOMContentLoaded",__initCarouselAndLightbox):__initCarouselAndLightbox();const __collectLogsEnabled=typeof window<"u"&&new URLSearchParams(window.location.search).has("collect-logs"),__collectedLogs=[],__saveCollected=()=>{try{localStorage.setItem("site_collect_logs",JSON.stringify(__collectedLogs.slice(-1e3)))}catch{}},__logCollect=(r,i)=>{if(__collectLogsEnabled)try{const t={t:Date.now(),msg:String(r),data:i||null,scrollY:window.scrollY||0};__collectedLogs.push(t),__saveCollected()}catch{}},__collectLogsParam=typeof window<"u"?new URLSearchParams(window.location.search).get("collect-logs"):null,__collectSnapshots=!!(__collectLogsParam&&/snapshot/i.test(__collectLogsParam)),__maybeTakeSnapshot=(r,i)=>{if(__collectSnapshots)try{const t=document.activeElement,o=e=>{if(!e||!e.getBoundingClientRect)return null;const s=e.getBoundingClientRect();return{tag:e.tagName||null,id:e.id||null,classes:e.className||null,rect:{x:Math.round(s.x),y:Math.round(s.y),w:Math.round(s.width),h:Math.round(s.height),top:Math.round(s.top),left:Math.round(s.left)},focusable:typeof e.tabIndex=="number"?e.tabIndex:null,ariaRole:e.getAttribute&&(e.getAttribute("role")||null)}},n={reason:r||null,ts:Date.now(),scrollY:window.scrollY||0,innerWidth:window.innerWidth||0,innerHeight:window.innerHeight||0,docHeight:document.documentElement.scrollHeight||document.body.scrollHeight||0,target:o(i||document.activeElement)||null,activeElement:o(t)||null};__logCollect("snapshot",n)}catch{}};if(__collectLogsEnabled){let r=null;window.addEventListener("scroll",()=>{r||(r=setTimeout(()=>{__logCollect("scroll",{y:window.scrollY,innerHeight:window.innerHeight,docHeight:document.documentElement.scrollHeight}),r=null},200))},{passive:!0});try{"serviceWorker"in navigator&&navigator.serviceWorker.addEventListener("controllerchange",()=>{__logCollect("controllerchange",{controller:!!navigator.serviceWorker.controller})})}catch{}try{const t=window.location.reload.bind(window.location);window.location.reload=function(){return __logCollect("location.reload called"),t()}}catch{}(()=>{const t=document.createElement("button");t.id="collect-logs-btn",t.textContent="Logs",Object.assign(t.style,{position:"fixed",left:"8px",bottom:"12px",zIndex:99999,padding:"6px 8px",fontSize:"12px",background:"rgba(33,40,66,0.85)",color:"#e1d4c2",border:"1px solid rgba(225,212,194,0.08)",borderRadius:"6px"}),t.addEventListener("click",()=>{try{const o=JSON.stringify(__collectedLogs,null,2),n=new Blob([o],{type:"application/json"}),e=URL.createObjectURL(n),s=document.createElement("a");s.href=e,s.download=`site-logs-${Date.now()}.json`,document.body.appendChild(s),s.click(),s.remove(),URL.revokeObjectURL(e)}catch{const n=window.open();if(n)try{const e=JSON.stringify(__collectedLogs,null,2),s=n.document;s.title="Site logs",s.body.style.margin="0";const u=s.createElement("pre");u.style.margin="0",u.style.padding="12px",u.textContent=e,s.body.appendChild(u)}catch{}}}),document.addEventListener("DOMContentLoaded",()=>{document.body.appendChild(t)})})();try{document.addEventListener("visibilitychange",()=>__logCollect("visibilitychange",{hidden:document.hidden})),window.addEventListener("hashchange",t=>__logCollect("hashchange",{oldURL:t.oldURL,newURL:t.newURL})),window.addEventListener("popstate",t=>__logCollect("popstate",{state:t.state})),window.addEventListener("beforeunload",t=>__logCollect("beforeunload",{})),window.addEventListener("focusin",t=>{try{__logCollect("focusin",{tag:t.target&&t.target.tagName,id:t.target&&t.target.id||null,class:t.target&&t.target.className||null})}catch{}}),(function(){const t=HTMLElement.prototype.focus;t.__wrappedByCollectLogs||(HTMLElement.prototype.focus=function(){try{__logCollect("element.focus.called",{tag:this.tagName,id:this.id||null,options:arguments[0]||null})}catch{}try{__maybeTakeSnapshot&&__maybeTakeSnapshot("focus",this)}catch{}try{return t.apply(this,arguments)}catch{try{return t.call(this)}catch{}}},HTMLElement.prototype.focus.__wrappedByCollectLogs=!0)})(),(function(){const t=Element.prototype;if(!t.__scrollIntoViewLogged){const o=t.scrollIntoView;t.scrollIntoView=function(){try{__logCollect("element.scrollIntoView",{tag:this.tagName,id:this.id||null,args:Array.from(arguments)})}catch{}try{__maybeTakeSnapshot&&__maybeTakeSnapshot("scrollIntoView",this)}catch{}return o.apply(this,arguments)},t.__scrollIntoViewLogged=!0}})();try{const t=window.scrollTo;window.scrollTo=function(){try{__logCollect("window.scrollTo",{args:Array.from(arguments)})}catch{}try{__maybeTakeSnapshot&&__maybeTakeSnapshot("window.scrollTo",null)}catch{}return t.apply(window,arguments)}}catch{}try{const t=window.scrollBy;window.scrollBy=function(){try{__logCollect("window.scrollBy",{args:Array.from(arguments)})}catch{}try{__maybeTakeSnapshot&&__maybeTakeSnapshot("window.scrollBy",null)}catch{}return t.apply(window,arguments)}}catch{}try{const t=window.fetch;window.fetch=function(o,n){try{__logCollect("fetch.start",{url:o&&o.url||o,method:n&&n.method||"GET"})}catch{}return t.apply(this,arguments).then(e=>{try{__logCollect("fetch.end",{url:e&&e.url||o,status:e.status})}catch{}return e}).catch(e=>{try{__logCollect("fetch.error",{url:o,message:e&&e.message})}catch{}throw e})}}catch{}try{let o=function(){const n=new t;let e=null;const s=n.open;n.open=function(h,g){e=g;try{__logCollect("xhr.open",{method:h,url:g})}catch{}return s.apply(n,arguments)};const u=n.send;return n.send=function(){try{__logCollect("xhr.send",{url:e})}catch{}return n.addEventListener("loadend",function(){try{__logCollect("xhr.loadend",{url:e,status:n.status})}catch{}}),u.apply(n,arguments)},n};var WrappedXHR=o;const t=window.XMLHttpRequest;o.prototype=t.prototype,window.XMLHttpRequest=o}catch{}window.addEventListener("resize",()=>__logCollect("resize",{innerWidth:window.innerWidth,innerHeight:window.innerHeight})),window.addEventListener("orientationchange",()=>__logCollect("orientationchange",{orientation:window.orientation}));try{if(navigator.serviceWorker&&navigator.serviceWorker.register){const t=navigator.serviceWorker.register.bind(navigator.serviceWorker);navigator.serviceWorker.register=function(){const o=arguments;try{__logCollect("sw.register.start",{scope:o&&o[1]&&o[1].scope||null,script:o&&o[0]})}catch{}return t.apply(navigator.serviceWorker,arguments).then(n=>{try{__logCollect("sw.register.done",{scope:n.scope})}catch{}try{n.addEventListener("updatefound",()=>__logCollect("sw.updatefound",{})),n.waiting&&__logCollect("sw.waiting",{})}catch{}return n}).catch(n=>{try{__logCollect("sw.register.error",{message:n&&n.message})}catch{}throw n})}}}catch{}try{if(typeof ScrollTrigger<"u"&&ScrollTrigger&&ScrollTrigger.refresh){const t=ScrollTrigger.refresh.bind(ScrollTrigger);ScrollTrigger.refresh=function(){try{__logCollect("ScrollTrigger.refresh",{args:Array.from(arguments)})}catch{}return t.apply(this,arguments)}}}catch{}["touchend","pointerup","mouseup"].forEach(t=>{window.addEventListener(t,o=>{try{__logCollect("gesture."+t,{x:o.changedTouches&&o.changedTouches[0]&&o.changedTouches[0].clientX||o.clientX||null,y:o.changedTouches&&o.changedTouches[0]&&o.changedTouches[0].clientY||o.clientY||null})}catch{}},{passive:!0})});try{let t=document.documentElement.scrollHeight||document.body.scrollHeight||0;new MutationObserver(()=>{try{const n=document.documentElement.scrollHeight||document.body.scrollHeight||0;if(n!==t){__logCollect("docHeight.change",{from:t,to:n});try{__maybeTakeSnapshot&&__maybeTakeSnapshot("docHeight.change",document.documentElement)}catch{}t=n}}catch{}}).observe(document.documentElement||document.body,{childList:!0,subtree:!0,attributes:!0})}catch{}try{const o=n=>{try{const e=JSON.stringify(n,(s,u)=>typeof s=="string"&&/pass(word)?|token|secret|auth|credit|cc-number|card|ssn|cvv/i.test(s)?"[REDACTED]":typeof u=="string"&&u.length>200?u.slice(0,200)+"\u2026[truncated]":u);return e.length>8192?e.slice(0,8192)+"...[truncated]":e}catch{return String(n)}};try{["log","info","warn","error","debug"].forEach(n=>{const e=console[n]&&console[n].bind(console);e&&(console[n]=function(){try{__logCollect("console."+n,{args:Array.from(arguments).map(s=>typeof s=="object"?o(s):String(s))})}catch{}try{(n==="error"||n==="warn")&&__maybeTakeSnapshot&&__maybeTakeSnapshot("console."+n,document.activeElement)}catch{}return e.apply(console,arguments)})})}catch{}window.addEventListener("error",n=>{try{__logCollect("window.error",{message:n.message,filename:n.filename,lineno:n.lineno,colno:n.colno,stack:n.error&&n.error.stack?String(n.error.stack).slice(0,1e3):null});try{__maybeTakeSnapshot&&__maybeTakeSnapshot("error",n&&n.target?n.target:document.activeElement)}catch{}}catch{}}),window.addEventListener("unhandledrejection",n=>{try{__logCollect("unhandledrejection",{reason:n.reason&&(n.reason.stack?String(n.reason.stack).slice(0,1e3):String(n.reason))})}catch{}});try{const n=localStorage.setItem.bind(localStorage);localStorage.setItem=function(e,s){try{__logCollect("localStorage.setItem",{key:String(e),size:s&&s.length||0})}catch{}return n(e,s)}}catch{}try{const n=sessionStorage.setItem.bind(sessionStorage);sessionStorage.setItem=function(e,s){try{__logCollect("sessionStorage.setItem",{key:String(e),size:s&&s.length||0})}catch{}return n(e,s)}}catch{}try{if(navigator&&navigator.sendBeacon){const n=navigator.sendBeacon.bind(navigator);navigator.sendBeacon=function(e,s){try{__logCollect("navigator.sendBeacon",{url:String(e),dataSize:s&&s.size||null})}catch{}return n(e,s)}}}catch{}try{document.addEventListener("click",n=>{try{const e=n.target&&(n.target.closest?n.target.closest("a,button,input,select,textarea,summary"):n.target);if(!e)return;const s=(e.tagName||"").toLowerCase(),u={tag:s,id:e.id||null,classes:e.className||null};s==="a"&&e.href&&(u.href=e.href.length>200?e.href.slice(0,200)+"\u2026":e.href),__logCollect("dom.click",u);try{["a","button","input","textarea","select"].includes(s)&&__maybeTakeSnapshot&&__maybeTakeSnapshot("click",e)}catch{}}catch{}},{passive:!0}),document.addEventListener("submit",n=>{try{const e=n.target;if(!e||!e.tagName||e.tagName.toLowerCase()!=="form")return;const s=Array.from(e.elements||[]).filter(u=>u.name).map(u=>({name:u.name,type:u.type||u.tagName}));__logCollect("form.submit",{action:e.action||null,method:e.method||"GET",fields:s})}catch{}},!0)}catch{}try{document.addEventListener("input",n=>{try{const e=n.target;if(!e)return;const s=e.tagName&&e.tagName.toLowerCase();if(s==="input"||s==="textarea"||s==="select"){const u={tag:s,type:e.type||null,name:e.name||null,valueLength:e.value&&e.value.length||0};__logCollect("input",u)}}catch{}},{passive:!0})}catch{}try{document.addEventListener("selectionchange",()=>{try{const n=document.getSelection&&document.getSelection();if(!n)return;const e=n.toString(),s=n.anchorNode&&n.anchorNode.parentElement&&n.anchorNode.parentElement.tagName;__logCollect("selectionchange",{length:e.length,container:s||null})}catch{}})}catch{}try{["copy","cut","paste"].forEach(n=>{document.addEventListener(n,e=>{try{__logCollect("clipboard."+n,{})}catch{}})})}catch{}try{if("PerformanceObserver"in window)try{new PerformanceObserver(e=>{e.getEntries().forEach(s=>{try{s.entryType==="longtask"?__logCollect("perf.longtask",{duration:Math.round(s.duration)}):s.entryType==="resource"&&__logCollect("perf.resource",{name:s.name,initiatorType:s.initiatorType,duration:Math.round(s.duration)})}catch{}})}).observe({entryTypes:["longtask","resource"]})}catch{}}catch{}try{const n=EventTarget.prototype.addEventListener;EventTarget.prototype.addEventListener=function(e,s,u){try{__logCollect("addEventListener",{target:this&&this.tagName?this.tagName:this&&this.constructor&&this.constructor.name||"unknown",type:e})}catch{}return n.apply(this,arguments)}}catch{}}catch{}}catch{}window.tryGuardedReload=function(t){t=t||{};const o=typeof t.MAX=="number"?t.MAX:3e4,n=typeof t.RETRY=="number"?t.RETRY:500,e=t&&typeof t.fallback=="function"?t.fallback:null,s=Date.now();(function u(){try{if(!(typeof window.__userInteracting<"u"?window.__userInteracting:!1)){try{window.location.reload()}catch{try{window.location.href=window.location.href}catch{}}return}if(Date.now()-s<o){setTimeout(u,n);return}if(e)try{e()}catch{try{window.location.reload()}catch{}}else try{window.location.reload()}catch{try{window.location.href=window.location.href}catch{}}}catch{if(e)try{e()}catch{try{window.location.reload()}catch{}}else try{window.location.reload()}catch{}}})()}}const initDarkMode=()=>{const r=document.getElementById("theme-toggle");if(!r)return;const i=window.matchMedia("(prefers-color-scheme: dark)").matches,t=localStorage.getItem("theme"),o=t||(i?"dark":"light");document.documentElement.setAttribute("data-theme",o),t||localStorage.setItem("theme",o),r.innerHTML=o==="dark"?'<span style="color: #e1d4c2">\u{1F506}</span>':'<span style="color: #212842">\u{1F319}</span>';const n=()=>{const e=document.documentElement.getAttribute("data-theme"),s=e==="light"?"dark":"light";document.documentElement.setAttribute("data-theme",s),localStorage.setItem("theme",s),r.innerHTML=s==="dark"?'<span style="color: #e1d4c2">\u{1F506}</span>':'<span style="color: #212842">\u{1F319}</span>',typeof clarity=="function"&&clarity("event","theme_toggle",{theme:s}),typeof gtag=="function"&&gtag("event","theme_toggle",{event_category:"user_preference",event_label:s}),r.setAttribute("aria-label",`Switch to ${e} mode`)};window.matchMedia("(prefers-color-scheme: dark)").addEventListener("change",e=>{if(!localStorage.getItem("theme_manual")){const s=e.matches?"dark":"light";document.documentElement.setAttribute("data-theme",s),localStorage.setItem("theme",s),r.innerHTML=s==="dark"?'<span style="color: #e1d4c2">\u{1F506}</span>':'<span style="color: #212842">\u{1F319}</span>'}}),r.addEventListener("click",()=>{n(),localStorage.setItem("theme_manual","true")})},initMobileMenu=()=>{const r=document.getElementById("mobile-menu-toggle"),i=document.getElementById("mobile-menu");if(!r||!i)return;let t=0,o=null;const n=()=>o||(o=document.createElement("div"),o.setAttribute("aria-hidden","true"),o.style.position="fixed",o.style.left="0",o.style.top="0",o.style.right="0",o.style.bottom="0",o.style.zIndex="35",o.style.background="rgba(0,0,0,0.35)",o.addEventListener("click",()=>s()),o),e=()=>{t=window.scrollY;try{const g=n();g.parentElement||document.body.appendChild(g)}catch{}i.classList.remove("hidden"),r.setAttribute("aria-expanded","true"),document.body.style.position="fixed",document.body.style.top=`-${t}px`,document.body.style.width="100%";const h=r.querySelector("svg");h&&(h.style.transform="rotate(90deg)")},s=()=>{if(i.classList.contains("hidden"))return;i.classList.add("hidden"),r.setAttribute("aria-expanded","false"),o&&o.parentElement&&o.parentElement.removeChild(o),document.body.style.position="",document.body.style.top="",document.body.style.width="",window.scrollTo(0,t);const h=r.querySelector("svg");h&&(h.style.transform="rotate(0deg)")},u=()=>{r.getAttribute("aria-expanded")==="true"?s():e()};r.addEventListener("click",h=>{h.preventDefault(),h.stopPropagation(),u()}),document.addEventListener("click",h=>{!r.contains(h.target)&&!i.contains(h.target)&&s()}),document.addEventListener("keydown",h=>{h.key==="Escape"&&s()}),window.addEventListener("hashchange",s),window.addEventListener("popstate",s),i.addEventListener("click",h=>{(h.target.tagName==="A"||h.target.closest("a"))&&s()})},initAriaCurrent=()=>{const r=o=>{try{return o?(o=String(o).split("#")[0].split("?")[0],o.endsWith(".html")&&(o=o.slice(0,-5)),o.length>1&&o.endsWith("/")&&(o=o.slice(0,-1)),o||"/"):"/"}catch{return"/"}},i=r(window.location&&window.location.pathname);document.querySelectorAll("header a[href], #mobile-menu a[href]").forEach(o=>{try{const n=o.getAttribute("href");if(!n||/^(https?:)?\/\//i.test(n)||/^mailto:/i.test(n)||n.startsWith("#"))return;r(n)===i?o.setAttribute("aria-current","page"):o.removeAttribute("aria-current")}catch{}})},initAnimations=()=>{const r=typeof window<"u"&&typeof window.matchMedia=="function"&&window.matchMedia("(max-width: 768px)").matches,i=typeof window<"u"&&typeof window.matchMedia=="function"&&window.matchMedia("(prefers-reduced-motion: reduce)").matches;if(document.querySelectorAll("[data-gsap]").forEach(s=>{s.classList.remove("opacity-0","translate-y-8"),s.style.opacity="1",s.style.transform="none"}),typeof gsap>"u"||typeof ScrollTrigger>"u"){console.warn("GSAP or ScrollTrigger not loaded; revealing content without animations.");return}if(i)return;gsap.registerPlugin(ScrollTrigger),document.querySelectorAll('[data-gsap="fade-up"]').forEach(s=>{const u=s.getAttribute("data-gsap-delay")||0;gsap.from(s,{opacity:0,y:20,duration:.4,delay:parseFloat(u)*.5,ease:"power2.out",scrollTrigger:{trigger:s,start:"top 92%",toggleActions:"play none none none"}})});const n=document.querySelector("section:first-of-type");n&&!r&&!n.classList.contains("no-parallax")&&gsap.to(n,{yPercent:20,ease:"none",scrollTrigger:{trigger:n,start:"top top",end:"bottom top",scrub:!0}}),document.querySelectorAll(".card-hover").forEach(s=>{s.addEventListener("mouseenter",()=>{gsap.to(s,{y:-8,duration:.3,ease:"power2.out"})}),s.addEventListener("mouseleave",()=>{gsap.to(s,{y:0,duration:.3,ease:"power2.out"})})})},loadGSAPAndInit=()=>{const r=typeof window<"u"&&typeof window.matchMedia=="function"&&window.matchMedia("(max-width: 768px)").matches,i=()=>{if(window.gsap&&window.ScrollTrigger){initAnimations();return}const t=document.createElement("script");t.src="https://cdnjs.cloudflare.com/ajax/libs/gsap/3.12.2/gsap.min.js",t.onload=()=>{const o=document.createElement("script");o.src="https://cdnjs.cloudflare.com/ajax/libs/gsap/3.12.2/ScrollTrigger.min.js",o.onload=()=>{initAnimations()},document.body.appendChild(o)},document.body.appendChild(t)};if(r){initAnimations();const t=()=>{["scroll","touchstart","mousemove"].forEach(o=>window.removeEventListener(o,t)),i()};["scroll","touchstart","mousemove"].forEach(o=>window.addEventListener(o,t,{once:!0,passive:!0}))}else i()},initSmoothScroll=()=>{document.addEventListener("click",r=>{const i=r.target.closest("a");if(!i)return;const t=i.getAttribute("href");if(t==="#"){r.preventDefault(),r.stopPropagation();return}if(t&&t.startsWith("#")&&t.length>1){const o=document.querySelector(t);if(o){r.preventDefault();const s=o.getBoundingClientRect().top+window.pageYOffset-100;window.scrollTo({top:s,behavior:"smooth"})}}},{passive:!1})},initFormValidation=()=>{const r=document.querySelector('form[action*="formspree.io"]');if(!r)return;const i=r.querySelectorAll("input, textarea, select"),t=r.querySelector('input[type="file"][name="file"]'),o=5*1024*1024,n=["csv","doc","docx","pdf","txt","xls","xlsx","jpg","jpeg","png","gif","svg","webp"],e=r.querySelector('input[name="link"]'),s=v=>{if(!v)return!0;let _=v.trim();/^https?:\/\//i.test(_)||(_=`https://${_}`);let f;try{f=new URL(_)}catch{return!1}return!["javascript:","data:","file:","blob:","chrome:","chrome-extension:"].includes(f.protocol)};e&&e.addEventListener("blur",()=>{e.value&&!/^https?:\/\//i.test(e.value)&&(e.value=`https://${e.value.trim()}`)});const u=(v,_)=>{v.classList.add("border-red-500");let f=v.parentElement.querySelector(".inline-error");f||(f=document.createElement("p"),f.className="inline-error text-xs text-red-600 mt-1",v.parentElement.appendChild(f)),f.textContent=_},h=v=>{v.classList.remove("border-red-500");const _=v.parentElement.querySelector(".inline-error");_&&_.remove()};i.forEach(v=>{v.addEventListener("blur",()=>{v.hasAttribute("required")&&!v.value.trim()?u(v,"This field is required"):v.type==="email"&&v.value&&!v.checkValidity()?u(v,"Please enter a valid email address"):v.type==="url"&&v.value&&!s(v.value)?u(v,"Please enter a valid URL"):v.checkValidity()?h(v):u(v,v.validationMessage||"Invalid input")}),v.addEventListener("input",()=>{v.classList.contains("border-red-500")&&v.checkValidity()&&v.value.trim()&&h(v)})});let g=r.querySelector("#form-status");g||(g=document.createElement("div"),g.id="form-status",g.className="text-sm mt-3",r.appendChild(g));const C=v=>{const _=r.querySelector('button[type="submit"]');_&&(_.disabled=v,_.classList.toggle("loading",v))},M=async()=>{C(!0),g.textContent="";try{const v=new FormData(r);if(t&&t.files&&t.files[0]){const f=t.files[0],b=(f.name.split(".").pop()||"").toLowerCase();if(!n.includes(b)){g.className="text-sm mt-3 text-red-700",g.textContent="Unsupported file type. Please upload one of: CSV, DOC, DOCX, PDF, TXT, XLS, XLSX, JPG, JPEG, PNG, GIF, SVG, WEBP.",C(!1);return}if(f.size>o){g.className="text-sm mt-3 text-red-700",g.textContent="File too large (max 5MB). Please upload a smaller file.",C(!1);return}}if(e&&e.value&&!s(e.value)){g.className="text-sm mt-3 text-red-700",g.textContent="Please enter a valid link starting with https:// or http://",C(!1);return}if((await fetch(r.action,{method:"POST",body:v,headers:{Accept:"application/json"},mode:"cors",credentials:"omit"})).ok){r.reset();const f=r.parentElement;f&&(f.innerHTML=`
    ...
    `;const h=i.querySelector("#mg-canvas"),g=i.querySelector("#mg-score"),C=i.querySelector("#mg-mult"),M=i.querySelector("#mg-best"),v=i.querySelector("#mg-lives"),_=i.querySelector("#mg-start"),f=h.getContext("2d"),b=window.devicePixelRatio||1,a={running:!1,score:0,best:n,w:0,h:0,paddle:{x:0,y:0,w:90,h:12},orbs:[],particles:[],lastSpawn:0,orbInterval:900,baseSpeed:2.2,lives:3,combo:0,comboTimer:0,shake:0,t:0},$=()=>{const k=h.getBoundingClientRect();h.width=Math.floor(k.width*b),h.height=Math.floor(320*b),a.w=h.width,a.h=h.height,a.paddle.y=a.h-30*b,a.paddle.x===0&&(a.paddle.x=a.w/2-a.paddle.w*b/2),B()},U=k=>"\u2764\u2764\u2764".slice(0,k),D=k=>{navigator.vibrate&&navigator.vibrate(k)},R=(k,l,m="#212842",c=10)=>{for(let y=0;y<c;y++)a.particles.push({x:k,y:l,vx:(Math.random()-.5)*3*b,vy:-Math.random()*3*b,life:600,color:m,r:2*b})},O=()=>{const k=(8+Math.random()*2)*b,l=k+Math.random()*(a.w-2*k),m=Math.random()<.15,c=m?"#eab308":"#362017",y=(a.baseSpeed+Math.random()*1.5+a.score*.01)*b;a.orbs.push({x:l,y:k+2,r:k,vy:y,color:c,type:m?"gold":"normal"})},q=()=>{const k=f.createLinearGradient(0,0,a.w,a.h),l=(Math.sin(a.t*.001)+1)/2;k.addColorStop(0,`rgba(${210+20*l|0}, ${200+10*l|0}, 180, 0.6)`),k.addColorStop(1,"rgba(200, 190, 170, 0.6)"),f.fillStyle=k,f.fillRect(0,0,a.w,a.h)},B=()=>{const k=a.shake?Math.random()*a.shake-a.shake/2:0,l=a.shake?Math.random()*a.shake-a.shake/2:0;f.setTransform(1,0,0,1,0,0),f.clearRect(0,0,a.w,a.h),f.translate(k,l),q();const m=Math.min(a.combo,6);f.shadowColor="rgba(33,40,66,0.6)",f.shadowBlur=m*2*b,f.fillStyle="#212842",f.fillRect(a.paddle.x,a.paddle.y,a.paddle.w*b,a.paddle.h*b),f.shadowBlur=0,a.particles.forEach(c=>{f.globalAlpha=Math.max(0,c.life/600),f.fillStyle=c.color,f.beginPath(),f.arc(c.x,c.y,c.r,0,Math.PI*2),f.fill(),f.globalAlpha=1}),a.orbs.forEach(c=>{f.beginPath(),f.fillStyle=c.color,f.shadowColor=c.type==="gold"?"rgba(234,179,8,0.6)":"rgba(54,32,23,0.3)",f.shadowBlur=c.type==="gold"?8*b:4*b,f.arc(c.x,c.y,c.r,0,Math.PI*2),f.fill(),f.shadowBlur=0})},x=k=>{if(!a.running)return;a.last||(a.last=k);const l=k-a.last;a.t+=l,a.last=k,a.comboTimer+=l,a.comboTimer>1600&&a.combo>0&&(a.combo=0,C.textContent="x1"),a.shake>0&&(a.shake=Math.max(0,a.shake-.5*b)),k-a.lastSpawn>a.orbInterval&&(O(),a.lastSpawn=k,a.orbInterval>420&&(a.orbInterval-=8));const m=a.paddle.w*b,c=a.paddle.h*b,y=a.paddle.x,S=a.paddle.y;a.orbs.forEach(w=>{w.y+=w.vy});for(let w=a.particles.length-1;w>=0;w--){const d=a.particles[w];d.x+=d.vx,d.y+=d.vy,d.vy+=.04*b,d.life-=l,d.life<=0&&a.particles.splice(w,1)}for(let w=a.orbs.length-1;w>=0;w--){const d=a.orbs[w];if(d.y+d.r>=S&&d.x>=y&&d.x<=y+m){const p=d.type==="gold"?5:1;a.combo=Math.min(a.combo+1,9),a.comboTimer=0;const E=1+Math.floor(a.combo/3);a.score+=p*E,g.textContent=a.score,C.textContent="x"+E,R(d.x,S,d.color,d.type==="gold"?18:10),a.shake=Math.min(6*b,a.shake+(d.type==="gold"?4:2)),D(d.type==="gold"?25:12),a.orbs.splice(w,1),a.score%10===0&&R(d.x,d.y,"#e1d4c2",24)}else if(d.y-d.r>a.h&&(a.orbs.splice(w,1),a.lives-=1,v.textContent=U(a.lives),a.combo=0,C.textContent="x1",a.shake=10*b,D(60),a.lives<=0)){I();return}}B(),requestAnimationFrame(x)},I=()=>{a.running=!1,a.score>a.best&&(a.best=a.score,localStorage.setItem(t,String(a.best)),M.textContent=a.best),_.textContent="Restart";const k=document.createElement("div");k.className="mt-3 text-sm text-indigodeep mg-end",k.innerHTML=`
        ...
        `,i.appendChild(k);const l=k.querySelector("#mg-name"),m=k.querySelector("#mg-save"),c=k.querySelector("#mg-view"),y=k.querySelector("#mg-name-error"),S=k.querySelector("#mg-leaderboard");if(!m||!c)return;const w=["fuck","shit","bitch","cunt","dick","piss","cock","asshole","retard","fag","faggot","nigger","nigga","spic","chink","whore","slut","bastard","twat","rape","cum","penis","vagina"],d=P=>P.toLowerCase().replace(/[@]/g,"a").replace(/[$]/g,"s").replace(/0/g,"o").replace(/1/g,"i").replace(/3/g,"e").replace(/4/g,"a").replace(/5/g,"s").replace(/7/g,"t"),p=P=>{const T=d(P).replace(/[_-]/g,"");return!w.some(N=>T.includes(N))},E=/^[A-Za-z0-9_-]{3,16}$/,H=()=>{if(!S)return;let P="<table class='w-full text-xs'><thead><tr class='text-indigodeep'><th class='text-left pb-1'>#</th><th class='text-left pb-1'>User</th><th class='text-right pb-1'>Score</th></tr></thead><tbody>";u.slice(0,10).forEach((T,N)=>{P+=`<tr class='border-t border-chocolate/10'><td class='py-1 pr-2'>${N+1}</td><td class='py-1 pr-2'>${T.name}</td><td class='py-1 text-right'>${T.score}</td></tr>`}),u.length===0&&(P+="<tr><td colspan='3' class='py-2 text-ink/60'>No scores yet.</td></tr>"),P+="</tbody></table>",S.innerHTML=P};c.addEventListener("click",()=>{S.classList.toggle("hidden"),S.classList.contains("hidden")?c.textContent="View Leaderboard":(H(),c.textContent="Hide Leaderboard")}),m.addEventListener("click",()=>{const P=(l.value||"").trim();if(!E.test(P)){y.textContent="Username must be 3-16 chars: letters, numbers, _ or - only.",y.classList.remove("hidden");return}if(!p(P)){y.textContent="Please choose a different name (profanity not allowed).",y.classList.remove("hidden");return}y.classList.add("hidden"),u.push({name:P,score:a.score,ts:Date.now()}),u.sort((T,N)=>N.score-T.score||T.ts-N.ts),u=u.slice(0,25),s(u),H(),S.classList.remove("hidden"),c.textContent="Hide Leaderboard",m.disabled=!0,m.textContent="Saved"})},j=()=>{a.running=!0,a.score=0,g.textContent="0",a.orbs=[],a.particles=[],a.lastSpawn=0,a.orbInterval=900,a.baseSpeed=2.2,a.lives=3,v.textContent=U(3),a.combo=0,C.textContent="x1",a.t=0,a.shake=0,[...i.querySelectorAll(".mg-end")].forEach(k=>k.remove()),requestAnimationFrame(x)},W=k=>{const l=h.getBoundingClientRect();let m=(k-l.left)*b-a.paddle.w*b/2;m=Math.max(0,Math.min(m,a.w-a.paddle.w*b)),a.paddle.x=m};h.addEventListener("mousemove",k=>W(k.clientX)),h.addEventListener("touchstart",k=>{k.touches[0]&&W(k.touches[0].clientX)},{passive:!0}),h.addEventListener("touchmove",k=>{k.touches[0]&&W(k.touches[0].clientX)},{passive:!0}),window.addEventListener("keydown",k=>{k.key==="ArrowLeft"&&W(h.getBoundingClientRect().left+a.paddle.x/b-24),k.key==="ArrowRight"&&W(h.getBoundingClientRect().left+a.paddle.x/b+24)}),_.addEventListener("click",()=>{_.textContent="Playing...",j()}),window.addEventListener("resize",$),$(),B()},initLazyLoading=()=>{const r=document.querySelectorAll("img[data-src]");if("IntersectionObserver"in window){const i=new IntersectionObserver((t,o)=>{t.forEach(n=>{if(n.isIntersecting){const e=n.target;e.src=e.dataset.src,e.removeAttribute("data-src"),i.unobserve(e)}})});r.forEach(t=>i.observe(t))}else r.forEach(i=>{i.src=i.dataset.src,i.removeAttribute("data-src")})},initPdfPreviews=()=>{try{document.querySelectorAll(".preview-panel").forEach(r=>{try{const i=r.closest("section")||r.parentElement;if(!i)return;const t=i.querySelector('a[href$=".pdf"]');if(!t)return;const o=t.href;r.dataset.pdfLoaded="true";const n=g=>{try{r.innerHTML='<div class="rounded-xl border border-chocolate/20 bg-white/40 overflow-hidden p-8 text-center"><p class="text-sm text-chocolate/70">Inline PDF preview may be blocked by hosting or browser settings. Use the buttons below to open or download the deck.</p></div>',__logCollect&&__logCollect("pdf.preview.fallback",{url:o,reason:g})}catch{}};r.innerHTML=`<div class="py-12 bg-white/30 rounded-xl border border-chocolate/10 flex items-center justify-center min-h-[480px]">
  <div class="text-sm text-chocolate/60 flex items-center gap-2"><svg class="animate-spin h-4 w-4" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"><circle class="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" stroke-width="4"></circle><path class="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z"></path></svg> Loading preview\u2026</div>
        ...
        `,document.body.appendChild(D);const R=D.querySelector(".achievement-close"),O=()=>{D.classList.remove("show"),setTimeout(()=>D.remove(),300)};R.addEventListener("click",O),setTimeout(()=>D.classList.add("show"),100);const q=setTimeout(()=>{document.body.contains(D)&&O()},4e3);R.addEventListener("click",()=>clearTimeout(q))},s=()=>{const g="portfolio_visited_pages";try{const C=JSON.parse(localStorage.getItem(g)||"[]"),M=window.location.pathname.split("/").pop()||"index.html";C.includes(M)||(C.push(M),localStorage.setItem(g,JSON.stringify(C))),["index.html","overview.html","deep-dive.html","about.html","projects.html","contact.html"].every(f=>C.includes(f))&&n("explorer"),M==="deep-dive.html"&&n("reader")}catch{}},u=()=>{const g=document.getElementById("theme-toggle");g&&g.addEventListener("click",()=>n("nightOwl"))},h=()=>{document.querySelectorAll('a[href*="linkedin.com"], a[href*="github.com"]').forEach(g=>{g.addEventListener("click",()=>n("networker"))})};s(),u(),h(),window.unlockAchievement=n},initKonamiCode=()=>{const r=["ArrowUp","ArrowUp","ArrowDown","ArrowDown","ArrowLeft","ArrowRight","ArrowLeft","ArrowRight","b","a"];let i=0;const t=()=>{window.dispatchEvent(new Event("konami-activated")),window.unlockAchievement&&window.unlockAchievement("konami");const n=getCurrentLanguage(),e=translations.konami[n],s=document.createElement("div");s.className="konami-modal",s.innerHTML=`
        ...
        <div class="max-w-7xl mx-auto px-6 lg:px-12">
            ...
            `,document.body&&document.body.appendChild(i)}}catch{}}},__arcadeStorageKey="site_played_games_v1",__safeJsonParse=(r,i)=>{try{return JSON.parse(r)}catch{return i}},__getPlayedGames=()=>{try{const r=localStorage.getItem(__arcadeStorageKey),i=__safeJsonParse(r,{});return i&&typeof i=="object"?i:{}}catch{return{}}},__setPlayedGames=r=>{try{localStorage.setItem(__arcadeStorageKey,JSON.stringify(r||{}))}catch{}},__normalizePath=r=>{try{return(r||"/").replace(/\/+$/,"")||"/"}catch{return"/"}},__getCurrentGameId=()=>{try{const r=document.body&&document.body.getAttribute("data-arcade-achievements-filter");if(r&&/^mini_/.test(r))return r.replace(/^mini_/,"");if(r&&/^arcade_/.test(r))return r.replace(/^arcade_/,"");const i=__normalizePath(window.location.pathname||"/"),t=i.match(/^\/hobbies-games\/(.+)$/);if(t&&t[1])return t[1].replace(/\.html$/i,"");const o=i.split("/").pop()||"";return o.endsWith(".html")?o.replace(/\.html$/i,""):null}catch{return null}},__markGamePlayed=r=>{if(r)try{const i=__getPlayedGames();i[r]={lastPlayedAt:Date.now()},__setPlayedGames(i)}catch{}},__hashString=r=>{let i=2166136261;for(let t=0;t<r.length;t++)i^=r.charCodeAt(t),i=Math.imul(i,16777619);return i>>>0},__mulberry32=r=>{let i=r>>>0;return function(){i+=1831565813;let t=Math.imul(i^i>>>15,1|i);return t^=t+Math.imul(t^t>>>7,61|t),((t^t>>>14)>>>0)/4294967296}},__shuffleInPlace=(r,i)=>{for(let t=r.length-1;t>0;t--){const o=Math.floor(i()*(t+1));[r[t],r[o]]=[r[o],r[t]]}return r},__GAME_CATALOG=[{id:"snake",href:"/snake.html",emoji:"\u{1F40D}",title:"Snake",subtitle:"Classic growth game"},{id:"breaker",href:"/breaker.html",emoji:"\u{1F9F1}",title:"Block Breaker",subtitle:"Smash the bricks"},{id:"2048",href:"/2048.html",emoji:"\u{1F9E9}",title:"2048",subtitle:"Merge the numbers"},{id:"invaders",href:"/invaders.html",emoji:"\u{1F47E}",title:"Space Invaders",subtitle:"Defend the earth"},{id:"racer",href:"/hobbies-games/racer.html",emoji:"\u{1F3CE}\uFE0F",title:"Racer",subtitle:"Fast reflex racing"},{id:"oh-flip",href:"/hobbies-games/oh-flip.html",emoji:"\u{1F938}",title:"Oh Flip",subtitle:"Timing + tricks"},{id:"onoff",href:"/hobbies-games/onoff.html",emoji:"\u26A1",title:"ON/OFF",subtitle:"Switch-based puzzle"},{id:"1024-moves",href:"/hobbies-games/1024-moves.html",emoji:"\u{1F9E0}",title:"1024 Moves",subtitle:"Move-limited strategy"},{id:"back-attacker",href:"/hobbies-games/back-attacker.html",emoji:"\u{1F6E1}\uFE0F",title:"Back Attacker",subtitle:"Survive the attacks"},{id:"nano-wirebot",href:"/hobbies-games/nano-wirebot.html",emoji:"\u{1F916}",title:"Nano Wirebot",subtitle:"Precision platforming"},{id:"off-the-line",href:"/hobbies-games/off-the-line.html",emoji:"\u{1F9F7}",title:"Off The Line",subtitle:"Don\u2019t cross the line"},{id:"pizza-undelivery",href:"/hobbies-games/pizza-undelivery.html",emoji:"\u{1F355}",title:"Pizza Undelivery",subtitle:"Fast food chaos"},{id:"the-matr13k",href:"/hobbies-games/the-matr13k.html",emoji:"\u{1F9EC}",title:"The Matr13k",subtitle:"Pattern puzzle"},{id:"triangle-back-to-home",href:"/hobbies-games/triangle-back-to-home.html",emoji:"\u{1F53A}",title:"Triangle: Back to Home",subtitle:"Geometry adventure"},{id:"xx142-b2exe",href:"/hobbies-games/xx142-b2exe.html",emoji:"\u{1F9EA}",title:"XX142-B2EXE",subtitle:"Experimental arcade"}],__renderSuggestionGrid=(r,i)=>{if(!r)return;const t=i&&i.count?i.count:6,o=i&&i.currentId?i.currentId:null,n=__getPlayedGames(),e=Date.now(),s=__GAME_CATALOG.filter(L=>L&&L.id&&L.href&&L.id!==o),u=s.filter(L=>!n[L.id]),h=s.filter(L=>!!n[L.id]),g=Math.floor(e/864e5),C=parseInt(sessionStorage.getItem("site_suggest_nonce")||"0",10)||0;sessionStorage.setItem("site_suggest_nonce",String(C+1));const M=g*1e3+C+__hashString(String(window.location.pathname||"/")),v=__mulberry32(M);__shuffleInPlace(u,v),h.sort((L,A)=>{const a=n[L.id]&&n[L.id].lastPlayedAt?n[L.id].lastPlayedAt:0,$=n[A.id]&&n[A.id].lastPlayedAt?n[A.id].lastPlayedAt:0;return a-$}),__shuffleInPlace(h,v);const _=[];for(const L of u){if(_.length>=t)break;_.push(L)}for(const L of h){if(_.length>=t)break;_.push(L)}const f="flex flex-col items-center p-4 bg-white/5 rounded-xl hover:bg-white/10 transition-all group border border-white/5 hover:border-white/20",b="text-4xl mb-3 group-hover:scale-110 transition-transform";r.innerHTML=_.map(L=>`
        <a href="${L.href}" class="${f}" data-game-id="${L.id}">
            <div class="${b}">${L.emoji||"\u{1F3AE}"}</div>
            <div class="font-bold text-sm">${L.title||L.id}</div>
            <div class="text-xs opacity-60 mt-1">${L.subtitle||""}</div>
        </a>
    `).join("")},__initDynamicGameSuggestions=()=>{try{const r=__getCurrentGameId();r&&__markGamePlayed(r);const i=new Set;document.querySelectorAll('a[class*="bg-white/5"][class*="rounded-xl"][class*="hover:bg-white/10"]').forEach(t=>{const o=t.closest(".grid");o&&i.add(o)}),i.forEach(t=>{const o=t.querySelectorAll("a");!o||o.length<4||__renderSuggestionGrid(t,{count:6,currentId:r})})}catch{}},init=()=>{console.log("%c Designed by Estivan Ayramia ","background: #212842; color: #e1d4c2; padding: 4px; border-radius: 4px;"),document.readyState==="loading"?document.addEventListener("DOMContentLoaded",()=>{__ensureStandardEnglishChrome(),initDarkMode(),initAriaCurrent(),initMobileMenu(),__initDynamicGameSuggestions(),loadGSAPAndInit(),initSmoothScroll(),initFormValidation(),initLazyLoading(),initScrollToTop(),initPdfPreviews(),initAchievements(),initKonamiCode(),initPWA(),initAnalytics(),initPerformanceMonitoring(),initPhase2()}):(__ensureStandardEnglishChrome(),initDarkMode(),initAriaCurrent(),initMobileMenu(),__initDynamicGameSuggestions(),loadGSAPAndInit(),initSmoothScroll(),initFormValidation(),initLazyLoading(),initScrollToTop(),initPdfPreviews(),initAchievements(),initKonamiCode(),initPWA(),initAnalytics(),initPerformanceMonitoring(),initPhase2())};init(),document.addEventListener("DOMContentLoaded",()=>{const r="https://portfolio-chat.eayramia.workers.dev/chat",i="/assets/docs/Estivan-Ayramia-Resume.pdf",t="https://www.linkedin.com/in/estivanayramia",n={logistics:{title:"Logistics System",summary:"A systems-focused project centered on execution, coordination, and operational clarity.",img:"/assets/img/project-logistics.jpg",link:"/projects/logistics"},conflict:{title:"Conflict Playbook",summary:"A practical framework for navigating conflict with structure, empathy, and outcomes.",img:"/assets/img/project-conflict.jpg",link:"/deep-dive#conflict"},discipline:{title:"Discipline Routine",summary:"A repeatable routine and mindset system for sustainable discipline and follow-through.",img:"/assets/img/project-discipline.jpg",link:"/projects/discipline"},website:{title:"Portfolio Website",summary:"The site you\u2019re on\u2014built for speed, clarity, and a clean browsing experience.",img:"/assets/img/og-image.png",link:"/"}},e={widget:document.getElementById("chat-widget"),window:document.getElementById("chat-window"),header:document.getElementById("chat-header"),messages:document.getElementById("chat-messages"),input:document.getElementById("chat-input"),sendBtn:document.getElementById("send-btn"),toggleBtn:document.getElementById("chat-toggle"),closeBtn:document.getElementById("close-chat"),bubble:document.getElementById("welcome-bubble"),chipsContainer:document.getElementById("chat-chips"),suggestionsBtn:document.getElementById("suggestions-btn"),suggestionsContainer:document.querySelector('[data-chat-suggestions="container"]'),suggestionsToggle:document.querySelector('[data-chat-suggestions-toggle="button"]'),suggestionsClose:null};(function(){try{if(window.CSS&&CSS.supports&&CSS.supports("animation-timeline","scroll()"))return}catch{}const m=document.querySelector(".scroll-progress");if(!m)return;let c=!1;function y(){const w=document.documentElement,d=window.scrollY||w.scrollTop||0,p=Math.max((w.scrollHeight||document.body.scrollHeight||0)-window.innerHeight,0),E=p>0?Math.min(1,Math.max(0,d/p)):0;m.style.setProperty("--scroll-scale",E),c=!1}const S=function(){c||(c=!0,requestAnimationFrame(y))};window.addEventListener("scroll",S,{passive:!0}),window.addEventListener("resize",S,{passive:!0}),requestAnimationFrame(y)})();const s=document.documentElement.lang||"en";s==="ar"&&e.widget?(e.widget.style.left="1rem",e.widget.style.right="auto",e.bubble&&(e.bubble.style.left="1rem",e.bubble.style.right="auto")):e.widget&&(e.widget.style.right="1rem",e.widget.style.left="auto",e.bubble&&(e.bubble.style.right="1rem",e.bubble.style.left="auto"));let u=[],h=!1,g=!1;const C=`savonie_history:${s}:${window.location.pathname||"/"}`,M=50;function v(){try{const l=[],m=window.location.pathname||"/";l.push(`path: ${m}`),l.push(`title: ${document.title||""}`);const c=Array.from(document.querySelectorAll("h1, h2")).map(S=>(S.textContent||"").trim()).filter(Boolean).slice(0,10);c.length&&(l.push("headings:"),c.forEach(S=>l.push(`- ${S}`)));const y=l.join(`
`);return y.length>3500?y.slice(0,3500):y}catch{return`${window.location.pathname||"/"} | ${document.title||""}`}}try{const l=sessionStorage.getItem(C);l&&(u=JSON.parse(l),u.forEach(m=>{if(m&&m.kind==="card"){W(m.cardId);return}if(!m||m.kind!=="text")return;const c=document.createElement("div"),y="bg-[#212842] text-white rounded-tr-none self-end ml-auto",S="bg-white text-[#362017] rounded-tl-none border border-[#362017]/5 self-start";c.className=`p-3 rounded-lg shadow-sm max-w-[85%] mb-3 text-sm leading-relaxed ${m.sender==="user"?y:S}`,m.sender==="bot"?c.replaceChildren(O(m.text)):c.textContent=m.text,e.messages?.appendChild(c)}),setTimeout(()=>{e.messages&&(e.messages.scrollTop=e.messages.scrollHeight)},100))}catch{}if(u.length===0){const l=document.documentElement.lang||"en",m=translations.chat.welcome[l]||"Hello! I am Savonie. Ask me anything about Estivan.";j(m,"bot",!1)}if(e.chipsContainer){const l=document.documentElement.lang||"en",m=translations.chat.defaultChips[l]||translations.chat.defaultChips.en;q(m)}g=!0;const _=parseInt(sessionStorage.getItem("savonie_bubble_count")||"0");_<2&&setTimeout(()=>{e.window?.classList.contains("hidden")&&u.length===0&&(e.bubble?.classList.remove("opacity-0","translate-y-4"),e.bubble?.classList.add("opacity-100","translate-y-0"),sessionStorage.setItem("savonie_bubble_count",(_+1).toString()))},2500),e.toggleBtn?.addEventListener("click",B),e.closeBtn?.addEventListener("click",B),e.sendBtn?.addEventListener("click",I),e.input?.addEventListener("keydown",l=>{l.key!=="Enter"||l.target&&l.target.tagName==="TEXTAREA"&&l.shiftKey||(l.preventDefault(),I())});function f(l){if(!e.suggestionsContainer){console.log("[Savonie DEBUG] setSuggestionsVisible called but no suggestions container");return}l?(e.suggestionsContainer.classList.remove("savonie-suggestions-hidden"),e.suggestionsContainer.removeAttribute("hidden"),e.suggestionsContainer.style.display="flex"):(e.suggestionsContainer.classList.add("savonie-suggestions-hidden"),e.suggestionsContainer.setAttribute("hidden","true"),e.suggestionsContainer.style.display="none"),console.log("[Savonie DEBUG] setSuggestionsVisible ->",l,"classes:",e.suggestionsContainer.className)}function b(){if(!e.suggestionsContainer){console.log("[Savonie DEBUG] No suggestions container found on this page");return}e.suggestionsToggle?e.suggestionsToggle.addEventListener("click",()=>{const m=e.suggestionsContainer.classList.contains("savonie-suggestions-hidden")||e.suggestionsContainer.hasAttribute("hidden")||e.suggestionsContainer.style.display==="none";console.log("[Savonie DEBUG] Lightbulb clicked, nextVisible =",m),f(m)}):console.log("[Savonie DEBUG] No suggestions toggle (lightbulb) found"),console.log("[Savonie DEBUG] attachSuggestionHandlers complete")}b(),e.chipsContainer&&e.chipsContainer.querySelectorAll(".chip-btn").forEach(l=>{l.addEventListener("click",()=>{e.input&&(e.input.value=l.textContent,I())})});const L=document.getElementById("mic-btn");let A=null,a=!1;if(L&&("webkitSpeechRecognition"in window||"SpeechRecognition"in window)){const l=window.SpeechRecognition||window.webkitSpeechRecognition;A=new l,A.continuous=!1,A.interimResults=!1,A.lang=document.documentElement.lang||"en-US",A.onstart=()=>{a=!0,L.classList.add("listening"),L.setAttribute("aria-label","Listening...")},A.onend=()=>{a=!1,L.classList.remove("listening"),L.setAttribute("aria-label","Voice input")},A.onresult=m=>{const c=m.results[0][0].transcript;if(e.input&&c){e.input.value=c;try{e.input.focus({preventScroll:!0})}catch{e.input.focus()}}},A.onerror=m=>{console.warn("Speech recognition error:",m.error),a=!1,L.classList.remove("listening")},L.addEventListener("click",()=>{a?A.stop():A.start()})}else L&&(L.style.display="none");function $(l){const m=[],c=[...l].reverse().find(d=>d.sender==="user")?.text?.toLowerCase()||"",y=[...l].reverse().find(d=>d.sender==="bot")?.text?.toLowerCase()||"",S=U(c),w=translations.chat.contextualSuggestions;return c.includes("skill")||c.includes("technology")||c.includes("expertise")||c.includes("habilidad")||c.includes("tecnolog\xEDa")||c.includes("experiencia")||c.includes("\u0645\u0647\u0627\u0631\u0629")||c.includes("\u062A\u0643\u0646\u0648\u0644\u0648\u062C\u064A\u0627")||c.includes("\u062E\u0628\u0631\u0629")?m.push(...w[S]?.skills||["What projects have you worked on?","Tell me about your experience","What are you learning currently?"]):c.includes("background")||c.includes("experience")||c.includes("career")||c.includes("fondo")||c.includes("experiencia")||c.includes("carrera")||c.includes("\u062E\u0644\u0641\u064A\u0629")||c.includes("\u062E\u0628\u0631\u0629")||c.includes("\u0645\u0633\u064A\u0631\u0629")?m.push(...w[S]?.background||["What are your main skills?","Tell me about your education","What industries have you worked in?"]):c.includes("project")||c.includes("work")||c.includes("portfolio")||c.includes("proyecto")||c.includes("trabajo")||c.includes("portafolio")||c.includes("\u0645\u0634\u0631\u0648\u0639")||c.includes("\u0639\u0645\u0644")||c.includes("\u0645\u062D\u0641\u0638\u0629")?m.push(...w[S]?.projects||["Can you show me your code?","What technologies did you use?","How long did it take to build?"]):c.includes("contact")||c.includes("reach")||c.includes("email")||c.includes("contacto")||c.includes("alcanzar")||c.includes("correo")||c.includes("\u0627\u062A\u0635\u0627\u0644")||c.includes("\u0627\u0644\u0648\u0635\u0648\u0644")||c.includes("\u0628\u0631\u064A\u062F")?m.push(...w[S]?.contact||["Are you available for freelance work?","What's your typical response time?","Do you work remotely?"]):c.includes("education")||c.includes("study")||c.includes("learn")||c.includes("educaci\xF3n")||c.includes("estudio")||c.includes("aprender")||c.includes("\u062A\u0639\u0644\u064A\u0645")||c.includes("\u062F\u0631\u0627\u0633\u0629")||c.includes("\u062A\u0639\u0644\u0645")?m.push(...w[S]?.education||["What certifications do you have?","What's your favorite programming language?","How do you stay updated with technology?"]):y.includes("project")||y.includes("work")||y.includes("proyecto")||y.includes("trabajo")||y.includes("\u0645\u0634\u0631\u0648\u0639")||y.includes("\u0639\u0645\u0644")?m.push(...w[S]?.projectResponse||["Can you tell me more about that project?","What challenges did you face?","What did you learn from it?"]):y.includes("skill")||y.includes("technology")||y.includes("habilidad")||y.includes("tecnolog\xEDa")||y.includes("\u0645\u0647\u0627\u0631\u0629")||y.includes("\u062A\u0643\u0646\u0648\u0644\u0648\u062C\u064A\u0627")?m.push(...w[S]?.skillResponse||["How did you learn that?","Have you used it in projects?","What's your proficiency level?"]):l.length<4&&m.push(...w[S]?.early||["What are your main skills?","Tell me about your background","What projects are you proud of?"]),m.slice(0,3)}function U(l){return l?/[\u0600-\u06FF]/.test(l)?"ar":/\b(qué|como|dónde|cuándo|por qué|está|son|tiene|trabajo|habilidades?|experiencia|proyecto|contacto)\b/i.test(l)?"es":"en":"en"}function D(l){const m=document.createDocumentFragment();if(!l)return m;const c=d=>{try{const p=String(d).trim();if(p.startsWith("/"))return p;const E=new URL(p);return E.protocol!=="http:"&&E.protocol!=="https:"?null:E.toString()}catch{return null}},y=(d,p)=>{const E=document.createElement("a");E.href=d;const H=d.startsWith("/");return E.target=H?"_self":"_blank",H||(E.rel="noopener noreferrer"),E.className="text-[#212842] underline hover:text-[#362017] font-medium",E.textContent=p,E},S=(d,p)=>{const E=/\[([^\]]+)\]\(([^)\s]+)\)|\bhttps?:\/\/[^\s<]+/g,H=String(p);let P=0,T;for(;(T=E.exec(H))!==null;){if(T.index>P&&d.appendChild(document.createTextNode(H.slice(P,T.index))),T[1]&&T[2]){const N=c(T[2]);N?d.appendChild(y(N,T[1])):d.appendChild(document.createTextNode(T[0]))}else{const N=c(T[0]);N?d.appendChild(y(N,T[0])):d.appendChild(document.createTextNode(T[0]))}P=E.lastIndex}P<H.length&&d.appendChild(document.createTextNode(H.slice(P)))},w=String(l).split(/\n/);for(let d=0;d<w.length;d++)S(m,w[d]),d<w.length-1&&m.appendChild(document.createElement("br"));return m}function R(l){const m=document.createElement("template");m.innerHTML=String(l||"");const c=new Set(["P","BR","STRONG","EM","CODE","PRE","UL","OL","LI","A","BLOCKQUOTE"]),y=w=>{if(!w)return null;const d=String(w).trim();if(d.startsWith("/"))return d;try{const p=new URL(d);return p.protocol==="http:"||p.protocol==="https:"?p.toString():null}catch{return null}},S=w=>{const d=Array.from(w.childNodes);for(const p of d)if(p.nodeType===Node.ELEMENT_NODE){const E=p,H=E.tagName;if(!c.has(H)){const T=document.createTextNode(E.textContent||"");E.replaceWith(T);continue}const P=Array.from(E.attributes);for(const T of P)E.removeAttribute(T.name);if(H==="A"){const T=y(E.getAttribute("href"));if(!T){const Y=document.createTextNode(E.textContent||"");E.replaceWith(Y);continue}E.setAttribute("href",T),T.startsWith("/")?E.setAttribute("target","_self"):(E.setAttribute("target","_blank"),E.setAttribute("rel","noopener noreferrer")),E.className="text-[#212842] underline hover:text-[#362017] font-medium"}S(E)}};return S(m.content),m.content}function O(l){const m=String(l||""),c=typeof window<"u"&&window.marked&&typeof window.marked.parse=="function"?window.marked:null;if(!c)return D(m);const y=m.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;");try{const S=c.parse(y);return R(S)}catch{return D(m)}}window.__savonieXssSelfTest=function(){const m=["<img src=x onerror=alert(1)>","[bad](javascript:alert(1))","[ok](https://example.com)","https://example.com/test?x=<script>alert(1)<\/script>",`Line 1
Line 2 with https://example.com`].map(c=>{const y=document.createElement("div");return y.appendChild(D(c)),y.innerHTML});return console.log("[Savonie] XSS self-test rendered HTML:",m),m};function q(l){if(!e.chipsContainer)return;if(e.chipsContainer.innerHTML="",!l||l.length===0){f(!1);return}const m=["Projects","View Projects","Projects & Case Studies","View projects"],c=["Resume","Download Resume","View Resume","Get resume"],y=["Contact","Email","Email Estivan","LinkedIn","Contact Estivan"],S=["LinkedIn","Open LinkedIn"];l.forEach(d=>{const p=document.createElement("button");p.className="chip-btn text-xs bg-white border border-[#212842]/20 text-[#212842] px-3 py-1 rounded-full hover:bg-[#212842] hover:text-white transition-colors",p.textContent=d,p.addEventListener("click",()=>{if(m.includes(d)){window.location.href="/projects.html";return}if(c.includes(d)){try{window.open(i,"_blank","noopener")}catch{}return}if(y.includes(d)){window.location.href="/contact.html";return}if(S.includes(d)){try{window.open(t,"_blank","noopener")}catch{}return}e.input&&(e.input.value=d,I())}),e.chipsContainer.appendChild(p)});const w=document.createElement("button");w.className="chip-close-btn text-xs text-[#362017]/60 hover:text-[#362017] px-2 py-1 ml-2 transition-colors",w.setAttribute("data-chat-suggestions-close","button"),w.innerHTML="\xD7",w.title="Hide suggestions",w.addEventListener("click",d=>{d.preventDefault(),d.stopPropagation(),console.log("[Savonie DEBUG] Suggestions close X clicked, hiding suggestions"),f(!1)}),e.chipsContainer.appendChild(w),e.suggestionsClose=w,f(!0)}function B(){const l=e.window?.classList.contains("hidden"),m=document.documentElement.dir==="rtl";if(l?(e.window?.classList.remove("hidden"),e.window?.classList.add("flex"),typeof clarity=="function"&&clarity("event","chat_open"),typeof gtag=="function"&&gtag("event","chat_open",{event_category:"Chatbot"})):(e.window?.classList.remove("flex"),e.window?.classList.add("hidden"),typeof clarity=="function"&&clarity("event","chat_close"),typeof gtag=="function"&&gtag("event","chat_close",{event_category:"Chatbot"})),!e.window?.classList.contains("hidden")){if(l){const c=e.widget?.getBoundingClientRect();if(c){let d=c.left/16,p=c.top/16-31.25-1;d+20>window.innerWidth/16&&(d=window.innerWidth/16-20-1),d<1&&(d=1),p<1&&(p=1),e.window.style.position="fixed",e.window.style.left=`${d}rem`,e.window.style.top=`${p}rem`,e.window.style.right="auto",e.window.style.zIndex="10000"}else e.window.style.position="",e.window.style.left="",e.window.style.top="",e.window.style.right="",e.window.style.zIndex=""}e.bubble&&(e.bubble.style.display="none"),setTimeout(()=>{try{e.input?.focus({preventScroll:!0})}catch{e.input?.focus&&e.input.focus()}e.messages&&(e.messages.scrollTop=e.messages.scrollHeight)},100)}}async function x(){if(navigator.onLine)return!0;try{const l=new AbortController,m=setTimeout(()=>l.abort(),3e3),c=await fetch("/favicon.ico",{method:"HEAD",cache:"no-cache",signal:l.signal});return clearTimeout(m),c.ok}catch{return!1}}async function I(){if(!e.input)return;const l=e.input.value.trim();if(!l||h)return;if(h=!0,typeof gtag=="function"&&gtag("event","chat_question",{event_category:"Chatbot",event_label:"User Asked Question"}),typeof clarity=="function"&&clarity("event","chat_question"),!await x()){j(l,"user"),e.input.value="",j("You appear to be offline. Please check your connection and try again.","bot"),h=!1;return}j(l,"user"),e.input.value="";const c=j("Thinking...","bot",!0),y=3e4,S=2;let w=null,d=null;for(let p=0;p<=S;p++){const E=new AbortController,H=setTimeout(()=>E.abort(),y);try{const P=await fetch(r,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({message:l,pageContent:v(),language:s}),signal:E.signal});if(clearTimeout(H),!P.ok)if(P.status>=500){if(w={type:"server",status:P.status},p<S){await new Promise(T=>setTimeout(T,1e3*(p+1)));continue}}else if(P.status===429){w={type:"rate_limit"};break}else{w={type:"client",status:P.status};break}d=await P.json(),w=null;break}catch(P){if(clearTimeout(H),P.name==="AbortError"){if(w={type:"timeout"},p<S)continue}else if(w={type:"network",message:P.message},p<S){await new Promise(T=>setTimeout(T,1e3*(p+1)));continue}}}if(w){k(c);let p;switch(w.type){case"timeout":p="The request took too long. The AI service might be busy. Please try again in a moment.";break;case"rate_limit":p="Too many requests. Please wait a moment before sending another message.";break;case"server":p="The AI service is temporarily unavailable. Please try again in a few seconds.";break;case"network":p="Connection lost. Please check your internet connection and try again.";break;default:p="Something went wrong. Please try again."}j(p,"bot"),h=!1;return}if(k(c),d&&d.errorType){let p="Something went wrong. Please try again.";d.errorType==="RateLimit"?p="Too many requests. Please wait a moment before trying again.":d.errorType==="BadRequest"?p="Please rephrase your question and try again.":d.errorType==="UpstreamError"&&(p="Service hiccup\u2014please try again in a moment."),j(p,"bot"),h=!1;return}if(d.reply&&(d.reply=d.reply.replace(/\n?\s*\{\s*"(reply|chips|action|card|errorType)"[\s\S]*$/,"").trim(),j(d.reply,"bot")),d.chips&&Array.isArray(d.chips)&&e.chipsContainer&&q(d.chips),d.action){if(d.action==="download_resume")try{window.open(i,"_blank","noopener")}catch{const E=document.createElement("a");E.href=i,E.target="_blank",E.rel="noopener noreferrer",E.download="Estivan-Ayramia-Resume.pdf",E.style.display="none",document.body.appendChild(E),E.click(),document.body.removeChild(E)}else if(d.action==="email_link")window.location.href="mailto:hello@estivanayramia.com";else if(d.action==="open_linkedin")try{window.open(t,"_blank","noopener")}catch{}}if(d.card&&W(d.card),!d.chips&&u.length>0){const p=$(u);p.length>0&&e.chipsContainer&&q(p)}h=!1}function j(l,m,c=!1){if(!e.messages)return;const y=document.createElement("div");y.id=c?"loading-msg":"";const S="bg-[#212842] text-white rounded-tr-none self-end ml-auto",w="bg-white text-[#362017] rounded-tl-none border border-[#362017]/5 self-start";if(y.className=`p-3 rounded-lg shadow-sm max-w-[70%] mb-3 text-sm leading-relaxed ${m==="user"?S:w}`,e.messages.appendChild(y),m==="bot"&&!c){let d=0;y.textContent="";const p=setInterval(()=>{d<l.length?(y.textContent+=l[d],d++,e.messages.scrollTop=e.messages.scrollHeight):(clearInterval(p),y.replaceChildren(O(l)),e.messages.scrollTop=e.messages.scrollHeight)},12)}else m==="bot"?y.replaceChildren(O(l)):y.textContent=l;return!c&&g&&(u.push({kind:"text",text:l,sender:m}),u.length>M&&(u=u.slice(u.length-M)),sessionStorage.setItem(C,JSON.stringify(u))),e.messages.scrollTop=e.messages.scrollHeight,y.id}function W(l){if(!e.messages||!n[l])return;const m=n[l],c=document.createElement("div");c.className="bg-white rounded-lg shadow-md overflow-hidden border border-[#362017]/10 mb-3 max-w-[85%] self-start";const y=document.createElement("div");y.className="p-3";const S=document.createElement("h4");S.className="font-semibold text-[#212842] mb-1",S.textContent=m.title;const w=document.createElement("p");w.className="text-xs text-[#362017]/80 mb-3 leading-relaxed",w.textContent=m.summary||"";const d=document.createElement("a");if(d.href=m.link,d.className="inline-block bg-[#212842] text-white px-4 py-2 rounded-lg text-sm hover:bg-[#362017] transition-colors",d.textContent="View",y.appendChild(S),m.summary&&y.appendChild(w),y.appendChild(d),m.img){const p=document.createElement("img");p.src=m.img,p.alt=m.title,p.className="w-full h-32 object-cover",p.addEventListener("error",()=>{try{p.remove()}catch{}}),c.appendChild(p)}c.appendChild(y),e.messages.appendChild(c),e.messages.scrollTop=e.messages.scrollHeight,g&&(u.push({kind:"card",cardId:l}),u.length>M&&(u=u.slice(u.length-M)),sessionStorage.setItem(C,JSON.stringify(u)))}function k(l){const m=document.getElementById(l);m&&m.remove()}if(e.header&&e.window){let l=!1,m,c,y,S;const w=document.documentElement.dir==="rtl";e.header.style.cursor="move",e.header.addEventListener("mousedown",d=>{if(d.target.closest("#close-chat"))return;l=!0,m=d.clientX,c=d.clientY;const p=e.window.getBoundingClientRect();if(y=p.left,S=p.top,e.header.style.cursor="grabbing",document.body.style.userSelect="none",e.window.style.position!=="fixed"){if(e.window.style.position="fixed",w){const E=window.innerWidth-p.right;e.window.style.right=`${E}px`,e.window.style.left="auto"}else e.window.style.left=`${y}px`;e.window.style.top=`${S}px`,e.window.style.zIndex="10000"}}),document.addEventListener("mousemove",d=>{if(!l)return;d.preventDefault();const p=d.clientX-m,E=d.clientY-c,H=e.window.offsetWidth,P=e.window.offsetHeight,T=10;if(w){let Y=window.innerWidth-y-H-p;Y=Math.max(T,Math.min(Y,window.innerWidth-H-T)),e.window.style.right=`${Y}px`,e.window.style.left="auto"}else{let Y=y+p;Y=Math.max(T,Math.min(Y,window.innerWidth-H-T)),e.window.style.left=`${Y}px`,e.window.style.right="auto"}let N=S+E;N=Math.max(T,Math.min(N,window.innerHeight-P-T)),e.window.style.top=`${N}px`}),document.addEventListener("mouseup",()=>{l&&(l=!1,e.header.style.cursor="move",document.body.style.userSelect="")})}document.addEventListener("keydown",l=>{l.key==="Escape"&&!e.window?.classList.contains("hidden")&&B(),(l.ctrlKey||l.metaKey)&&l.key==="k"&&(l.preventDefault(),B())})}),document.addEventListener("DOMContentLoaded",()=>{const r=()=>{const t=document.createElement("div");t.className="rounded-xl border border-chocolate/20 bg-white/40 overflow-hidden p-8 text-center";const o=document.createElement("p");return o.className="text-sm text-chocolate/70",o.textContent="Inline PDF preview may be blocked by hosting or browser settings. Use the buttons below to open or download the deck.",t.appendChild(o),t},i=(t,o)=>{if(!t||!o||t.dataset.pdfLoaded)return;t.innerHTML="";const n=document.createElement("div");n.className="py-12 text-sm text-chocolate/60",n.textContent="Attempting to load inline preview\u2026",t.appendChild(n);const e=document.createElement("iframe");e.src=o,e.title="PDF preview",e.style.width="100%",e.style.height="480px",e.style.border="0",e.loading="lazy";let s=!1;const u=setTimeout(()=>{s=!0,console.log("PDF load timeout - assuming success");try{n.remove()}catch{}t.contains(e)||t.appendChild(e),t.dataset.pdfLoaded="true"},5e3),h=()=>{clearTimeout(u);try{e.remove()}catch{}t.innerHTML="",t.appendChild(r()),t.dataset.pdfLoaded="false"};e.addEventListener("load",()=>{clearTimeout(u);try{try{n.remove()}catch{}t.contains(e)||t.appendChild(e),t.dataset.pdfLoaded="true"}catch{h()}}),e.addEventListener("error",h),t.appendChild(e)};document.querySelectorAll(".preview-toggle").forEach(t=>{const o=t.closest("section"),n=o&&o.querySelector(".preview-panel");let e=null;o&&(e=o.querySelector('a[href$=".pdf"]')||o.querySelector('a[href*=".pdf?"]'));const s=e?e.getAttribute("href"):null;n&&s&&i(n,s),t.addEventListener("click",()=>{if(!n)return;n.classList.toggle("hidden");const u=!n.classList.contains("hidden");t.textContent=u?"Hide preview":"Show preview",typeof clarity=="function"&&clarity("event",u?"pdf_preview_show":"pdf_preview_hide"),typeof gtag=="function"&&gtag("event",u?"pdf_preview_show":"pdf_preview_hide",{event_category:"PDF"}),u&&!n.dataset.pdfLoaded&&s&&i(n,s)})})});
