 ...
 */let __userInteracting=!1,__userInteractingTimer=null;const __markUserInteraction=()=>{__userInteracting=!0,__userInteractingTimer&&clearTimeout(__userInteractingTimer),__userInteractingTimer=setTimeout(()=>{__userInteracting=!1},1e3)};["touchstart","touchmove","wheel","scroll"].forEach(r=>{try{window.addEventListener(r,__markUserInteraction,{passive:!0})}catch{window.addEventListener(r,__markUserInteraction)}});const __initDeferredStylesheets=()=>{try{document.querySelectorAll('link[rel="stylesheet"][media="print"][data-media]').forEach(i=>{const t=i.getAttribute("data-media")||"all",o=()=>{try{i.media=t}catch{}};try{i.addEventListener("load",o,{once:!0})}catch{i.addEventListener("load",o)}try{i.addEventListener("error",o,{once:!0})}catch{i.addEventListener("error",o)}setTimeout(()=>{try{i.sheet&&o()}catch{}},0)})}catch{}};__initDeferredStylesheets();const __initPreloadStylesheets=()=>{try{document.querySelectorAll('link[rel="preload"][as="style"][data-onload-rel]').forEach(i=>{const t=i.getAttribute("data-onload-rel")||"stylesheet",o=()=>{try{i.rel=t,i.removeAttribute("data-onload-rel")}catch{}};try{i.addEventListener("load",o,{once:!0})}catch{i.addEventListener("load",o)}try{if(typeof performance<"u"&&typeof performance.getEntriesByName=="function"){const n=i.href,e=n?performance.getEntriesByName(n):[];if(e&&e.length){const s=e[0];s&&typeof s.responseEnd=="number"&&s.responseEnd>0&&o()}}}catch{}})}catch{}};__initPreloadStylesheets();const __initCarouselAndLightbox=()=>{try{const r=document.getElementById("carouselTrack");if(!r||r.dataset&&r.dataset.carouselInit==="1")return;const i=!!(r.dataset&&r.dataset.carouselWrap==="1"),t=Array.from(document.querySelectorAll(".note-card img")),o=t.length>0,n=Array.from(document.querySelectorAll(".carousel-slide"));if(!n.length)return;const e=document.getElementById("carouselPrev"),s=document.getElementById("carouselNext"),d=document.getElementById("carouselDots"),f=document.getElementById("lightbox"),m=document.getElementById("lightbox-image"),C=document.querySelector(".lightbox-close"),M=document.querySelector(".lightbox-prev"),w=document.querySelector(".lightbox-next");if(!e||!s||!d||!f||!m||!C||!M||!w)return;const S=n.map(v=>v.querySelector("img")).filter(Boolean),p=o?t:S;if(!p.length)return;let y=0,E=0;const A=()=>o?window.innerWidth>=1024?5:window.innerWidth>=768?4:window.innerWidth>=640?3:2:window.innerWidth>=768?3:2;let a=A();const $=()=>{try{d.innerHTML=""}catch{for(;d.firstChild;)d.removeChild(d.firstChild)}},U=()=>{try{f.classList.remove("active"),f.setAttribute("aria-hidden","true")}catch{}},D=()=>Math.ceil(n.length/a),q=()=>{try{const v=(n[0]&&n[0].offsetWidth?n[0].offsetWidth:0)+16,I=D();if(o){const B=Math.max(0,n.length-a);y=Math.max(0,Math.min(y,B)),r.style.transform=`translateX(-${y*v}px)`}else y=Math.max(0,Math.min(y,I-1)),r.style.transform=`translateX(-${y*v*a}px)`;Array.from(document.querySelectorAll(".carousel-dot")).forEach((B,W)=>{const x=o?Math.floor(y/a):y;B.classList.toggle("active",W===x)})}catch{}},O=()=>{$();const v=D();for(let I=0;I<v;I++){const B=document.createElement("button");B.className="carousel-dot"+(I===0?" active":"");try{B.setAttribute("aria-label",`Go to page ${I+1}`)}catch{}B.addEventListener("click",()=>{if(o){const W=Math.max(0,n.length-a);y=Math.max(0,Math.min(I*a,W))}else y=i?(I+v)%v:Math.max(0,Math.min(I,v-1));q()}),d.appendChild(B)}q()};e.addEventListener("click",()=>{const v=D();if(o){const I=Math.max(0,n.length-a);i?(y=y-a,y<0&&(y=I)):y=Math.max(0,y-a)}else y=i?(y-1+v)%v:Math.max(0,Math.min(y-1,v-1));q()}),s.addEventListener("click",()=>{const v=D();if(o){const I=Math.max(0,n.length-a);i?(y=y+a,y>I&&(y=0)):y=Math.min(I,y+a)}else y=i?(y+1)%v:Math.max(0,Math.min(y+1,v-1));q()});const R=v=>{const I=p[v];if(I){E=v,m.src=I.src,m.alt=I.alt||"";try{m.style.transform=I.style&&I.style.transform?I.style.transform:""}catch{}if(o){try{M.style.display=v>0?"block":"none"}catch{}try{w.style.display=v<p.length-1?"block":"none"}catch{}}}},H=v=>{R(v),f.classList.add("active"),f.setAttribute("aria-hidden","false")};o?p.forEach((v,I)=>{v.addEventListener("click",()=>H(I))}):n.forEach((v,I)=>{v.addEventListener("click",()=>H(I))}),C.addEventListener("click",U),f.addEventListener("click",v=>{v.target===f&&U()}),M.addEventListener("click",v=>{v&&v.stopPropagation&&v.stopPropagation(),o?E>0&&R(E-1):R((E-1+p.length)%p.length)}),w.addEventListener("click",v=>{v&&v.stopPropagation&&v.stopPropagation(),o?E<p.length-1&&R(E+1):R((E+1)%p.length)}),document.addEventListener("keydown",v=>{f.classList.contains("active")&&(v.key==="Escape"&&U(),v.key==="ArrowLeft"&&M.click(),v.key==="ArrowRight"&&w.click())}),window.addEventListener("resize",()=>{const v=A();v!==a?(a=v,O()):q()});try{r.dataset.carouselInit="1"}catch{}O()}catch{}};document.readyState==="loading"?document.addEventListener("DOMContentLoaded",__initCarouselAndLightbox):__initCarouselAndLightbox();const __collectLogsEnabled=typeof window<"u"&&new URLSearchParams(window.location.search).has("collect-logs"),__collectedLogs=[],__saveCollected=()=>{try{localStorage.setItem("site_collect_logs",JSON.stringify(__collectedLogs.slice(-1e3)))}catch{}},__logCollect=(r,i)=>{if(__collectLogsEnabled)try{const t={t:Date.now(),msg:String(r),data:i||null,scrollY:window.scrollY||0};__collectedLogs.push(t),__saveCollected()}catch{}},__collectLogsParam=typeof window<"u"?new URLSearchParams(window.location.search).get("collect-logs"):null,__collectSnapshots=!!(__collectLogsParam&&/snapshot/i.test(__collectLogsParam)),__maybeTakeSnapshot=(r,i)=>{if(__collectSnapshots)try{const t=document.activeElement,o=e=>{if(!e||!e.getBoundingClientRect)return null;const s=e.getBoundingClientRect();return{tag:e.tagName||null,id:e.id||null,classes:e.className||null,rect:{x:Math.round(s.x),y:Math.round(s.y),w:Math.round(s.width),h:Math.round(s.height),top:Math.round(s.top),left:Math.round(s.left)},focusable:typeof e.tabIndex=="number"?e.tabIndex:null,ariaRole:e.getAttribute&&(e.getAttribute("role")||null)}},n={reason:r||null,ts:Date.now(),scrollY:window.scrollY||0,innerWidth:window.innerWidth||0,innerHeight:window.innerHeight||0,docHeight:document.documentElement.scrollHeight||document.body.scrollHeight||0,target:o(i||document.activeElement)||null,activeElement:o(t)||null};__logCollect("snapshot",n)}catch{}};if(__collectLogsEnabled){let r=null;window.addEventListener("scroll",()=>{r||(r=setTimeout(()=>{__logCollect("scroll",{y:window.scrollY,innerHeight:window.innerHeight,docHeight:document.documentElement.scrollHeight}),r=null},200))},{passive:!0});try{"serviceWorker"in navigator&&navigator.serviceWorker.addEventListener("controllerchange",()=>{__logCollect("controllerchange",{controller:!!navigator.serviceWorker.controller})})}catch{}try{const t=window.location.reload.bind(window.location);window.location.reload=function(){return __logCollect("location.reload called"),t()}}catch{}(()=>{const t=document.createElement("button");t.id="collect-logs-btn",t.textContent="Logs",Object.assign(t.style,{position:"fixed",left:"8px",bottom:"12px",zIndex:99999,padding:"6px 8px",fontSize:"12px",background:"rgba(33,40,66,0.85)",color:"#e1d4c2",border:"1px solid rgba(225,212,194,0.08)",borderRadius:"6px"}),t.addEventListener("click",()=>{try{const o=JSON.stringify(__collectedLogs,null,2),n=new Blob([o],{type:"application/json"}),e=URL.createObjectURL(n),s=document.createElement("a");s.href=e,s.download=`site-logs-${Date.now()}.json`,document.body.appendChild(s),s.click(),s.remove(),URL.revokeObjectURL(e)}catch{const n=window.open();if(n)try{const e=JSON.stringify(__collectedLogs,null,2),s=n.document;s.title="Site logs",s.body.style.margin="0";const d=s.createElement("pre");d.style.margin="0",d.style.padding="12px",d.textContent=e,s.body.appendChild(d)}catch{}}}),document.addEventListener("DOMContentLoaded",()=>{document.body.appendChild(t)})})();try{document.addEventListener("visibilitychange",()=>__logCollect("visibilitychange",{hidden:document.hidden})),window.addEventListener("hashchange",t=>__logCollect("hashchange",{oldURL:t.oldURL,newURL:t.newURL})),window.addEventListener("popstate",t=>__logCollect("popstate",{state:t.state})),window.addEventListener("beforeunload",t=>__logCollect("beforeunload",{})),window.addEventListener("focusin",t=>{try{__logCollect("focusin",{tag:t.target&&t.target.tagName,id:t.target&&t.target.id||null,class:t.target&&t.target.className||null})}catch{}}),(function(){const t=HTMLElement.prototype.focus;t.__wrappedByCollectLogs||(HTMLElement.prototype.focus=function(){try{__logCollect("element.focus.called",{tag:this.tagName,id:this.id||null,options:arguments[0]||null})}catch{}try{__maybeTakeSnapshot&&__maybeTakeSnapshot("focus",this)}catch{}try{return t.apply(this,arguments)}catch{try{return t.call(this)}catch{}}},HTMLElement.prototype.focus.__wrappedByCollectLogs=!0)})(),(function(){const t=Element.prototype;if(!t.__scrollIntoViewLogged){const o=t.scrollIntoView;t.scrollIntoView=function(){try{__logCollect("element.scrollIntoView",{tag:this.tagName,id:this.id||null,args:Array.from(arguments)})}catch{}try{__maybeTakeSnapshot&&__maybeTakeSnapshot("scrollIntoView",this)}catch{}return o.apply(this,arguments)},t.__scrollIntoViewLogged=!0}})();try{const t=window.scrollTo;window.scrollTo=function(){try{__logCollect("window.scrollTo",{args:Array.from(arguments)})}catch{}try{__maybeTakeSnapshot&&__maybeTakeSnapshot("window.scrollTo",null)}catch{}return t.apply(window,arguments)}}catch{}try{const t=window.scrollBy;window.scrollBy=function(){try{__logCollect("window.scrollBy",{args:Array.from(arguments)})}catch{}try{__maybeTakeSnapshot&&__maybeTakeSnapshot("window.scrollBy",null)}catch{}return t.apply(window,arguments)}}catch{}try{const t=window.fetch;window.fetch=function(o,n){try{__logCollect("fetch.start",{url:o&&o.url||o,method:n&&n.method||"GET"})}catch{}return t.apply(this,arguments).then(e=>{try{__logCollect("fetch.end",{url:e&&e.url||o,status:e.status})}catch{}return e}).catch(e=>{try{__logCollect("fetch.error",{url:o,message:e&&e.message})}catch{}throw e})}}catch{}try{let o=function(){const n=new t;let e=null;const s=n.open;n.open=function(f,m){e=m;try{__logCollect("xhr.open",{method:f,url:m})}catch{}return s.apply(n,arguments)};const d=n.send;return n.send=function(){try{__logCollect("xhr.send",{url:e})}catch{}return n.addEventListener("loadend",function(){try{__logCollect("xhr.loadend",{url:e,status:n.status})}catch{}}),d.apply(n,arguments)},n};var WrappedXHR=o;const t=window.XMLHttpRequest;o.prototype=t.prototype,window.XMLHttpRequest=o}catch{}window.addEventListener("resize",()=>__logCollect("resize",{innerWidth:window.innerWidth,innerHeight:window.innerHeight})),window.addEventListener("orientationchange",()=>__logCollect("orientationchange",{orientation:window.orientation}));try{if(navigator.serviceWorker&&navigator.serviceWorker.register){const t=navigator.serviceWorker.register.bind(navigator.serviceWorker);navigator.serviceWorker.register=function(){const o=arguments;try{__logCollect("sw.register.start",{scope:o&&o[1]&&o[1].scope||null,script:o&&o[0]})}catch{}return t.apply(navigator.serviceWorker,arguments).then(n=>{try{__logCollect("sw.register.done",{scope:n.scope})}catch{}try{n.addEventListener("updatefound",()=>__logCollect("sw.updatefound",{})),n.waiting&&__logCollect("sw.waiting",{})}catch{}return n}).catch(n=>{try{__logCollect("sw.register.error",{message:n&&n.message})}catch{}throw n})}}}catch{}try{if(typeof ScrollTrigger<"u"&&ScrollTrigger&&ScrollTrigger.refresh){const t=ScrollTrigger.refresh.bind(ScrollTrigger);ScrollTrigger.refresh=function(){try{__logCollect("ScrollTrigger.refresh",{args:Array.from(arguments)})}catch{}return t.apply(this,arguments)}}}catch{}["touchend","pointerup","mouseup"].forEach(t=>{window.addEventListener(t,o=>{try{__logCollect("gesture."+t,{x:o.changedTouches&&o.changedTouches[0]&&o.changedTouches[0].clientX||o.clientX||null,y:o.changedTouches&&o.changedTouches[0]&&o.changedTouches[0].clientY||o.clientY||null})}catch{}},{passive:!0})});try{let t=document.documentElement.scrollHeight||document.body.scrollHeight||0;new MutationObserver(()=>{try{const n=document.documentElement.scrollHeight||document.body.scrollHeight||0;if(n!==t){__logCollect("docHeight.change",{from:t,to:n});try{__maybeTakeSnapshot&&__maybeTakeSnapshot("docHeight.change",document.documentElement)}catch{}t=n}}catch{}}).observe(document.documentElement||document.body,{childList:!0,subtree:!0,attributes:!0})}catch{}try{const o=n=>{try{const e=JSON.stringify(n,(s,d)=>typeof s=="string"&&/pass(word)?|token|secret|auth|credit|cc-number|card|ssn|cvv/i.test(s)?"[REDACTED]":typeof d=="string"&&d.length>200?d.slice(0,200)+"\u2026[truncated]":d);return e.length>8192?e.slice(0,8192)+"...[truncated]":e}catch{return String(n)}};try{["log","info","warn","error","debug"].forEach(n=>{const e=console[n]&&console[n].bind(console);e&&(console[n]=function(){try{__logCollect("console."+n,{args:Array.from(arguments).map(s=>typeof s=="object"?o(s):String(s))})}catch{}try{(n==="error"||n==="warn")&&__maybeTakeSnapshot&&__maybeTakeSnapshot("console."+n,document.activeElement)}catch{}return e.apply(console,arguments)})})}catch{}window.addEventListener("error",n=>{try{__logCollect("window.error",{message:n.message,filename:n.filename,lineno:n.lineno,colno:n.colno,stack:n.error&&n.error.stack?String(n.error.stack).slice(0,1e3):null});try{__maybeTakeSnapshot&&__maybeTakeSnapshot("error",n&&n.target?n.target:document.activeElement)}catch{}}catch{}}),window.addEventListener("unhandledrejection",n=>{try{__logCollect("unhandledrejection",{reason:n.reason&&(n.reason.stack?String(n.reason.stack).slice(0,1e3):String(n.reason))})}catch{}});try{const n=localStorage.setItem.bind(localStorage);localStorage.setItem=function(e,s){try{__logCollect("localStorage.setItem",{key:String(e),size:s&&s.length||0})}catch{}return n(e,s)}}catch{}try{const n=sessionStorage.setItem.bind(sessionStorage);sessionStorage.setItem=function(e,s){try{__logCollect("sessionStorage.setItem",{key:String(e),size:s&&s.length||0})}catch{}return n(e,s)}}catch{}try{if(navigator&&navigator.sendBeacon){const n=navigator.sendBeacon.bind(navigator);navigator.sendBeacon=function(e,s){try{__logCollect("navigator.sendBeacon",{url:String(e),dataSize:s&&s.size||null})}catch{}return n(e,s)}}}catch{}try{document.addEventListener("click",n=>{try{const e=n.target&&(n.target.closest?n.target.closest("a,button,input,select,textarea,summary"):n.target);if(!e)return;const s=(e.tagName||"").toLowerCase(),d={tag:s,id:e.id||null,classes:e.className||null};s==="a"&&e.href&&(d.href=e.href.length>200?e.href.slice(0,200)+"\u2026":e.href),__logCollect("dom.click",d);try{["a","button","input","textarea","select"].includes(s)&&__maybeTakeSnapshot&&__maybeTakeSnapshot("click",e)}catch{}}catch{}},{passive:!0}),document.addEventListener("submit",n=>{try{const e=n.target;if(!e||!e.tagName||e.tagName.toLowerCase()!=="form")return;const s=Array.from(e.elements||[]).filter(d=>d.name).map(d=>({name:d.name,type:d.type||d.tagName}));__logCollect("form.submit",{action:e.action||null,method:e.method||"GET",fields:s})}catch{}},!0)}catch{}try{document.addEventListener("input",n=>{try{const e=n.target;if(!e)return;const s=e.tagName&&e.tagName.toLowerCase();if(s==="input"||s==="textarea"||s==="select"){const d={tag:s,type:e.type||null,name:e.name||null,valueLength:e.value&&e.value.length||0};__logCollect("input",d)}}catch{}},{passive:!0})}catch{}try{document.addEventListener("selectionchange",()=>{try{const n=document.getSelection&&document.getSelection();if(!n)return;const e=n.toString(),s=n.anchorNode&&n.anchorNode.parentElement&&n.anchorNode.parentElement.tagName;__logCollect("selectionchange",{length:e.length,container:s||null})}catch{}})}catch{}try{["copy","cut","paste"].forEach(n=>{document.addEventListener(n,e=>{try{__logCollect("clipboard."+n,{})}catch{}})})}catch{}try{if("PerformanceObserver"in window)try{new PerformanceObserver(e=>{e.getEntries().forEach(s=>{try{s.entryType==="longtask"?__logCollect("perf.longtask",{duration:Math.round(s.duration)}):s.entryType==="resource"&&__logCollect("perf.resource",{name:s.name,initiatorType:s.initiatorType,duration:Math.round(s.duration)})}catch{}})}).observe({entryTypes:["longtask","resource"]})}catch{}}catch{}try{const n=EventTarget.prototype.addEventListener;EventTarget.prototype.addEventListener=function(e,s,d){try{__logCollect("addEventListener",{target:this&&this.tagName?this.tagName:this&&this.constructor&&this.constructor.name||"unknown",type:e})}catch{}return n.apply(this,arguments)}}catch{}}catch{}}catch{}window.tryGuardedReload=function(t){t=t||{};const o=typeof t.MAX=="number"?t.MAX:3e4,n=typeof t.RETRY=="number"?t.RETRY:500,e=t&&typeof t.fallback=="function"?t.fallback:null,s=Date.now();(function d(){try{if(!(typeof window.__userInteracting<"u"?window.__userInteracting:!1)){try{window.location.reload()}catch{try{window.location.href=window.location.href}catch{}}return}if(Date.now()-s<o){setTimeout(d,n);return}if(e)try{e()}catch{try{window.location.reload()}catch{}}else try{window.location.reload()}catch{try{window.location.href=window.location.href}catch{}}}catch{if(e)try{e()}catch{try{window.location.reload()}catch{}}else try{window.location.reload()}catch{}}})()}}const initDarkMode=()=>{const r=document.getElementById("theme-toggle");if(!r)return;const i=window.matchMedia("(prefers-color-scheme: dark)").matches,t=localStorage.getItem("theme"),o=t||(i?"dark":"light");document.documentElement.setAttribute("data-theme",o),t||localStorage.setItem("theme",o),r.innerHTML=o==="dark"?'<span style="color: #e1d4c2">\u{1F506}</span>':'<span style="color: #212842">\u{1F319}</span>';const n=()=>{const e=document.documentElement.getAttribute("data-theme"),s=e==="light"?"dark":"light";document.documentElement.setAttribute("data-theme",s),localStorage.setItem("theme",s),r.innerHTML=s==="dark"?'<span style="color: #e1d4c2">\u{1F506}</span>':'<span style="color: #212842">\u{1F319}</span>',typeof clarity=="function"&&clarity("event","theme_toggle",{theme:s}),typeof gtag=="function"&&gtag("event","theme_toggle",{event_category:"user_preference",event_label:s}),r.setAttribute("aria-label",`Switch to ${e} mode`)};window.matchMedia("(prefers-color-scheme: dark)").addEventListener("change",e=>{if(!localStorage.getItem("theme_manual")){const s=e.matches?"dark":"light";document.documentElement.setAttribute("data-theme",s),localStorage.setItem("theme",s),r.innerHTML=s==="dark"?'<span style="color: #e1d4c2">\u{1F506}</span>':'<span style="color: #212842">\u{1F319}</span>'}}),r.addEventListener("click",()=>{n(),localStorage.setItem("theme_manual","true")})},initMobileMenu=()=>{const r=document.getElementById("mobile-menu-toggle"),i=document.getElementById("mobile-menu");if(!r||!i)return;let t=0,o=null;const n=()=>o||(o=document.createElement("div"),o.setAttribute("aria-hidden","true"),o.style.position="fixed",o.style.left="0",o.style.top="0",o.style.right="0",o.style.bottom="0",o.style.zIndex="35",o.style.background="rgba(0,0,0,0.35)",o.addEventListener("click",()=>s()),o),e=()=>{t=window.scrollY;try{const m=n();m.parentElement||document.body.appendChild(m)}catch{}i.classList.remove("hidden"),r.setAttribute("aria-expanded","true"),document.body.style.position="fixed",document.body.style.top=`-${t}px`,document.body.style.width="100%";const f=r.querySelector("svg");f&&(f.style.transform="rotate(90deg)")},s=()=>{if(i.classList.contains("hidden"))return;i.classList.add("hidden"),r.setAttribute("aria-expanded","false"),o&&o.parentElement&&o.parentElement.removeChild(o),document.body.style.position="",document.body.style.top="",document.body.style.width="",window.scrollTo(0,t);const f=r.querySelector("svg");f&&(f.style.transform="rotate(0deg)")},d=()=>{r.getAttribute("aria-expanded")==="true"?s():e()};r.addEventListener("click",f=>{f.preventDefault(),f.stopPropagation(),d()}),document.addEventListener("click",f=>{!r.contains(f.target)&&!i.contains(f.target)&&s()}),document.addEventListener("keydown",f=>{f.key==="Escape"&&s()}),window.addEventListener("hashchange",s),window.addEventListener("popstate",s),i.addEventListener("click",f=>{(f.target.tagName==="A"||f.target.closest("a"))&&s()})},initAriaCurrent=()=>{const r=o=>{try{return o?(o=String(o).split("#")[0].split("?")[0],o.endsWith(".html")&&(o=o.slice(0,-5)),o.length>1&&o.endsWith("/")&&(o=o.slice(0,-1)),o||"/"):"/"}catch{return"/"}},i=r(window.location&&window.location.pathname);document.querySelectorAll("header a[href], #mobile-menu a[href]").forEach(o=>{try{const n=o.getAttribute("href");if(!n||/^(https?:)?\/\//i.test(n)||/^mailto:/i.test(n)||n.startsWith("#"))return;r(n)===i?o.setAttribute("aria-current","page"):o.removeAttribute("aria-current")}catch{}})},initAnimations=()=>{const r=typeof window<"u"&&typeof window.matchMedia=="function"&&window.matchMedia("(max-width: 768px)").matches,i=typeof window<"u"&&typeof window.matchMedia=="function"&&window.matchMedia("(prefers-reduced-motion: reduce)").matches;if(document.querySelectorAll("[data-gsap]").forEach(s=>{s.classList.remove("opacity-0","translate-y-8"),s.style.opacity="1",s.style.transform="none"}),typeof gsap>"u"||typeof ScrollTrigger>"u"){console.warn("GSAP or ScrollTrigger not loaded; revealing content without animations.");return}if(i)return;gsap.registerPlugin(ScrollTrigger),document.querySelectorAll('[data-gsap="fade-up"]').forEach(s=>{const d=s.getAttribute("data-gsap-delay")||0;gsap.from(s,{opacity:0,y:20,duration:.4,delay:parseFloat(d)*.5,ease:"power2.out",scrollTrigger:{trigger:s,start:"top 92%",toggleActions:"play none none none"}})});const n=document.querySelector("section:first-of-type");n&&!r&&!n.classList.contains("no-parallax")&&gsap.to(n,{yPercent:20,ease:"none",scrollTrigger:{trigger:n,start:"top top",end:"bottom top",scrub:!0}}),document.querySelectorAll(".card-hover").forEach(s=>{s.addEventListener("mouseenter",()=>{gsap.to(s,{y:-8,duration:.3,ease:"power2.out"})}),s.addEventListener("mouseleave",()=>{gsap.to(s,{y:0,duration:.3,ease:"power2.out"})})})},loadGSAPAndInit=()=>{const r=typeof window<"u"&&typeof window.matchMedia=="function"&&window.matchMedia("(max-width: 768px)").matches,i=()=>{if(window.gsap&&window.ScrollTrigger){initAnimations();return}const t=document.createElement("script");t.src="https://cdnjs.cloudflare.com/ajax/libs/gsap/3.12.2/gsap.min.js",t.onload=()=>{const o=document.createElement("script");o.src="https://cdnjs.cloudflare.com/ajax/libs/gsap/3.12.2/ScrollTrigger.min.js",o.onload=()=>{initAnimations()},document.body.appendChild(o)},document.body.appendChild(t)};if(r){initAnimations();const t=()=>{["scroll","touchstart","mousemove"].forEach(o=>window.removeEventListener(o,t)),i()};["scroll","touchstart","mousemove"].forEach(o=>window.addEventListener(o,t,{once:!0,passive:!0}))}else i()},initSmoothScroll=()=>{document.addEventListener("click",r=>{const i=r.target.closest("a");if(!i)return;const t=i.getAttribute("href");if(t==="#"){r.preventDefault(),r.stopPropagation();return}if(t&&t.startsWith("#")&&t.length>1){const o=document.querySelector(t);if(o){r.preventDefault();const s=o.getBoundingClientRect().top+window.pageYOffset-100;window.scrollTo({top:s,behavior:"smooth"})}}},{passive:!1})},initFormValidation=()=>{const r=document.querySelector('form[action*="formspree.io"]');if(!r)return;const i=r.querySelectorAll("input, textarea, select"),t=r.querySelector('input[type="file"][name="file"]'),o=5*1024*1024,n=["csv","doc","docx","pdf","txt","xls","xlsx","jpg","jpeg","png","gif","svg","webp"],e=r.querySelector('input[name="link"]'),s=w=>{if(!w)return!0;let S=w.trim();/^https?:\/\//i.test(S)||(S=`https://${S}`);let p;try{p=new URL(S)}catch{return!1}return!["javascript:","data:","file:","blob:","chrome:","chrome-extension:"].includes(p.protocol)};e&&e.addEventListener("blur",()=>{e.value&&!/^https?:\/\//i.test(e.value)&&(e.value=`https://${e.value.trim()}`)});const d=(w,S)=>{w.classList.add("border-red-500");let p=w.parentElement.querySelector(".inline-error");p||(p=document.createElement("p"),p.className="inline-error text-xs text-red-600 mt-1",w.parentElement.appendChild(p)),p.textContent=S},f=w=>{w.classList.remove("border-red-500");const S=w.parentElement.querySelector(".inline-error");S&&S.remove()};i.forEach(w=>{w.addEventListener("blur",()=>{w.hasAttribute("required")&&!w.value.trim()?d(w,"This field is required"):w.type==="email"&&w.value&&!w.checkValidity()?d(w,"Please enter a valid email address"):w.type==="url"&&w.value&&!s(w.value)?d(w,"Please enter a valid URL"):w.checkValidity()?f(w):d(w,w.validationMessage||"Invalid input")}),w.addEventListener("input",()=>{w.classList.contains("border-red-500")&&w.checkValidity()&&w.value.trim()&&f(w)})});let m=r.querySelector("#form-status");m||(m=document.createElement("div"),m.id="form-status",m.className="text-sm mt-3",r.appendChild(m));const C=w=>{const S=r.querySelector('button[type="submit"]');S&&(S.disabled=w,S.classList.toggle("loading",w))},M=async()=>{C(!0),m.textContent="";try{const w=new FormData(r);if(t&&t.files&&t.files[0]){const p=t.files[0],y=(p.name.split(".").pop()||"").toLowerCase();if(!n.includes(y)){m.className="text-sm mt-3 text-red-700",m.textContent="Unsupported file type. Please upload one of: CSV, DOC, DOCX, PDF, TXT, XLS, XLSX, JPG, JPEG, PNG, GIF, SVG, WEBP.",C(!1);return}if(p.size>o){m.className="text-sm mt-3 text-red-700",m.textContent="File too large (max 5MB). Please upload a smaller file.",C(!1);return}}if(e&&e.value&&!s(e.value)){m.className="text-sm mt-3 text-red-700",m.textContent="Please enter a valid link starting with https:// or http://",C(!1);return}if((await fetch(r.action,{method:"POST",body:w,headers:{Accept:"application/json"},mode:"cors",credentials:"omit"})).ok){r.reset();const p=r.parentElement;p&&(p.innerHTML=`
                    ...
                    `,initMiniGame("mini-game-root"))}else{m.className="text-sm mt-3 text-red-700",m.textContent="Sorry, something went wrong. Trying fallback...";try{r.setAttribute("target","_blank"),r.submit()}catch{m.textContent="Sorry, something went wrong. Please try again or email hello@estivanayramia.com."}}}catch{m.className="text-sm mt-3 text-red-700",m.textContent="Network error detected. Opening fallback submit...";try{r.setAttribute("target","_blank"),r.submit()}catch{m.textContent="Network error. Please check your connection or email hello@estivanayramia.com."}}finally{C(!1)}};r.addEventListener("submit",w=>{let S=!0;if(i.forEach(p=>{p.checkValidity()||(S=!1,p.classList.add("border-red-500"))}),w.preventDefault(),!S){const p=r.querySelector(".border-red-500");if(p)try{p.focus({preventScroll:!0})}catch{try{__logCollect&&__logCollect("focus-fallback",{selector:p.tagName+(p.id?"#"+p.id:"")})}catch{}p.focus()}m.className="text-sm mt-3 text-red-700",m.textContent="Please complete required fields highlighted in red.";return}M()})},initMiniGame=r=>{const i=document.getElementById(r);if(!i)return;const t="mgHighScore",o="mgLeaderboard",n=parseInt(localStorage.getItem(t)||"0",10),e=()=>{try{const x=localStorage.getItem(o);if(!x)return[];const l=JSON.parse(x);return Array.isArray(l)?l.filter(u=>typeof u.name=="string"&&typeof u.score=="number").slice(0,25):[]}catch{return[]}},s=x=>{try{localStorage.setItem(o,JSON.stringify(x.slice(0,25)))}catch{}};let d=e();i.innerHTML=`
    ...
    `;const f=i.querySelector("#mg-canvas"),m=i.querySelector("#mg-score"),C=i.querySelector("#mg-mult"),M=i.querySelector("#mg-best"),w=i.querySelector("#mg-lives"),S=i.querySelector("#mg-start"),p=f.getContext("2d"),y=window.devicePixelRatio||1,a={running:!1,score:0,best:n,w:0,h:0,paddle:{x:0,y:0,w:90,h:12},orbs:[],particles:[],lastSpawn:0,orbInterval:900,baseSpeed:2.2,lives:3,combo:0,comboTimer:0,shake:0,t:0},$=()=>{const x=f.getBoundingClientRect();f.width=Math.floor(x.width*y),f.height=Math.floor(320*y),a.w=f.width,a.h=f.height,a.paddle.y=a.h-30*y,a.paddle.x===0&&(a.paddle.x=a.w/2-a.paddle.w*y/2),H()},U=x=>"\u2764\u2764\u2764".slice(0,x),D=x=>{navigator.vibrate&&navigator.vibrate(x)},q=(x,l,u="#212842",c=10)=>{for(let h=0;h<c;h++)a.particles.push({x,y:l,vx:(Math.random()-.5)*3*y,vy:-Math.random()*3*y,life:600,color:u,r:2*y})},O=()=>{const x=(8+Math.random()*2)*y,l=x+Math.random()*(a.w-2*x),u=Math.random()<.15,c=u?"#eab308":"#362017",h=(a.baseSpeed+Math.random()*1.5+a.score*.01)*y;a.orbs.push({x:l,y:x+2,r:x,vy:h,color:c,type:u?"gold":"normal"})},R=()=>{const x=p.createLinearGradient(0,0,a.w,a.h),l=(Math.sin(a.t*.001)+1)/2;x.addColorStop(0,`rgba(${210+20*l|0}, ${200+10*l|0}, 180, 0.6)`),x.addColorStop(1,"rgba(200, 190, 170, 0.6)"),p.fillStyle=x,p.fillRect(0,0,a.w,a.h)},H=()=>{const x=a.shake?Math.random()*a.shake-a.shake/2:0,l=a.shake?Math.random()*a.shake-a.shake/2:0;p.setTransform(1,0,0,1,0,0),p.clearRect(0,0,a.w,a.h),p.translate(x,l),R();const u=Math.min(a.combo,6);p.shadowColor="rgba(33,40,66,0.6)",p.shadowBlur=u*2*y,p.fillStyle="#212842",p.fillRect(a.paddle.x,a.paddle.y,a.paddle.w*y,a.paddle.h*y),p.shadowBlur=0,a.particles.forEach(c=>{p.globalAlpha=Math.max(0,c.life/600),p.fillStyle=c.color,p.beginPath(),p.arc(c.x,c.y,c.r,0,Math.PI*2),p.fill(),p.globalAlpha=1}),a.orbs.forEach(c=>{p.beginPath(),p.fillStyle=c.color,p.shadowColor=c.type==="gold"?"rgba(234,179,8,0.6)":"rgba(54,32,23,0.3)",p.shadowBlur=c.type==="gold"?8*y:4*y,p.arc(c.x,c.y,c.r,0,Math.PI*2),p.fill(),p.shadowBlur=0})},v=x=>{if(!a.running)return;a.last||(a.last=x);const l=x-a.last;a.t+=l,a.last=x,a.comboTimer+=l,a.comboTimer>1600&&a.combo>0&&(a.combo=0,C.textContent="x1"),a.shake>0&&(a.shake=Math.max(0,a.shake-.5*y)),x-a.lastSpawn>a.orbInterval&&(O(),a.lastSpawn=x,a.orbInterval>420&&(a.orbInterval-=8));const u=a.paddle.w*y,c=a.paddle.h*y,h=a.paddle.x,L=a.paddle.y;a.orbs.forEach(k=>{k.y+=k.vy});for(let k=a.particles.length-1;k>=0;k--){const g=a.particles[k];g.x+=g.vx,g.y+=g.vy,g.vy+=.04*y,g.life-=l,g.life<=0&&a.particles.splice(k,1)}for(let k=a.orbs.length-1;k>=0;k--){const g=a.orbs[k];if(g.y+g.r>=L&&g.x>=h&&g.x<=h+u){const b=g.type==="gold"?5:1;a.combo=Math.min(a.combo+1,9),a.comboTimer=0;const _=1+Math.floor(a.combo/3);a.score+=b*_,m.textContent=a.score,C.textContent="x"+_,q(g.x,L,g.color,g.type==="gold"?18:10),a.shake=Math.min(6*y,a.shake+(g.type==="gold"?4:2)),D(g.type==="gold"?25:12),a.orbs.splice(k,1),a.score%10===0&&q(g.x,g.y,"#e1d4c2",24)}else if(g.y-g.r>a.h&&(a.orbs.splice(k,1),a.lives-=1,w.textContent=U(a.lives),a.combo=0,C.textContent="x1",a.shake=10*y,D(60),a.lives<=0)){I();return}}H(),requestAnimationFrame(v)},I=()=>{a.running=!1,a.score>a.best&&(a.best=a.score,localStorage.setItem(t,String(a.best)),M.textContent=a.best),S.textContent="Restart";const x=document.createElement("div");x.className="mt-3 text-sm text-indigodeep mg-end",x.innerHTML=`
        ...
        `,i.appendChild(x);const l=x.querySelector("#mg-name"),u=x.querySelector("#mg-save"),c=x.querySelector("#mg-view"),h=x.querySelector("#mg-name-error"),L=x.querySelector("#mg-leaderboard");if(!u||!c)return;const k=["fuck","shit","bitch","cunt","dick","piss","cock","asshole","retard","fag","faggot","nigger","nigga","spic","chink","whore","slut","bastard","twat","rape","cum","penis","vagina"],g=P=>P.toLowerCase().replace(/[@]/g,"a").replace(/[$]/g,"s").replace(/0/g,"o").replace(/1/g,"i").replace(/3/g,"e").replace(/4/g,"a").replace(/5/g,"s").replace(/7/g,"t"),b=P=>{const T=g(P).replace(/[_-]/g,"");return!k.some(N=>T.includes(N))},_=/^[A-Za-z0-9_-]{3,16}$/,j=()=>{if(!L)return;let P="<table class='w-full text-xs'><thead><tr class='text-indigodeep'><th class='text-left pb-1'>#</th><th class='text-left pb-1'>User</th><th class='text-right pb-1'>Score</th></tr></thead><tbody>";d.slice(0,10).forEach((T,N)=>{P+=`<tr class='border-t border-chocolate/10'><td class='py-1 pr-2'>${N+1}</td><td class='py-1 pr-2'>${T.name}</td><td class='py-1 text-right'>${T.score}</td></tr>`}),d.length===0&&(P+="<tr><td colspan='3' class='py-2 text-ink/60'>No scores yet.</td></tr>"),P+="</tbody></table>",L.innerHTML=P};c.addEventListener("click",()=>{L.classList.toggle("hidden"),L.classList.contains("hidden")?c.textContent="View Leaderboard":(j(),c.textContent="Hide Leaderboard")}),u.addEventListener("click",()=>{const P=(l.value||"").trim();if(!_.test(P)){h.textContent="Username must be 3-16 chars: letters, numbers, _ or - only.",h.classList.remove("hidden");return}if(!b(P)){h.textContent="Please choose a different name (profanity not allowed).",h.classList.remove("hidden");return}h.classList.add("hidden"),d.push({name:P,score:a.score,ts:Date.now()}),d.sort((T,N)=>N.score-T.score||T.ts-N.ts),d=d.slice(0,25),s(d),j(),L.classList.remove("hidden"),c.textContent="Hide Leaderboard",u.disabled=!0,u.textContent="Saved"})},B=()=>{a.running=!0,a.score=0,m.textContent="0",a.orbs=[],a.particles=[],a.lastSpawn=0,a.orbInterval=900,a.baseSpeed=2.2,a.lives=3,w.textContent=U(3),a.combo=0,C.textContent="x1",a.t=0,a.shake=0,[...i.querySelectorAll(".mg-end")].forEach(x=>x.remove()),requestAnimationFrame(v)},W=x=>{const l=f.getBoundingClientRect();let u=(x-l.left)*y-a.paddle.w*y/2;u=Math.max(0,Math.min(u,a.w-a.paddle.w*y)),a.paddle.x=u};f.addEventListener("mousemove",x=>W(x.clientX)),f.addEventListener("touchstart",x=>{x.touches[0]&&W(x.touches[0].clientX)},{passive:!0}),f.addEventListener("touchmove",x=>{x.touches[0]&&W(x.touches[0].clientX)},{passive:!0}),window.addEventListener("keydown",x=>{x.key==="ArrowLeft"&&W(f.getBoundingClientRect().left+a.paddle.x/y-24),x.key==="ArrowRight"&&W(f.getBoundingClientRect().left+a.paddle.x/y+24)}),S.addEventListener("click",()=>{S.textContent="Playing...",B()}),window.addEventListener("resize",$),$(),H()},initLazyLoading=()=>{const r=document.querySelectorAll("img[data-src]");if("IntersectionObserver"in window){const i=new IntersectionObserver((t,o)=>{t.forEach(n=>{if(n.isIntersecting){const e=n.target;e.src=e.dataset.src,e.removeAttribute("data-src"),i.unobserve(e)}})});r.forEach(t=>i.observe(t))}else r.forEach(i=>{i.src=i.dataset.src,i.removeAttribute("data-src")})},initPdfPreviews=()=>{try{document.querySelectorAll(".preview-panel").forEach(r=>{try{const i=r.closest("section")||r.parentElement;if(!i)return;const t=i.querySelector('a[href$=".pdf"]');if(!t)return;const o=t.href;r.dataset.pdfLoaded="true";const n=m=>{try{r.innerHTML='<div class="rounded-xl border border-chocolate/20 bg-white/40 overflow-hidden p-8 text-center"><p class="text-sm text-chocolate/70">Inline PDF preview may be blocked by hosting or browser settings. Use the buttons below to open or download the deck.</p></div>',__logCollect&&__logCollect("pdf.preview.fallback",{url:o,reason:m})}catch{}};r.innerHTML=`<div class="py-12 bg-white/30 rounded-xl border border-chocolate/10 flex items-center justify-center min-h-[480px]">
  <div class="text-sm text-chocolate/60 flex items-center gap-2"><svg class="animate-spin h-4 w-4" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"><circle class="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" stroke-width="4"></circle><path class="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z"></path></svg> Loading preview\u2026</div>
        ...
        `,document.body.appendChild(D);const q=D.querySelector(".achievement-close"),O=()=>{D.classList.remove("show"),setTimeout(()=>D.remove(),300)};q.addEventListener("click",O),setTimeout(()=>D.classList.add("show"),100);const R=setTimeout(()=>{document.body.contains(D)&&O()},4e3);q.addEventListener("click",()=>clearTimeout(R))},s=()=>{const m="portfolio_visited_pages";try{const C=JSON.parse(localStorage.getItem(m)||"[]"),M=window.location.pathname.split("/").pop()||"index.html";C.includes(M)||(C.push(M),localStorage.setItem(m,JSON.stringify(C))),["index.html","overview.html","deep-dive.html","about.html","projects.html","contact.html"].every(p=>C.includes(p))&&n("explorer"),M==="deep-dive.html"&&n("reader")}catch{}},d=()=>{const m=document.getElementById("theme-toggle");m&&m.addEventListener("click",()=>n("nightOwl"))},f=()=>{document.querySelectorAll('a[href*="linkedin.com"], a[href*="github.com"]').forEach(m=>{m.addEventListener("click",()=>n("networker"))})};s(),d(),f(),window.unlockAchievement=n},initKonamiCode=()=>{const r=["ArrowUp","ArrowUp","ArrowDown","ArrowDown","ArrowLeft","ArrowRight","ArrowLeft","ArrowRight","b","a"];let i=0;const t=()=>{window.dispatchEvent(new Event("konami-activated")),window.unlockAchievement&&window.unlockAchievement("konami");const n=getCurrentLanguage(),e=translations.konami[n],s=document.createElement("div");s.className="konami-modal",s.innerHTML=`
        ...
        <div class="max-w-7xl mx-auto px-6 lg:px-12">
            ...
            `,document.body&&document.body.appendChild(i)}}catch{}}},__arcadeStorageKey="site_played_games_v1",__safeJsonParse=(r,i)=>{try{return JSON.parse(r)}catch{return i}},__getPlayedGames=()=>{try{const r=localStorage.getItem(__arcadeStorageKey),i=__safeJsonParse(r,{});return i&&typeof i=="object"?i:{}}catch{return{}}},__setPlayedGames=r=>{try{localStorage.setItem(__arcadeStorageKey,JSON.stringify(r||{}))}catch{}},__normalizePath=r=>{try{return(r||"/").replace(/\/+$/,"")||"/"}catch{return"/"}},__getCurrentGameId=()=>{try{const r=document.body&&document.body.getAttribute("data-arcade-achievements-filter");if(r&&/^mini_/.test(r))return r.replace(/^mini_/,"");if(r&&/^arcade_/.test(r))return r.replace(/^arcade_/,"");const i=__normalizePath(window.location.pathname||"/"),t=i.match(/^\/hobbies-games\/(.+)$/);if(t&&t[1])return t[1].replace(/\.html$/i,"");const o=i.split("/").pop()||"";return o.endsWith(".html")?o.replace(/\.html$/i,""):null}catch{return null}},__markGamePlayed=r=>{if(r)try{const i=__getPlayedGames();i[r]={lastPlayedAt:Date.now()},__setPlayedGames(i)}catch{}},__hashString=r=>{let i=2166136261;for(let t=0;t<r.length;t++)i^=r.charCodeAt(t),i=Math.imul(i,16777619);return i>>>0},__mulberry32=r=>{let i=r>>>0;return function(){i+=1831565813;let t=Math.imul(i^i>>>15,1|i);return t^=t+Math.imul(t^t>>>7,61|t),((t^t>>>14)>>>0)/4294967296}},__shuffleInPlace=(r,i)=>{for(let t=r.length-1;t>0;t--){const o=Math.floor(i()*(t+1));[r[t],r[o]]=[r[o],r[t]]}return r},__GAME_CATALOG=[{id:"snake",href:"/snake.html",emoji:"\u{1F40D}",title:"Snake",subtitle:"Classic growth game"},{id:"breaker",href:"/breaker.html",emoji:"\u{1F9F1}",title:"Block Breaker",subtitle:"Smash the bricks"},{id:"2048",href:"/2048.html",emoji:"\u{1F9E9}",title:"2048",subtitle:"Merge the numbers"},{id:"invaders",href:"/invaders.html",emoji:"\u{1F47E}",title:"Space Invaders",subtitle:"Defend the earth"},{id:"racer",href:"/hobbies-games/racer.html",emoji:"\u{1F3CE}\uFE0F",title:"Racer",subtitle:"Fast reflex racing"},{id:"oh-flip",href:"/hobbies-games/oh-flip.html",emoji:"\u{1F938}",title:"Oh Flip",subtitle:"Timing + tricks"},{id:"onoff",href:"/hobbies-games/onoff.html",emoji:"\u26A1",title:"ON/OFF",subtitle:"Switch-based puzzle"},{id:"1024-moves",href:"/hobbies-games/1024-moves.html",emoji:"\u{1F9E0}",title:"1024 Moves",subtitle:"Move-limited strategy"},{id:"back-attacker",href:"/hobbies-games/back-attacker.html",emoji:"\u{1F6E1}\uFE0F",title:"Back Attacker",subtitle:"Survive the attacks"},{id:"nano-wirebot",href:"/hobbies-games/nano-wirebot.html",emoji:"\u{1F916}",title:"Nano Wirebot",subtitle:"Precision platforming"},{id:"off-the-line",href:"/hobbies-games/off-the-line.html",emoji:"\u{1F9F7}",title:"Off The Line",subtitle:"Don\u2019t cross the line"},{id:"pizza-undelivery",href:"/hobbies-games/pizza-undelivery.html",emoji:"\u{1F355}",title:"Pizza Undelivery",subtitle:"Fast food chaos"},{id:"the-matr13k",href:"/hobbies-games/the-matr13k.html",emoji:"\u{1F9EC}",title:"The Matr13k",subtitle:"Pattern puzzle"},{id:"triangle-back-to-home",href:"/hobbies-games/triangle-back-to-home.html",emoji:"\u{1F53A}",title:"Triangle: Back to Home",subtitle:"Geometry adventure"},{id:"xx142-b2exe",href:"/hobbies-games/xx142-b2exe.html",emoji:"\u{1F9EA}",title:"XX142-B2EXE",subtitle:"Experimental arcade"}],__renderSuggestionGrid=(r,i)=>{if(!r)return;const t=i&&i.count?i.count:6,o=i&&i.currentId?i.currentId:null,n=__getPlayedGames(),e=Date.now(),s=__GAME_CATALOG.filter(E=>E&&E.id&&E.href&&E.id!==o),d=s.filter(E=>!n[E.id]),f=s.filter(E=>!!n[E.id]),m=Math.floor(e/864e5),C=parseInt(sessionStorage.getItem("site_suggest_nonce")||"0",10)||0;sessionStorage.setItem("site_suggest_nonce",String(C+1));const M=m*1e3+C+__hashString(String(window.location.pathname||"/")),w=__mulberry32(M);__shuffleInPlace(d,w),f.sort((E,A)=>{const a=n[E.id]&&n[E.id].lastPlayedAt?n[E.id].lastPlayedAt:0,$=n[A.id]&&n[A.id].lastPlayedAt?n[A.id].lastPlayedAt:0;return a-$}),__shuffleInPlace(f,w);const S=[];for(const E of d){if(S.length>=t)break;S.push(E)}for(const E of f){if(S.length>=t)break;S.push(E)}const p="flex flex-col items-center p-4 bg-white/5 rounded-xl hover:bg-white/10 transition-all group border border-white/5 hover:border-white/20",y="text-4xl mb-3 group-hover:scale-110 transition-transform";r.innerHTML=S.map(E=>`
        <a href="${E.href}" class="${p}" data-game-id="${E.id}">
            <div class="${y}">${E.emoji||"\u{1F3AE}"}</div>
            <div class="font-bold text-sm">${E.title||E.id}</div>
            <div class="text-xs opacity-60 mt-1">${E.subtitle||""}</div>
        </a>
    `).join("")},__initDynamicGameSuggestions=()=>{try{const r=__getCurrentGameId();r&&__markGamePlayed(r);const i=new Set;document.querySelectorAll('a[class*="bg-white/5"][class*="rounded-xl"][class*="hover:bg-white/10"]').forEach(t=>{const o=t.closest(".grid");o&&i.add(o)}),i.forEach(t=>{const o=t.querySelectorAll("a");!o||o.length<4||__renderSuggestionGrid(t,{count:6,currentId:r})})}catch{}},init=()=>{console.log("%c Designed by Estivan Ayramia ","background: #212842; color: #e1d4c2; padding: 4px; border-radius: 4px;"),document.readyState==="loading"?document.addEventListener("DOMContentLoaded",()=>{__ensureStandardEnglishChrome(),initDarkMode(),initAriaCurrent(),initMobileMenu(),__initDynamicGameSuggestions(),loadGSAPAndInit(),initSmoothScroll(),initFormValidation(),initLazyLoading(),initScrollToTop(),initPdfPreviews(),initAchievements(),initKonamiCode(),initPWA(),initAnalytics(),initPerformanceMonitoring(),initPhase2()}):(__ensureStandardEnglishChrome(),initDarkMode(),initAriaCurrent(),initMobileMenu(),__initDynamicGameSuggestions(),loadGSAPAndInit(),initSmoothScroll(),initFormValidation(),initLazyLoading(),initScrollToTop(),initPdfPreviews(),initAchievements(),initKonamiCode(),initPWA(),initAnalytics(),initPerformanceMonitoring(),initPhase2())};init(),document.addEventListener("DOMContentLoaded",()=>{const r="https://portfolio-chat.eayramia.workers.dev/chat",i="/assets/docs/Estivan-Ayramia-Resume.pdf",t="https://www.linkedin.com/in/estivanayramia",n={logistics:{title:"Logistics System",summary:"A systems-focused project centered on execution, coordination, and operational clarity.",img:"/assets/img/project-logistics.jpg",link:"/projects/logistics"},conflict:{title:"Conflict Playbook",summary:"A practical framework for navigating conflict with structure, empathy, and outcomes.",img:"/assets/img/project-conflict.jpg",link:"/deep-dive#conflict"},discipline:{title:"Discipline Routine",summary:"A repeatable routine and mindset system for sustainable discipline and follow-through.",img:"/assets/img/project-discipline.jpg",link:"/projects/discipline"},website:{title:"Portfolio Website",summary:"The site you\u2019re on\u2014built for speed, clarity, and a clean browsing experience.",img:"/assets/img/og-image.png",link:"/"}},e={widget:document.getElementById("chat-widget"),window:document.getElementById("chat-window"),header:document.getElementById("chat-header"),messages:document.getElementById("chat-messages"),input:document.getElementById("chat-input"),sendBtn:document.getElementById("send-btn"),toggleBtn:document.getElementById("chat-toggle"),closeBtn:document.getElementById("close-chat"),bubble:document.getElementById("welcome-bubble"),chipsContainer:document.getElementById("chat-chips"),suggestionsBtn:document.getElementById("suggestions-btn"),suggestionsContainer:document.querySelector('[data-chat-suggestions="container"]'),suggestionsToggle:document.querySelector('[data-chat-suggestions-toggle="button"]'),suggestionsClose:null};(function(){try{if(window.CSS&&CSS.supports&&CSS.supports("animation-timeline","scroll()"))return}catch{}const u=document.querySelector(".scroll-progress");if(!u)return;let c=!1;function h(){const k=document.documentElement,g=window.scrollY||k.scrollTop||0,b=Math.max((k.scrollHeight||document.body.scrollHeight||0)-window.innerHeight,0),_=b>0?Math.min(1,Math.max(0,g/b)):0;u.style.setProperty("--scroll-scale",_),c=!1}const L=function(){c||(c=!0,requestAnimationFrame(h))};window.addEventListener("scroll",L,{passive:!0}),window.addEventListener("resize",L,{passive:!0}),requestAnimationFrame(h)})();const s=document.documentElement.lang||"en";s==="ar"&&e.widget?(e.widget.style.left="1rem",e.widget.style.right="auto",e.bubble&&(e.bubble.style.left="1rem",e.bubble.style.right="auto")):e.widget&&(e.widget.style.right="1rem",e.widget.style.left="auto",e.bubble&&(e.bubble.style.right="1rem",e.bubble.style.left="auto"));let d=[],f=!1,m=!1;const C=`savonie_history:${s}:${window.location.pathname||"/"}`,M=50;function w(){try{const l=[],u=window.location.pathname||"/";l.push(`path: ${u}`),l.push(`title: ${document.title||""}`);const c=Array.from(document.querySelectorAll("h1, h2")).map(L=>(L.textContent||"").trim()).filter(Boolean).slice(0,10);c.length&&(l.push("headings:"),c.forEach(L=>l.push(`- ${L}`)));const h=l.join(`
`);return h.length>3500?h.slice(0,3500):h}catch{return`${window.location.pathname||"/"} | ${document.title||""}`}}try{const l=sessionStorage.getItem(C);l&&(d=JSON.parse(l),d.forEach(u=>{if(u&&u.kind==="card"){W(u.cardId);return}if(!u||u.kind!=="text")return;const c=document.createElement("div"),h="bg-[#212842] text-white rounded-tr-none self-end ml-auto",L="bg-white text-[#362017] rounded-tl-none border border-[#362017]/5 self-start";c.className=`p-3 rounded-lg shadow-sm max-w-[85%] mb-3 text-sm leading-relaxed ${u.sender==="user"?h:L}`,u.sender==="bot"?c.replaceChildren(O(u.text)):c.textContent=u.text,e.messages?.appendChild(c)}),setTimeout(()=>{e.messages&&(e.messages.scrollTop=e.messages.scrollHeight)},100))}catch{}if(d.length===0){const l=document.documentElement.lang||"en",u=translations.chat.welcome[l]||"Hello! I am Savonie. Ask me anything about Estivan.";B(u,"bot",!1)}if(e.chipsContainer){const l=document.documentElement.lang||"en",u=translations.chat.defaultChips[l]||translations.chat.defaultChips.en;R(u)}m=!0;const S=parseInt(sessionStorage.getItem("savonie_bubble_count")||"0");S<2&&setTimeout(()=>{e.window?.classList.contains("hidden")&&d.length===0&&(e.bubble?.classList.remove("opacity-0","translate-y-4"),e.bubble?.classList.add("opacity-100","translate-y-0"),sessionStorage.setItem("savonie_bubble_count",(S+1).toString()))},2500),e.toggleBtn?.addEventListener("click",H),e.closeBtn?.addEventListener("click",H),e.sendBtn?.addEventListener("click",I),e.input?.addEventListener("keydown",l=>{l.key!=="Enter"||l.target&&l.target.tagName==="TEXTAREA"&&l.shiftKey||(l.preventDefault(),I())});function p(l){if(!e.suggestionsContainer){console.log("[Savonie DEBUG] setSuggestionsVisible called but no suggestions container");return}l?(e.suggestionsContainer.classList.remove("savonie-suggestions-hidden"),e.suggestionsContainer.removeAttribute("hidden"),e.suggestionsContainer.style.display="flex"):(e.suggestionsContainer.classList.add("savonie-suggestions-hidden"),e.suggestionsContainer.setAttribute("hidden","true"),e.suggestionsContainer.style.display="none"),console.log("[Savonie DEBUG] setSuggestionsVisible ->",l,"classes:",e.suggestionsContainer.className)}function y(){if(!e.suggestionsContainer){console.log("[Savonie DEBUG] No suggestions container found on this page");return}e.suggestionsToggle?e.suggestionsToggle.addEventListener("click",()=>{const u=e.suggestionsContainer.classList.contains("savonie-suggestions-hidden")||e.suggestionsContainer.hasAttribute("hidden")||e.suggestionsContainer.style.display==="none";console.log("[Savonie DEBUG] Lightbulb clicked, nextVisible =",u),p(u)}):console.log("[Savonie DEBUG] No suggestions toggle (lightbulb) found"),console.log("[Savonie DEBUG] attachSuggestionHandlers complete")}y(),e.chipsContainer&&e.chipsContainer.querySelectorAll(".chip-btn").forEach(l=>{l.addEventListener("click",()=>{e.input&&(e.input.value=l.textContent,I())})});const E=document.getElementById("mic-btn");let A=null,a=!1;if(E&&("webkitSpeechRecognition"in window||"SpeechRecognition"in window)){const l=window.SpeechRecognition||window.webkitSpeechRecognition;A=new l,A.continuous=!1,A.interimResults=!1,A.lang=document.documentElement.lang||"en-US",A.onstart=()=>{a=!0,E.classList.add("listening"),E.setAttribute("aria-label","Listening...")},A.onend=()=>{a=!1,E.classList.remove("listening"),E.setAttribute("aria-label","Voice input")},A.onresult=u=>{const c=u.results[0][0].transcript;if(e.input&&c){e.input.value=c;try{e.input.focus({preventScroll:!0})}catch{e.input.focus()}}},A.onerror=u=>{console.warn("Speech recognition error:",u.error),a=!1,E.classList.remove("listening")},E.addEventListener("click",()=>{a?A.stop():A.start()})}else E&&(E.style.display="none");function $(l){const u=[],c=[...l].reverse().find(g=>g.sender==="user")?.text?.toLowerCase()||"",h=[...l].reverse().find(g=>g.sender==="bot")?.text?.toLowerCase()||"",L=U(c),k=translations.chat.contextualSuggestions;return c.includes("skill")||c.includes("technology")||c.includes("expertise")||c.includes("habilidad")||c.includes("tecnolog\xEDa")||c.includes("experiencia")||c.includes("\u0645\u0647\u0627\u0631\u0629")||c.includes("\u062A\u0643\u0646\u0648\u0644\u0648\u062C\u064A\u0627")||c.includes("\u062E\u0628\u0631\u0629")?u.push(...k[L]?.skills||["What projects have you worked on?","Tell me about your experience","What are you learning currently?"]):c.includes("background")||c.includes("experience")||c.includes("career")||c.includes("fondo")||c.includes("experiencia")||c.includes("carrera")||c.includes("\u062E\u0644\u0641\u064A\u0629")||c.includes("\u062E\u0628\u0631\u0629")||c.includes("\u0645\u0633\u064A\u0631\u0629")?u.push(...k[L]?.background||["What are your main skills?","Tell me about your education","What industries have you worked in?"]):c.includes("project")||c.includes("work")||c.includes("portfolio")||c.includes("proyecto")||c.includes("trabajo")||c.includes("portafolio")||c.includes("\u0645\u0634\u0631\u0648\u0639")||c.includes("\u0639\u0645\u0644")||c.includes("\u0645\u062D\u0641\u0638\u0629")?u.push(...k[L]?.projects||["Can you show me your code?","What technologies did you use?","How long did it take to build?"]):c.includes("contact")||c.includes("reach")||c.includes("email")||c.includes("contacto")||c.includes("alcanzar")||c.includes("correo")||c.includes("\u0627\u062A\u0635\u0627\u0644")||c.includes("\u0627\u0644\u0648\u0635\u0648\u0644")||c.includes("\u0628\u0631\u064A\u062F")?u.push(...k[L]?.contact||["Are you available for freelance work?","What's your typical response time?","Do you work remotely?"]):c.includes("education")||c.includes("study")||c.includes("learn")||c.includes("educaci\xF3n")||c.includes("estudio")||c.includes("aprender")||c.includes("\u062A\u0639\u0644\u064A\u0645")||c.includes("\u062F\u0631\u0627\u0633\u0629")||c.includes("\u062A\u0639\u0644\u0645")?u.push(...k[L]?.education||["What certifications do you have?","What's your favorite programming language?","How do you stay updated with technology?"]):h.includes("project")||h.includes("work")||h.includes("proyecto")||h.includes("trabajo")||h.includes("\u0645\u0634\u0631\u0648\u0639")||h.includes("\u0639\u0645\u0644")?u.push(...k[L]?.projectResponse||["Can you tell me more about that project?","What challenges did you face?","What did you learn from it?"]):h.includes("skill")||h.includes("technology")||h.includes("habilidad")||h.includes("tecnolog\xEDa")||h.includes("\u0645\u0647\u0627\u0631\u0629")||h.includes("\u062A\u0643\u0646\u0648\u0644\u0648\u062C\u064A\u0627")?u.push(...k[L]?.skillResponse||["How did you learn that?","Have you used it in projects?","What's your proficiency level?"]):l.length<4&&u.push(...k[L]?.early||["What are your main skills?","Tell me about your background","What projects are you proud of?"]),u.slice(0,3)}function U(l){return l?/[\u0600-\u06FF]/.test(l)?"ar":/\b(qué|como|dónde|cuándo|por qué|está|son|tiene|trabajo|habilidades?|experiencia|proyecto|contacto)\b/i.test(l)?"es":"en":"en"}function D(l){const u=document.createDocumentFragment();if(!l)return u;const c=g=>{try{const b=new URL(String(g));return b.protocol!=="http:"&&b.protocol!=="https:"?null:b.toString()}catch{return null}},h=(g,b)=>{const _=document.createElement("a");return _.href=g,_.target="_blank",_.rel="noopener noreferrer",_.className="text-[#212842] underline hover:text-[#362017] font-medium",_.textContent=b,_},L=(g,b)=>{const _=/\[([^\]]+)\]\(([^)\s]+)\)|\bhttps?:\/\/[^\s<]+/g,j=String(b);let P=0,T;for(;(T=_.exec(j))!==null;){if(T.index>P&&g.appendChild(document.createTextNode(j.slice(P,T.index))),T[1]&&T[2]){const N=c(T[2]);N?g.appendChild(h(N,T[1])):g.appendChild(document.createTextNode(T[0]))}else{const N=c(T[0]);N?g.appendChild(h(N,T[0])):g.appendChild(document.createTextNode(T[0]))}P=_.lastIndex}P<j.length&&g.appendChild(document.createTextNode(j.slice(P)))},k=String(l).split(/\n/);for(let g=0;g<k.length;g++)L(u,k[g]),g<k.length-1&&u.appendChild(document.createElement("br"));return u}function q(l){const u=document.createElement("template");u.innerHTML=String(l||"");const c=new Set(["P","BR","STRONG","EM","CODE","PRE","UL","OL","LI","A","BLOCKQUOTE"]),h=k=>{if(!k)return null;const g=String(k).trim();if(g.startsWith("/"))return g;try{const b=new URL(g);return b.protocol==="http:"||b.protocol==="https:"?b.toString():null}catch{return null}},L=k=>{const g=Array.from(k.childNodes);for(const b of g)if(b.nodeType===Node.ELEMENT_NODE){const _=b,j=_.tagName;if(!c.has(j)){const T=document.createTextNode(_.textContent||"");_.replaceWith(T);continue}const P=Array.from(_.attributes);for(const T of P)_.removeAttribute(T.name);if(j==="A"){const T=h(_.getAttribute("href"));if(!T){const N=document.createTextNode(_.textContent||"");_.replaceWith(N);continue}_.setAttribute("href",T),_.setAttribute("target","_blank"),_.setAttribute("rel","noopener noreferrer"),_.className="text-[#212842] underline hover:text-[#362017] font-medium"}L(_)}};return L(u.content),u.content}function O(l){const u=String(l||""),c=typeof window<"u"&&window.marked&&typeof window.marked.parse=="function"?window.marked:null;if(!c)return D(u);const h=u.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;");try{const L=c.parse(h);return q(L)}catch{return D(u)}}window.__savonieXssSelfTest=function(){const u=["<img src=x onerror=alert(1)>","[bad](javascript:alert(1))","[ok](https://example.com)","https://example.com/test?x=<script>alert(1)<\/script>",`Line 1
Line 2 with https://example.com`].map(c=>{const h=document.createElement("div");return h.appendChild(D(c)),h.innerHTML});return console.log("[Savonie] XSS self-test rendered HTML:",u),u};function R(l){if(!e.chipsContainer)return;if(e.chipsContainer.innerHTML="",!l||l.length===0){p(!1);return}l.forEach(c=>{const h=document.createElement("button");h.className="chip-btn text-xs bg-white border border-[#212842]/20 text-[#212842] px-3 py-1 rounded-full hover:bg-[#212842] hover:text-white transition-colors",h.textContent=c,h.addEventListener("click",()=>{e.input&&(e.input.value=c,I())}),e.chipsContainer.appendChild(h)});const u=document.createElement("button");u.className="chip-close-btn text-xs text-[#362017]/60 hover:text-[#362017] px-2 py-1 ml-2 transition-colors",u.setAttribute("data-chat-suggestions-close","button"),u.innerHTML="\xD7",u.title="Hide suggestions",u.addEventListener("click",c=>{c.preventDefault(),c.stopPropagation(),console.log("[Savonie DEBUG] Suggestions close X clicked, hiding suggestions"),p(!1)}),e.chipsContainer.appendChild(u),e.suggestionsClose=u,p(!0)}function H(){const l=e.window?.classList.contains("hidden"),u=document.documentElement.dir==="rtl";if(l?(e.window?.classList.remove("hidden"),e.window?.classList.add("flex"),typeof clarity=="function"&&clarity("event","chat_open"),typeof gtag=="function"&&gtag("event","chat_open",{event_category:"Chatbot"})):(e.window?.classList.remove("flex"),e.window?.classList.add("hidden"),typeof clarity=="function"&&clarity("event","chat_close"),typeof gtag=="function"&&gtag("event","chat_close",{event_category:"Chatbot"})),!e.window?.classList.contains("hidden")){if(l){const c=e.widget?.getBoundingClientRect();if(c){let g=c.left/16,b=c.top/16-31.25-1;g+20>window.innerWidth/16&&(g=window.innerWidth/16-20-1),g<1&&(g=1),b<1&&(b=1),e.window.style.position="fixed",e.window.style.left=`${g}rem`,e.window.style.top=`${b}rem`,e.window.style.right="auto",e.window.style.zIndex="10000"}else e.window.style.position="",e.window.style.left="",e.window.style.top="",e.window.style.right="",e.window.style.zIndex=""}e.bubble&&(e.bubble.style.display="none"),setTimeout(()=>{try{e.input?.focus({preventScroll:!0})}catch{e.input?.focus&&e.input.focus()}e.messages&&(e.messages.scrollTop=e.messages.scrollHeight)},100)}}async function v(){if(navigator.onLine)return!0;try{const l=new AbortController,u=setTimeout(()=>l.abort(),3e3),c=await fetch("/favicon.ico",{method:"HEAD",cache:"no-cache",signal:l.signal});return clearTimeout(u),c.ok}catch{return!1}}async function I(){if(!e.input)return;const l=e.input.value.trim();if(!l||f)return;if(f=!0,typeof gtag=="function"&&gtag("event","chat_question",{event_category:"Chatbot",event_label:"User Asked Question"}),typeof clarity=="function"&&clarity("event","chat_question"),!await v()){B(l,"user"),e.input.value="",B("You appear to be offline. Please check your connection and try again.","bot"),f=!1;return}B(l,"user"),e.input.value="";const c=B("Thinking...","bot",!0),h=3e4,L=2;let k=null,g=null;for(let b=0;b<=L;b++){const _=new AbortController,j=setTimeout(()=>_.abort(),h);try{const P=await fetch(r,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({message:l,pageContent:w(),language:s}),signal:_.signal});if(clearTimeout(j),!P.ok)if(P.status>=500){if(k={type:"server",status:P.status},b<L){await new Promise(T=>setTimeout(T,1e3*(b+1)));continue}}else if(P.status===429){k={type:"rate_limit"};break}else{k={type:"client",status:P.status};break}g=await P.json(),k=null;break}catch(P){if(clearTimeout(j),P.name==="AbortError"){if(k={type:"timeout"},b<L)continue}else if(k={type:"network",message:P.message},b<L){await new Promise(T=>setTimeout(T,1e3*(b+1)));continue}}}if(k){x(c);let b;switch(k.type){case"timeout":b="The request took too long. The AI service might be busy. Please try again in a moment.";break;case"rate_limit":b="Too many requests. Please wait a moment before sending another message.";break;case"server":b="The AI service is temporarily unavailable. Please try again in a few seconds.";break;case"network":b="Connection lost. Please check your internet connection and try again.";break;default:b="Something went wrong. Please try again."}B(b,"bot"),f=!1;return}if(x(c),g&&g.errorType){let b="Something went wrong. Please try again.";g.errorType==="RateLimit"?b="Too many requests. Please wait a moment before trying again.":g.errorType==="BadRequest"?b="Please rephrase your question and try again.":g.errorType==="UpstreamError"&&(b="Service hiccup\u2014please try again in a moment."),B(b,"bot"),f=!1;return}if(g.reply&&(g.reply=g.reply.replace(/\n?\s*\{\s*"(reply|chips|action|card|errorType)"[\s\S]*$/,"").trim(),B(g.reply,"bot")),g.chips&&Array.isArray(g.chips)&&e.chipsContainer&&R(g.chips),g.action){if(g.action==="download_resume")try{window.open(i,"_blank","noopener")}catch{const _=document.createElement("a");_.href=i,_.target="_blank",_.rel="noopener noreferrer",_.download="Estivan-Ayramia-Resume.pdf",_.style.display="none",document.body.appendChild(_),_.click(),document.body.removeChild(_)}else if(g.action==="email_link")window.location.href="mailto:hello@estivanayramia.com";else if(g.action==="open_linkedin")try{window.open(t,"_blank","noopener")}catch{}}if(g.card&&W(g.card),!g.chips&&d.length>0){const b=$(d);b.length>0&&e.chipsContainer&&R(b)}f=!1}function B(l,u,c=!1){if(!e.messages)return;const h=document.createElement("div");h.id=c?"loading-msg":"";const L="bg-[#212842] text-white rounded-tr-none self-end ml-auto",k="bg-white text-[#362017] rounded-tl-none border border-[#362017]/5 self-start";if(h.className=`p-3 rounded-lg shadow-sm max-w-[70%] mb-3 text-sm leading-relaxed ${u==="user"?L:k}`,e.messages.appendChild(h),u==="bot"&&!c){let g=0;h.textContent="";const b=setInterval(()=>{g<l.length?(h.textContent+=l[g],g++,e.messages.scrollTop=e.messages.scrollHeight):(clearInterval(b),h.replaceChildren(O(l)),e.messages.scrollTop=e.messages.scrollHeight)},12)}else u==="bot"?h.replaceChildren(O(l)):h.textContent=l;return!c&&m&&(d.push({kind:"text",text:l,sender:u}),d.length>M&&(d=d.slice(d.length-M)),sessionStorage.setItem(C,JSON.stringify(d))),e.messages.scrollTop=e.messages.scrollHeight,h.id}function W(l){if(!e.messages||!n[l])return;const u=n[l],c=document.createElement("div");c.className="bg-white rounded-lg shadow-md overflow-hidden border border-[#362017]/10 mb-3 max-w-[85%] self-start";const h=document.createElement("div");h.className="p-3";const L=document.createElement("h4");L.className="font-semibold text-[#212842] mb-1",L.textContent=u.title;const k=document.createElement("p");k.className="text-xs text-[#362017]/80 mb-3 leading-relaxed",k.textContent=u.summary||"";const g=document.createElement("a");if(g.href=u.link,g.className="inline-block bg-[#212842] text-white px-4 py-2 rounded-lg text-sm hover:bg-[#362017] transition-colors",g.textContent="View",h.appendChild(L),u.summary&&h.appendChild(k),h.appendChild(g),u.img){const b=document.createElement("img");b.src=u.img,b.alt=u.title,b.className="w-full h-32 object-cover",b.addEventListener("error",()=>{try{b.remove()}catch{}}),c.appendChild(b)}c.appendChild(h),e.messages.appendChild(c),e.messages.scrollTop=e.messages.scrollHeight,m&&(d.push({kind:"card",cardId:l}),d.length>M&&(d=d.slice(d.length-M)),sessionStorage.setItem(C,JSON.stringify(d)))}function x(l){const u=document.getElementById(l);u&&u.remove()}if(e.header&&e.window){let l=!1,u,c,h,L;const k=document.documentElement.dir==="rtl";e.header.style.cursor="move",e.header.addEventListener("mousedown",g=>{if(g.target.closest("#close-chat"))return;l=!0,u=g.clientX,c=g.clientY;const b=e.window.getBoundingClientRect();if(h=b.left,L=b.top,e.header.style.cursor="grabbing",document.body.style.userSelect="none",e.window.style.position!=="fixed"){if(e.window.style.position="fixed",k){const _=window.innerWidth-b.right;e.window.style.right=`${_}px`,e.window.style.left="auto"}else e.window.style.left=`${h}px`;e.window.style.top=`${L}px`,e.window.style.zIndex="10000"}}),document.addEventListener("mousemove",g=>{if(!l)return;g.preventDefault();const b=g.clientX-u,_=g.clientY-c,j=e.window.offsetWidth,P=e.window.offsetHeight,T=10;if(k){let Y=window.innerWidth-h-j-b;Y=Math.max(T,Math.min(Y,window.innerWidth-j-T)),e.window.style.right=`${Y}px`,e.window.style.left="auto"}else{let Y=h+b;Y=Math.max(T,Math.min(Y,window.innerWidth-j-T)),e.window.style.left=`${Y}px`,e.window.style.right="auto"}let N=L+_;N=Math.max(T,Math.min(N,window.innerHeight-P-T)),e.window.style.top=`${N}px`}),document.addEventListener("mouseup",()=>{l&&(l=!1,e.header.style.cursor="move",document.body.style.userSelect="")})}document.addEventListener("keydown",l=>{l.key==="Escape"&&!e.window?.classList.contains("hidden")&&H(),(l.ctrlKey||l.metaKey)&&l.key==="k"&&(l.preventDefault(),H())})}),document.addEventListener("DOMContentLoaded",()=>{const r=()=>{const t=document.createElement("div");t.className="rounded-xl border border-chocolate/20 bg-white/40 overflow-hidden p-8 text-center";const o=document.createElement("p");return o.className="text-sm text-chocolate/70",o.textContent="Inline PDF preview may be blocked by hosting or browser settings. Use the buttons below to open or download the deck.",t.appendChild(o),t},i=(t,o)=>{if(!t||!o||t.dataset.pdfLoaded)return;t.innerHTML="";const n=document.createElement("div");n.className="py-12 text-sm text-chocolate/60",n.textContent="Attempting to load inline preview\u2026",t.appendChild(n);const e=document.createElement("iframe");e.src=o,e.title="PDF preview",e.style.width="100%",e.style.height="480px",e.style.border="0",e.loading="lazy";let s=!1;const d=setTimeout(()=>{s=!0,console.log("PDF load timeout - assuming success");try{n.remove()}catch{}t.contains(e)||t.appendChild(e),t.dataset.pdfLoaded="true"},5e3),f=()=>{clearTimeout(d);try{e.remove()}catch{}t.innerHTML="",t.appendChild(r()),t.dataset.pdfLoaded="false"};e.addEventListener("load",()=>{clearTimeout(d);try{try{n.remove()}catch{}t.contains(e)||t.appendChild(e),t.dataset.pdfLoaded="true"}catch{f()}}),e.addEventListener("error",f),t.appendChild(e)};document.querySelectorAll(".preview-toggle").forEach(t=>{const o=t.closest("section"),n=o&&o.querySelector(".preview-panel");let e=null;o&&(e=o.querySelector('a[href$=".pdf"]')||o.querySelector('a[href*=".pdf?"]'));const s=e?e.getAttribute("href"):null;n&&s&&i(n,s),t.addEventListener("click",()=>{if(!n)return;n.classList.toggle("hidden");const d=!n.classList.contains("hidden");t.textContent=d?"Hide preview":"Show preview",typeof clarity=="function"&&clarity("event",d?"pdf_preview_show":"pdf_preview_hide"),typeof gtag=="function"&&gtag("event",d?"pdf_preview_show":"pdf_preview_hide",{event_category:"PDF"}),d&&!n.dataset.pdfLoaded&&s&&i(n,s)})})});
