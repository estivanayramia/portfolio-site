 ...
 */let __userInteracting=!1,__userInteractingTimer=null;const __markUserInteraction=()=>{__userInteracting=!0,__userInteractingTimer&&clearTimeout(__userInteractingTimer),__userInteractingTimer=setTimeout(()=>{__userInteracting=!1},1e3)};["touchstart","touchmove","wheel","scroll"].forEach(r=>{try{window.addEventListener(r,__markUserInteraction,{passive:!0})}catch{window.addEventListener(r,__markUserInteraction)}});const __initDeferredStylesheets=()=>{try{document.querySelectorAll('link[rel="stylesheet"][media="print"][data-media]').forEach(i=>{const t=i.getAttribute("data-media")||"all",o=()=>{try{i.media=t}catch{}};try{i.addEventListener("load",o,{once:!0})}catch{i.addEventListener("load",o)}try{i.addEventListener("error",o,{once:!0})}catch{i.addEventListener("error",o)}setTimeout(()=>{try{i.sheet&&o()}catch{}},0)})}catch{}};__initDeferredStylesheets();const __initPreloadStylesheets=()=>{try{document.querySelectorAll('link[rel="preload"][as="style"][data-onload-rel]').forEach(i=>{const t=i.getAttribute("data-onload-rel")||"stylesheet",o=()=>{try{i.rel=t,i.removeAttribute("data-onload-rel")}catch{}};try{i.addEventListener("load",o,{once:!0})}catch{i.addEventListener("load",o)}try{if(typeof performance<"u"&&typeof performance.getEntriesByName=="function"){const n=i.href,e=n?performance.getEntriesByName(n):[];if(e&&e.length){const s=e[0];s&&typeof s.responseEnd=="number"&&s.responseEnd>0&&o()}}}catch{}})}catch{}};__initPreloadStylesheets();const __initCarouselAndLightbox=()=>{try{const r=document.getElementById("carouselTrack");if(!r||r.dataset&&r.dataset.carouselInit==="1")return;const i=!!(r.dataset&&r.dataset.carouselWrap==="1"),t=Array.from(document.querySelectorAll(".note-card img")),o=t.length>0,n=Array.from(document.querySelectorAll(".carousel-slide"));if(!n.length)return;const e=document.getElementById("carouselPrev"),s=document.getElementById("carouselNext"),d=document.getElementById("carouselDots"),h=document.getElementById("lightbox"),m=document.getElementById("lightbox-image"),C=document.querySelector(".lightbox-close"),D=document.querySelector(".lightbox-prev"),v=document.querySelector(".lightbox-next");if(!e||!s||!d||!h||!m||!C||!D||!v)return;const _=n.map(x=>x.querySelector("img")).filter(Boolean),p=o?t:_;if(!p.length)return;let f=0,T=0;const A=()=>o?window.innerWidth>=1024?5:window.innerWidth>=768?4:window.innerWidth>=640?3:2:window.innerWidth>=768?3:2;let a=A();const $=()=>{try{d.innerHTML=""}catch{for(;d.firstChild;)d.removeChild(d.firstChild)}},Y=()=>{try{h.classList.remove("active"),h.setAttribute("aria-hidden","true")}catch{}},q=()=>Math.ceil(n.length/a),W=()=>{try{const x=(n[0]&&n[0].offsetWidth?n[0].offsetWidth:0)+16,j=q();if(o){const N=Math.max(0,n.length-a);f=Math.max(0,Math.min(f,N)),r.style.transform=`translateX(-${f*x}px)`}else f=Math.max(0,Math.min(f,j-1)),r.style.transform=`translateX(-${f*x*a}px)`;Array.from(document.querySelectorAll(".carousel-dot")).forEach((N,R)=>{const E=o?Math.floor(f/a):f;N.classList.toggle("active",R===E)})}catch{}},F=()=>{$();const x=q();for(let j=0;j<x;j++){const N=document.createElement("button");N.className="carousel-dot"+(j===0?" active":"");try{N.setAttribute("aria-label",`Go to page ${j+1}`)}catch{}N.addEventListener("click",()=>{if(o){const R=Math.max(0,n.length-a);f=Math.max(0,Math.min(j*a,R))}else f=i?(j+x)%x:Math.max(0,Math.min(j,x-1));W()}),d.appendChild(N)}W()};e.addEventListener("click",()=>{const x=q();if(o){const j=Math.max(0,n.length-a);i?(f=f-a,f<0&&(f=j)):f=Math.max(0,f-a)}else f=i?(f-1+x)%x:Math.max(0,Math.min(f-1,x-1));W()}),s.addEventListener("click",()=>{const x=q();if(o){const j=Math.max(0,n.length-a);i?(f=f+a,f>j&&(f=0)):f=Math.min(j,f+a)}else f=i?(f+1)%x:Math.max(0,Math.min(f+1,x-1));W()});const U=x=>{const j=p[x];if(j){T=x,m.src=j.src,m.alt=j.alt||"";try{m.style.transform=j.style&&j.style.transform?j.style.transform:""}catch{}if(o){try{D.style.display=x>0?"block":"none"}catch{}try{v.style.display=x<p.length-1?"block":"none"}catch{}}}},H=x=>{U(x),h.classList.add("active"),h.setAttribute("aria-hidden","false")};o?p.forEach((x,j)=>{x.addEventListener("click",()=>H(j))}):n.forEach((x,j)=>{x.addEventListener("click",()=>H(j))}),C.addEventListener("click",Y),h.addEventListener("click",x=>{x.target===h&&Y()}),D.addEventListener("click",x=>{x&&x.stopPropagation&&x.stopPropagation(),o?T>0&&U(T-1):U((T-1+p.length)%p.length)}),v.addEventListener("click",x=>{x&&x.stopPropagation&&x.stopPropagation(),o?T<p.length-1&&U(T+1):U((T+1)%p.length)}),document.addEventListener("keydown",x=>{h.classList.contains("active")&&(x.key==="Escape"&&Y(),x.key==="ArrowLeft"&&D.click(),x.key==="ArrowRight"&&v.click())}),window.addEventListener("resize",()=>{const x=A();x!==a?(a=x,F()):W()});try{r.dataset.carouselInit="1"}catch{}F()}catch{}};document.readyState==="loading"?document.addEventListener("DOMContentLoaded",__initCarouselAndLightbox):__initCarouselAndLightbox();const __collectLogsEnabled=typeof window<"u"&&new URLSearchParams(window.location.search).has("collect-logs"),__collectedLogs=[],__saveCollected=()=>{try{localStorage.setItem("site_collect_logs",JSON.stringify(__collectedLogs.slice(-1e3)))}catch{}},__logCollect=(r,i)=>{if(__collectLogsEnabled)try{const t={t:Date.now(),msg:String(r),data:i||null,scrollY:window.scrollY||0};__collectedLogs.push(t),__saveCollected()}catch{}},__collectLogsParam=typeof window<"u"?new URLSearchParams(window.location.search).get("collect-logs"):null,__collectSnapshots=!!(__collectLogsParam&&/snapshot/i.test(__collectLogsParam)),__maybeTakeSnapshot=(r,i)=>{if(__collectSnapshots)try{const t=document.activeElement,o=e=>{if(!e||!e.getBoundingClientRect)return null;const s=e.getBoundingClientRect();return{tag:e.tagName||null,id:e.id||null,classes:e.className||null,rect:{x:Math.round(s.x),y:Math.round(s.y),w:Math.round(s.width),h:Math.round(s.height),top:Math.round(s.top),left:Math.round(s.left)},focusable:typeof e.tabIndex=="number"?e.tabIndex:null,ariaRole:e.getAttribute&&(e.getAttribute("role")||null)}},n={reason:r||null,ts:Date.now(),scrollY:window.scrollY||0,innerWidth:window.innerWidth||0,innerHeight:window.innerHeight||0,docHeight:document.documentElement.scrollHeight||document.body.scrollHeight||0,target:o(i||document.activeElement)||null,activeElement:o(t)||null};__logCollect("snapshot",n)}catch{}};if(__collectLogsEnabled){let r=null;window.addEventListener("scroll",()=>{r||(r=setTimeout(()=>{__logCollect("scroll",{y:window.scrollY,innerHeight:window.innerHeight,docHeight:document.documentElement.scrollHeight}),r=null},200))},{passive:!0});try{"serviceWorker"in navigator&&navigator.serviceWorker.addEventListener("controllerchange",()=>{__logCollect("controllerchange",{controller:!!navigator.serviceWorker.controller})})}catch{}try{const t=window.location.reload.bind(window.location);window.location.reload=function(){return __logCollect("location.reload called"),t()}}catch{}(()=>{const t=document.createElement("button");t.id="collect-logs-btn",t.textContent="Logs",Object.assign(t.style,{position:"fixed",left:"8px",bottom:"12px",zIndex:99999,padding:"6px 8px",fontSize:"12px",background:"rgba(33,40,66,0.85)",color:"#e1d4c2",border:"1px solid rgba(225,212,194,0.08)",borderRadius:"6px"}),t.addEventListener("click",()=>{try{const o=JSON.stringify(__collectedLogs,null,2),n=new Blob([o],{type:"application/json"}),e=URL.createObjectURL(n),s=document.createElement("a");s.href=e,s.download=`site-logs-${Date.now()}.json`,document.body.appendChild(s),s.click(),s.remove(),URL.revokeObjectURL(e)}catch{const n=window.open();if(n)try{const e=JSON.stringify(__collectedLogs,null,2),s=n.document;s.title="Site logs",s.body.style.margin="0";const d=s.createElement("pre");d.style.margin="0",d.style.padding="12px",d.textContent=e,s.body.appendChild(d)}catch{}}}),document.addEventListener("DOMContentLoaded",()=>{document.body.appendChild(t)})})();try{document.addEventListener("visibilitychange",()=>__logCollect("visibilitychange",{hidden:document.hidden})),window.addEventListener("hashchange",t=>__logCollect("hashchange",{oldURL:t.oldURL,newURL:t.newURL})),window.addEventListener("popstate",t=>__logCollect("popstate",{state:t.state})),window.addEventListener("beforeunload",t=>__logCollect("beforeunload",{})),window.addEventListener("focusin",t=>{try{__logCollect("focusin",{tag:t.target&&t.target.tagName,id:t.target&&t.target.id||null,class:t.target&&t.target.className||null})}catch{}}),(function(){const t=HTMLElement.prototype.focus;t.__wrappedByCollectLogs||(HTMLElement.prototype.focus=function(){try{__logCollect("element.focus.called",{tag:this.tagName,id:this.id||null,options:arguments[0]||null})}catch{}try{__maybeTakeSnapshot&&__maybeTakeSnapshot("focus",this)}catch{}try{return t.apply(this,arguments)}catch{try{return t.call(this)}catch{}}},HTMLElement.prototype.focus.__wrappedByCollectLogs=!0)})(),(function(){const t=Element.prototype;if(!t.__scrollIntoViewLogged){const o=t.scrollIntoView;t.scrollIntoView=function(){try{__logCollect("element.scrollIntoView",{tag:this.tagName,id:this.id||null,args:Array.from(arguments)})}catch{}try{__maybeTakeSnapshot&&__maybeTakeSnapshot("scrollIntoView",this)}catch{}return o.apply(this,arguments)},t.__scrollIntoViewLogged=!0}})();try{const t=window.scrollTo;window.scrollTo=function(){try{__logCollect("window.scrollTo",{args:Array.from(arguments)})}catch{}try{__maybeTakeSnapshot&&__maybeTakeSnapshot("window.scrollTo",null)}catch{}return t.apply(window,arguments)}}catch{}try{const t=window.scrollBy;window.scrollBy=function(){try{__logCollect("window.scrollBy",{args:Array.from(arguments)})}catch{}try{__maybeTakeSnapshot&&__maybeTakeSnapshot("window.scrollBy",null)}catch{}return t.apply(window,arguments)}}catch{}try{const t=window.fetch;window.fetch=function(o,n){try{__logCollect("fetch.start",{url:o&&o.url||o,method:n&&n.method||"GET"})}catch{}return t.apply(this,arguments).then(e=>{try{__logCollect("fetch.end",{url:e&&e.url||o,status:e.status})}catch{}return e}).catch(e=>{try{__logCollect("fetch.error",{url:o,message:e&&e.message})}catch{}throw e})}}catch{}try{let o=function(){const n=new t;let e=null;const s=n.open;n.open=function(h,m){e=m;try{__logCollect("xhr.open",{method:h,url:m})}catch{}return s.apply(n,arguments)};const d=n.send;return n.send=function(){try{__logCollect("xhr.send",{url:e})}catch{}return n.addEventListener("loadend",function(){try{__logCollect("xhr.loadend",{url:e,status:n.status})}catch{}}),d.apply(n,arguments)},n};var WrappedXHR=o;const t=window.XMLHttpRequest;o.prototype=t.prototype,window.XMLHttpRequest=o}catch{}window.addEventListener("resize",()=>__logCollect("resize",{innerWidth:window.innerWidth,innerHeight:window.innerHeight})),window.addEventListener("orientationchange",()=>__logCollect("orientationchange",{orientation:window.orientation}));try{if(navigator.serviceWorker&&navigator.serviceWorker.register){const t=navigator.serviceWorker.register.bind(navigator.serviceWorker);navigator.serviceWorker.register=function(){const o=arguments;try{__logCollect("sw.register.start",{scope:o&&o[1]&&o[1].scope||null,script:o&&o[0]})}catch{}return t.apply(navigator.serviceWorker,arguments).then(n=>{try{__logCollect("sw.register.done",{scope:n.scope})}catch{}try{n.addEventListener("updatefound",()=>__logCollect("sw.updatefound",{})),n.waiting&&__logCollect("sw.waiting",{})}catch{}return n}).catch(n=>{try{__logCollect("sw.register.error",{message:n&&n.message})}catch{}throw n})}}}catch{}try{if(typeof ScrollTrigger<"u"&&ScrollTrigger&&ScrollTrigger.refresh){const t=ScrollTrigger.refresh.bind(ScrollTrigger);ScrollTrigger.refresh=function(){try{__logCollect("ScrollTrigger.refresh",{args:Array.from(arguments)})}catch{}return t.apply(this,arguments)}}}catch{}["touchend","pointerup","mouseup"].forEach(t=>{window.addEventListener(t,o=>{try{__logCollect("gesture."+t,{x:o.changedTouches&&o.changedTouches[0]&&o.changedTouches[0].clientX||o.clientX||null,y:o.changedTouches&&o.changedTouches[0]&&o.changedTouches[0].clientY||o.clientY||null})}catch{}},{passive:!0})});try{let t=document.documentElement.scrollHeight||document.body.scrollHeight||0;new MutationObserver(()=>{try{const n=document.documentElement.scrollHeight||document.body.scrollHeight||0;if(n!==t){__logCollect("docHeight.change",{from:t,to:n});try{__maybeTakeSnapshot&&__maybeTakeSnapshot("docHeight.change",document.documentElement)}catch{}t=n}}catch{}}).observe(document.documentElement||document.body,{childList:!0,subtree:!0,attributes:!0})}catch{}try{const o=n=>{try{const e=JSON.stringify(n,(s,d)=>typeof s=="string"&&/pass(word)?|token|secret|auth|credit|cc-number|card|ssn|cvv/i.test(s)?"[REDACTED]":typeof d=="string"&&d.length>200?d.slice(0,200)+"\u2026[truncated]":d);return e.length>8192?e.slice(0,8192)+"...[truncated]":e}catch{return String(n)}};try{["log","info","warn","error","debug"].forEach(n=>{const e=console[n]&&console[n].bind(console);e&&(console[n]=function(){try{__logCollect("console."+n,{args:Array.from(arguments).map(s=>typeof s=="object"?o(s):String(s))})}catch{}try{(n==="error"||n==="warn")&&__maybeTakeSnapshot&&__maybeTakeSnapshot("console."+n,document.activeElement)}catch{}return e.apply(console,arguments)})})}catch{}window.addEventListener("error",n=>{try{__logCollect("window.error",{message:n.message,filename:n.filename,lineno:n.lineno,colno:n.colno,stack:n.error&&n.error.stack?String(n.error.stack).slice(0,1e3):null});try{__maybeTakeSnapshot&&__maybeTakeSnapshot("error",n&&n.target?n.target:document.activeElement)}catch{}}catch{}}),window.addEventListener("unhandledrejection",n=>{try{__logCollect("unhandledrejection",{reason:n.reason&&(n.reason.stack?String(n.reason.stack).slice(0,1e3):String(n.reason))})}catch{}});try{const n=localStorage.setItem.bind(localStorage);localStorage.setItem=function(e,s){try{__logCollect("localStorage.setItem",{key:String(e),size:s&&s.length||0})}catch{}return n(e,s)}}catch{}try{const n=sessionStorage.setItem.bind(sessionStorage);sessionStorage.setItem=function(e,s){try{__logCollect("sessionStorage.setItem",{key:String(e),size:s&&s.length||0})}catch{}return n(e,s)}}catch{}try{if(navigator&&navigator.sendBeacon){const n=navigator.sendBeacon.bind(navigator);navigator.sendBeacon=function(e,s){try{__logCollect("navigator.sendBeacon",{url:String(e),dataSize:s&&s.size||null})}catch{}return n(e,s)}}}catch{}try{document.addEventListener("click",n=>{try{const e=n.target&&(n.target.closest?n.target.closest("a,button,input,select,textarea,summary"):n.target);if(!e)return;const s=(e.tagName||"").toLowerCase(),d={tag:s,id:e.id||null,classes:e.className||null};s==="a"&&e.href&&(d.href=e.href.length>200?e.href.slice(0,200)+"\u2026":e.href),__logCollect("dom.click",d);try{["a","button","input","textarea","select"].includes(s)&&__maybeTakeSnapshot&&__maybeTakeSnapshot("click",e)}catch{}}catch{}},{passive:!0}),document.addEventListener("submit",n=>{try{const e=n.target;if(!e||!e.tagName||e.tagName.toLowerCase()!=="form")return;const s=Array.from(e.elements||[]).filter(d=>d.name).map(d=>({name:d.name,type:d.type||d.tagName}));__logCollect("form.submit",{action:e.action||null,method:e.method||"GET",fields:s})}catch{}},!0)}catch{}try{document.addEventListener("input",n=>{try{const e=n.target;if(!e)return;const s=e.tagName&&e.tagName.toLowerCase();if(s==="input"||s==="textarea"||s==="select"){const d={tag:s,type:e.type||null,name:e.name||null,valueLength:e.value&&e.value.length||0};__logCollect("input",d)}}catch{}},{passive:!0})}catch{}try{document.addEventListener("selectionchange",()=>{try{const n=document.getSelection&&document.getSelection();if(!n)return;const e=n.toString(),s=n.anchorNode&&n.anchorNode.parentElement&&n.anchorNode.parentElement.tagName;__logCollect("selectionchange",{length:e.length,container:s||null})}catch{}})}catch{}try{["copy","cut","paste"].forEach(n=>{document.addEventListener(n,e=>{try{__logCollect("clipboard."+n,{})}catch{}})})}catch{}try{if("PerformanceObserver"in window)try{new PerformanceObserver(e=>{e.getEntries().forEach(s=>{try{s.entryType==="longtask"?__logCollect("perf.longtask",{duration:Math.round(s.duration)}):s.entryType==="resource"&&__logCollect("perf.resource",{name:s.name,initiatorType:s.initiatorType,duration:Math.round(s.duration)})}catch{}})}).observe({entryTypes:["longtask","resource"]})}catch{}}catch{}try{const n=EventTarget.prototype.addEventListener;EventTarget.prototype.addEventListener=function(e,s,d){try{__logCollect("addEventListener",{target:this&&this.tagName?this.tagName:this&&this.constructor&&this.constructor.name||"unknown",type:e})}catch{}return n.apply(this,arguments)}}catch{}}catch{}}catch{}window.tryGuardedReload=function(t){t=t||{};const o=typeof t.MAX=="number"?t.MAX:3e4,n=typeof t.RETRY=="number"?t.RETRY:500,e=t&&typeof t.fallback=="function"?t.fallback:null,s=Date.now();(function d(){try{if(!(typeof window.__userInteracting<"u"?window.__userInteracting:!1)){try{window.location.reload()}catch{try{window.location.href=window.location.href}catch{}}return}if(Date.now()-s<o){setTimeout(d,n);return}if(e)try{e()}catch{try{window.location.reload()}catch{}}else try{window.location.reload()}catch{try{window.location.href=window.location.href}catch{}}}catch{if(e)try{e()}catch{try{window.location.reload()}catch{}}else try{window.location.reload()}catch{}}})()}}const initDarkMode=()=>{const r=document.getElementById("theme-toggle");if(!r)return;const i=window.matchMedia("(prefers-color-scheme: dark)").matches,t=localStorage.getItem("theme"),o=t||(i?"dark":"light");document.documentElement.setAttribute("data-theme",o),t||localStorage.setItem("theme",o),r.innerHTML=o==="dark"?'<span style="color: #e1d4c2">\u{1F506}</span>':'<span style="color: #212842">\u{1F319}</span>';const n=()=>{const e=document.documentElement.getAttribute("data-theme"),s=e==="light"?"dark":"light";document.documentElement.setAttribute("data-theme",s),localStorage.setItem("theme",s),r.innerHTML=s==="dark"?'<span style="color: #e1d4c2">\u{1F506}</span>':'<span style="color: #212842">\u{1F319}</span>',typeof clarity=="function"&&clarity("event","theme_toggle",{theme:s}),typeof gtag=="function"&&gtag("event","theme_toggle",{event_category:"user_preference",event_label:s}),r.setAttribute("aria-label",`Switch to ${e} mode`)};window.matchMedia("(prefers-color-scheme: dark)").addEventListener("change",e=>{if(!localStorage.getItem("theme_manual")){const s=e.matches?"dark":"light";document.documentElement.setAttribute("data-theme",s),localStorage.setItem("theme",s),r.innerHTML=s==="dark"?'<span style="color: #e1d4c2">\u{1F506}</span>':'<span style="color: #212842">\u{1F319}</span>'}}),r.addEventListener("click",()=>{n(),localStorage.setItem("theme_manual","true")})},initMobileMenu=()=>{const r=document.getElementById("mobile-menu-toggle"),i=document.getElementById("mobile-menu");if(!r||!i)return;let t=0,o=null;const n=()=>o||(o=document.createElement("div"),o.setAttribute("aria-hidden","true"),o.style.position="fixed",o.style.left="0",o.style.top="0",o.style.right="0",o.style.bottom="0",o.style.zIndex="35",o.style.background="rgba(0,0,0,0.35)",o.addEventListener("click",()=>s()),o),e=()=>{t=window.scrollY;try{const m=n();m.parentElement||document.body.appendChild(m)}catch{}i.classList.remove("hidden"),r.setAttribute("aria-expanded","true"),document.body.style.position="fixed",document.body.style.top=`-${t}px`,document.body.style.width="100%";const h=r.querySelector("svg");h&&(h.style.transform="rotate(90deg)")},s=()=>{if(i.classList.contains("hidden"))return;i.classList.add("hidden"),r.setAttribute("aria-expanded","false"),o&&o.parentElement&&o.parentElement.removeChild(o),document.body.style.position="",document.body.style.top="",document.body.style.width="",window.scrollTo(0,t);const h=r.querySelector("svg");h&&(h.style.transform="rotate(0deg)")},d=()=>{r.getAttribute("aria-expanded")==="true"?s():e()};r.addEventListener("click",h=>{h.preventDefault(),h.stopPropagation(),d()}),document.addEventListener("click",h=>{!r.contains(h.target)&&!i.contains(h.target)&&s()}),document.addEventListener("keydown",h=>{h.key==="Escape"&&s()}),window.addEventListener("hashchange",s),window.addEventListener("popstate",s),i.addEventListener("click",h=>{(h.target.tagName==="A"||h.target.closest("a"))&&s()})},initAriaCurrent=()=>{const r=o=>{try{return o?(o=String(o).split("#")[0].split("?")[0],o.endsWith(".html")&&(o=o.slice(0,-5)),o.length>1&&o.endsWith("/")&&(o=o.slice(0,-1)),o||"/"):"/"}catch{return"/"}},i=r(window.location&&window.location.pathname);document.querySelectorAll("header a[href], #mobile-menu a[href]").forEach(o=>{try{const n=o.getAttribute("href");if(!n||/^(https?:)?\/\//i.test(n)||/^mailto:/i.test(n)||n.startsWith("#"))return;r(n)===i?o.setAttribute("aria-current","page"):o.removeAttribute("aria-current")}catch{}})},initAnimations=()=>{const r=typeof window<"u"&&typeof window.matchMedia=="function"&&window.matchMedia("(max-width: 768px)").matches,i=typeof window<"u"&&typeof window.matchMedia=="function"&&window.matchMedia("(prefers-reduced-motion: reduce)").matches;if(document.querySelectorAll("[data-gsap]").forEach(s=>{s.classList.remove("opacity-0","translate-y-8"),s.style.opacity="1",s.style.transform="none"}),typeof gsap>"u"||typeof ScrollTrigger>"u"){console.warn("GSAP or ScrollTrigger not loaded; revealing content without animations.");return}if(i)return;gsap.registerPlugin(ScrollTrigger),document.querySelectorAll('[data-gsap="fade-up"]').forEach(s=>{const d=s.getAttribute("data-gsap-delay")||0;gsap.from(s,{opacity:0,y:20,duration:.4,delay:parseFloat(d)*.5,ease:"power2.out",scrollTrigger:{trigger:s,start:"top 92%",toggleActions:"play none none none"}})});const n=document.querySelector("section:first-of-type");n&&!r&&!n.classList.contains("no-parallax")&&gsap.to(n,{yPercent:20,ease:"none",scrollTrigger:{trigger:n,start:"top top",end:"bottom top",scrub:!0}}),document.querySelectorAll(".card-hover").forEach(s=>{s.addEventListener("mouseenter",()=>{gsap.to(s,{y:-8,duration:.3,ease:"power2.out"})}),s.addEventListener("mouseleave",()=>{gsap.to(s,{y:0,duration:.3,ease:"power2.out"})})})},loadGSAPAndInit=()=>{const r=typeof window<"u"&&typeof window.matchMedia=="function"&&window.matchMedia("(max-width: 768px)").matches,i=()=>{if(window.gsap&&window.ScrollTrigger){initAnimations();return}const t=document.createElement("script");t.src="https://cdnjs.cloudflare.com/ajax/libs/gsap/3.12.2/gsap.min.js",t.onload=()=>{const o=document.createElement("script");o.src="https://cdnjs.cloudflare.com/ajax/libs/gsap/3.12.2/ScrollTrigger.min.js",o.onload=()=>{initAnimations()},document.body.appendChild(o)},document.body.appendChild(t)};if(r){initAnimations();const t=()=>{["scroll","touchstart","mousemove"].forEach(o=>window.removeEventListener(o,t)),i()};["scroll","touchstart","mousemove"].forEach(o=>window.addEventListener(o,t,{once:!0,passive:!0}))}else i()},initSmoothScroll=()=>{document.addEventListener("click",r=>{const i=r.target.closest("a");if(!i)return;const t=i.getAttribute("href");if(t==="#"){r.preventDefault(),r.stopPropagation();return}if(t&&t.startsWith("#")&&t.length>1){const o=document.querySelector(t);if(o){r.preventDefault();const s=o.getBoundingClientRect().top+window.pageYOffset-100;window.scrollTo({top:s,behavior:"smooth"})}}},{passive:!1})},initFormValidation=()=>{const r=document.querySelector('form[action*="formspree.io"]');if(!r)return;const i=r.querySelectorAll("input, textarea, select"),t=r.querySelector('input[type="file"][name="file"]'),o=5*1024*1024,n=["csv","doc","docx","pdf","txt","xls","xlsx","jpg","jpeg","png","gif","svg","webp"],e=r.querySelector('input[name="link"]'),s=v=>{if(!v)return!0;let _=v.trim();/^https?:\/\//i.test(_)||(_=`https://${_}`);let p;try{p=new URL(_)}catch{return!1}return!["javascript:","data:","file:","blob:","chrome:","chrome-extension:"].includes(p.protocol)};e&&e.addEventListener("blur",()=>{e.value&&!/^https?:\/\//i.test(e.value)&&(e.value=`https://${e.value.trim()}`)});const d=(v,_)=>{v.classList.add("border-red-500");let p=v.parentElement.querySelector(".inline-error");p||(p=document.createElement("p"),p.className="inline-error text-xs text-red-600 mt-1",v.parentElement.appendChild(p)),p.textContent=_},h=v=>{v.classList.remove("border-red-500");const _=v.parentElement.querySelector(".inline-error");_&&_.remove()};i.forEach(v=>{v.addEventListener("blur",()=>{v.hasAttribute("required")&&!v.value.trim()?d(v,"This field is required"):v.type==="email"&&v.value&&!v.checkValidity()?d(v,"Please enter a valid email address"):v.type==="url"&&v.value&&!s(v.value)?d(v,"Please enter a valid URL"):v.checkValidity()?h(v):d(v,v.validationMessage||"Invalid input")}),v.addEventListener("input",()=>{v.classList.contains("border-red-500")&&v.checkValidity()&&v.value.trim()&&h(v)})});let m=r.querySelector("#form-status");m||(m=document.createElement("div"),m.id="form-status",m.className="text-sm mt-3",r.appendChild(m));const C=v=>{const _=r.querySelector('button[type="submit"]');_&&(_.disabled=v,_.classList.toggle("loading",v))},D=async()=>{C(!0),m.textContent="";try{const v=new FormData(r);if(t&&t.files&&t.files[0]){const p=t.files[0],f=(p.name.split(".").pop()||"").toLowerCase();if(!n.includes(f)){m.className="text-sm mt-3 text-red-700",m.textContent="Unsupported file type. Please upload one of: CSV, DOC, DOCX, PDF, TXT, XLS, XLSX, JPG, JPEG, PNG, GIF, SVG, WEBP.",C(!1);return}if(p.size>o){m.className="text-sm mt-3 text-red-700",m.textContent="File too large (max 5MB). Please upload a smaller file.",C(!1);return}}if(e&&e.value&&!s(e.value)){m.className="text-sm mt-3 text-red-700",m.textContent="Please enter a valid link starting with https:// or http://",C(!1);return}if((await fetch(r.action,{method:"POST",body:v,headers:{Accept:"application/json"},mode:"cors",credentials:"omit"})).ok){r.reset();const p=r.parentElement;p&&(p.innerHTML=`
                    ...
                    `,initMiniGame("mini-game-root"))}else{m.className="text-sm mt-3 text-red-700",m.textContent="Sorry, something went wrong. Trying fallback...";try{r.setAttribute("target","_blank"),r.submit()}catch{m.textContent="Sorry, something went wrong. Please try again or email hello@estivanayramia.com."}}}catch{m.className="text-sm mt-3 text-red-700",m.textContent="Network error detected. Opening fallback submit...";try{r.setAttribute("target","_blank"),r.submit()}catch{m.textContent="Network error. Please check your connection or email hello@estivanayramia.com."}}finally{C(!1)}};r.addEventListener("submit",v=>{let _=!0;if(i.forEach(p=>{p.checkValidity()||(_=!1,p.classList.add("border-red-500"))}),v.preventDefault(),!_){const p=r.querySelector(".border-red-500");if(p)try{p.focus({preventScroll:!0})}catch{try{__logCollect&&__logCollect("focus-fallback",{selector:p.tagName+(p.id?"#"+p.id:"")})}catch{}p.focus()}m.className="text-sm mt-3 text-red-700",m.textContent="Please complete required fields highlighted in red.";return}D()})},initMiniGame=r=>{const i=document.getElementById(r);if(!i)return;const t="mgHighScore",o="mgLeaderboard",n=parseInt(localStorage.getItem(t)||"0",10),e=()=>{try{const E=localStorage.getItem(o);if(!E)return[];const B=JSON.parse(E);return Array.isArray(B)?B.filter(l=>typeof l.name=="string"&&typeof l.score=="number").slice(0,25):[]}catch{return[]}},s=E=>{try{localStorage.setItem(o,JSON.stringify(E.slice(0,25)))}catch{}};let d=e();i.innerHTML=`
    ...
    `;const h=i.querySelector("#mg-canvas"),m=i.querySelector("#mg-score"),C=i.querySelector("#mg-mult"),D=i.querySelector("#mg-best"),v=i.querySelector("#mg-lives"),_=i.querySelector("#mg-start"),p=h.getContext("2d"),f=window.devicePixelRatio||1,a={running:!1,score:0,best:n,w:0,h:0,paddle:{x:0,y:0,w:90,h:12},orbs:[],particles:[],lastSpawn:0,orbInterval:900,baseSpeed:2.2,lives:3,combo:0,comboTimer:0,shake:0,t:0},$=()=>{const E=h.getBoundingClientRect();h.width=Math.floor(E.width*f),h.height=Math.floor(320*f),a.w=h.width,a.h=h.height,a.paddle.y=a.h-30*f,a.paddle.x===0&&(a.paddle.x=a.w/2-a.paddle.w*f/2),H()},Y=E=>"\u2764\u2764\u2764".slice(0,E),q=E=>{navigator.vibrate&&navigator.vibrate(E)},W=(E,B,l="#212842",u=10)=>{for(let c=0;c<u;c++)a.particles.push({x:E,y:B,vx:(Math.random()-.5)*3*f,vy:-Math.random()*3*f,life:600,color:l,r:2*f})},F=()=>{const E=(8+Math.random()*2)*f,B=E+Math.random()*(a.w-2*E),l=Math.random()<.15,u=l?"#eab308":"#362017",c=(a.baseSpeed+Math.random()*1.5+a.score*.01)*f;a.orbs.push({x:B,y:E+2,r:E,vy:c,color:u,type:l?"gold":"normal"})},U=()=>{const E=p.createLinearGradient(0,0,a.w,a.h),B=(Math.sin(a.t*.001)+1)/2;E.addColorStop(0,`rgba(${210+20*B|0}, ${200+10*B|0}, 180, 0.6)`),E.addColorStop(1,"rgba(200, 190, 170, 0.6)"),p.fillStyle=E,p.fillRect(0,0,a.w,a.h)},H=()=>{const E=a.shake?Math.random()*a.shake-a.shake/2:0,B=a.shake?Math.random()*a.shake-a.shake/2:0;p.setTransform(1,0,0,1,0,0),p.clearRect(0,0,a.w,a.h),p.translate(E,B),U();const l=Math.min(a.combo,6);p.shadowColor="rgba(33,40,66,0.6)",p.shadowBlur=l*2*f,p.fillStyle="#212842",p.fillRect(a.paddle.x,a.paddle.y,a.paddle.w*f,a.paddle.h*f),p.shadowBlur=0,a.particles.forEach(u=>{p.globalAlpha=Math.max(0,u.life/600),p.fillStyle=u.color,p.beginPath(),p.arc(u.x,u.y,u.r,0,Math.PI*2),p.fill(),p.globalAlpha=1}),a.orbs.forEach(u=>{p.beginPath(),p.fillStyle=u.color,p.shadowColor=u.type==="gold"?"rgba(234,179,8,0.6)":"rgba(54,32,23,0.3)",p.shadowBlur=u.type==="gold"?8*f:4*f,p.arc(u.x,u.y,u.r,0,Math.PI*2),p.fill(),p.shadowBlur=0})},x=E=>{if(!a.running)return;a.last||(a.last=E);const B=E-a.last;a.t+=B,a.last=E,a.comboTimer+=B,a.comboTimer>1600&&a.combo>0&&(a.combo=0,C.textContent="x1"),a.shake>0&&(a.shake=Math.max(0,a.shake-.5*f)),E-a.lastSpawn>a.orbInterval&&(F(),a.lastSpawn=E,a.orbInterval>420&&(a.orbInterval-=8));const l=a.paddle.w*f,u=a.paddle.h*f,c=a.paddle.x,b=a.paddle.y;a.orbs.forEach(L=>{L.y+=L.vy});for(let L=a.particles.length-1;L>=0;L--){const w=a.particles[L];w.x+=w.vx,w.y+=w.vy,w.vy+=.04*f,w.life-=B,w.life<=0&&a.particles.splice(L,1)}for(let L=a.orbs.length-1;L>=0;L--){const w=a.orbs[L];if(w.y+w.r>=b&&w.x>=c&&w.x<=c+l){const y=w.type==="gold"?5:1;a.combo=Math.min(a.combo+1,9),a.comboTimer=0;const S=1+Math.floor(a.combo/3);a.score+=y*S,m.textContent=a.score,C.textContent="x"+S,W(w.x,b,w.color,w.type==="gold"?18:10),a.shake=Math.min(6*f,a.shake+(w.type==="gold"?4:2)),q(w.type==="gold"?25:12),a.orbs.splice(L,1),a.score%10===0&&W(w.x,w.y,"#e1d4c2",24)}else if(w.y-w.r>a.h&&(a.orbs.splice(L,1),a.lives-=1,v.textContent=Y(a.lives),a.combo=0,C.textContent="x1",a.shake=10*f,q(60),a.lives<=0)){j();return}}H(),requestAnimationFrame(x)},j=()=>{a.running=!1,a.score>a.best&&(a.best=a.score,localStorage.setItem(t,String(a.best)),D.textContent=a.best),_.textContent="Restart";const E=document.createElement("div");E.className="mt-3 text-sm text-indigodeep mg-end",E.innerHTML=`
        ...
        `,i.appendChild(E);const B=E.querySelector("#mg-name"),l=E.querySelector("#mg-save"),u=E.querySelector("#mg-view"),c=E.querySelector("#mg-name-error"),b=E.querySelector("#mg-leaderboard");if(!l||!u)return;const L=["fuck","shit","bitch","cunt","dick","piss","cock","asshole","retard","fag","faggot","nigger","nigga","spic","chink","whore","slut","bastard","twat","rape","cum","penis","vagina"],w=k=>k.toLowerCase().replace(/[@]/g,"a").replace(/[$]/g,"s").replace(/0/g,"o").replace(/1/g,"i").replace(/3/g,"e").replace(/4/g,"a").replace(/5/g,"s").replace(/7/g,"t"),y=k=>{const I=w(k).replace(/[_-]/g,"");return!L.some(M=>I.includes(M))},S=/^[A-Za-z0-9_-]{3,16}$/,g=()=>{if(!b)return;let k="<table class='w-full text-xs'><thead><tr class='text-indigodeep'><th class='text-left pb-1'>#</th><th class='text-left pb-1'>User</th><th class='text-right pb-1'>Score</th></tr></thead><tbody>";d.slice(0,10).forEach((I,M)=>{k+=`<tr class='border-t border-chocolate/10'><td class='py-1 pr-2'>${M+1}</td><td class='py-1 pr-2'>${I.name}</td><td class='py-1 text-right'>${I.score}</td></tr>`}),d.length===0&&(k+="<tr><td colspan='3' class='py-2 text-ink/60'>No scores yet.</td></tr>"),k+="</tbody></table>",b.innerHTML=k};u.addEventListener("click",()=>{b.classList.toggle("hidden"),b.classList.contains("hidden")?u.textContent="View Leaderboard":(g(),u.textContent="Hide Leaderboard")}),l.addEventListener("click",()=>{const k=(B.value||"").trim();if(!S.test(k)){c.textContent="Username must be 3-16 chars: letters, numbers, _ or - only.",c.classList.remove("hidden");return}if(!y(k)){c.textContent="Please choose a different name (profanity not allowed).",c.classList.remove("hidden");return}c.classList.add("hidden"),d.push({name:k,score:a.score,ts:Date.now()}),d.sort((I,M)=>M.score-I.score||I.ts-M.ts),d=d.slice(0,25),s(d),g(),b.classList.remove("hidden"),u.textContent="Hide Leaderboard",l.disabled=!0,l.textContent="Saved"})},N=()=>{a.running=!0,a.score=0,m.textContent="0",a.orbs=[],a.particles=[],a.lastSpawn=0,a.orbInterval=900,a.baseSpeed=2.2,a.lives=3,v.textContent=Y(3),a.combo=0,C.textContent="x1",a.t=0,a.shake=0,[...i.querySelectorAll(".mg-end")].forEach(E=>E.remove()),requestAnimationFrame(x)},R=E=>{const B=h.getBoundingClientRect();let l=(E-B.left)*f-a.paddle.w*f/2;l=Math.max(0,Math.min(l,a.w-a.paddle.w*f)),a.paddle.x=l};h.addEventListener("mousemove",E=>R(E.clientX)),h.addEventListener("touchstart",E=>{E.touches[0]&&R(E.touches[0].clientX)},{passive:!0}),h.addEventListener("touchmove",E=>{E.touches[0]&&R(E.touches[0].clientX)},{passive:!0}),window.addEventListener("keydown",E=>{E.key==="ArrowLeft"&&R(h.getBoundingClientRect().left+a.paddle.x/f-24),E.key==="ArrowRight"&&R(h.getBoundingClientRect().left+a.paddle.x/f+24)}),_.addEventListener("click",()=>{_.textContent="Playing...",N()}),window.addEventListener("resize",$),$(),H()},initLazyLoading=()=>{const r=document.querySelectorAll("img[data-src]");if("IntersectionObserver"in window){const i=new IntersectionObserver((t,o)=>{t.forEach(n=>{if(n.isIntersecting){const e=n.target;e.src=e.dataset.src,e.removeAttribute("data-src"),i.unobserve(e)}})});r.forEach(t=>i.observe(t))}else r.forEach(i=>{i.src=i.dataset.src,i.removeAttribute("data-src")})},initPdfPreviews=()=>{try{document.querySelectorAll(".preview-panel").forEach(r=>{try{const i=r.closest("section")||r.parentElement;if(!i)return;const t=i.querySelector('a[href$=".pdf"]');if(!t)return;const o=t.href;r.dataset.pdfLoaded="true";const n=m=>{try{r.innerHTML='<div class="rounded-xl border border-chocolate/20 bg-white/40 overflow-hidden p-8 text-center"><p class="text-sm text-chocolate/70">Inline PDF preview may be blocked by hosting or browser settings. Use the buttons below to open or download the deck.</p></div>',__logCollect&&__logCollect("pdf.preview.fallback",{url:o,reason:m})}catch{}};r.innerHTML=`<div class="py-12 bg-white/30 rounded-xl border border-chocolate/10 flex items-center justify-center min-h-[480px]">
  <div class="text-sm text-chocolate/60 flex items-center gap-2"><svg class="animate-spin h-4 w-4" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"><circle class="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" stroke-width="4"></circle><path class="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z"></path></svg> Loading preview\u2026</div>
        ...
        `,document.body.appendChild(q);const W=q.querySelector(".achievement-close"),F=()=>{q.classList.remove("show"),setTimeout(()=>q.remove(),300)};W.addEventListener("click",F),setTimeout(()=>q.classList.add("show"),100);const U=setTimeout(()=>{document.body.contains(q)&&F()},4e3);W.addEventListener("click",()=>clearTimeout(U))},s=()=>{const m="portfolio_visited_pages";try{const C=JSON.parse(localStorage.getItem(m)||"[]"),D=window.location.pathname.split("/").pop()||"index.html";C.includes(D)||(C.push(D),localStorage.setItem(m,JSON.stringify(C))),["index.html","overview.html","deep-dive.html","about.html","projects.html","contact.html"].every(p=>C.includes(p))&&n("explorer"),D==="deep-dive.html"&&n("reader")}catch{}},d=()=>{const m=document.getElementById("theme-toggle");m&&m.addEventListener("click",()=>n("nightOwl"))},h=()=>{document.querySelectorAll('a[href*="linkedin.com"], a[href*="github.com"]').forEach(m=>{m.addEventListener("click",()=>n("networker"))})};s(),d(),h(),window.unlockAchievement=n},initKonamiCode=()=>{const r=["ArrowUp","ArrowUp","ArrowDown","ArrowDown","ArrowLeft","ArrowRight","ArrowLeft","ArrowRight","b","a"];let i=0;const t=()=>{window.dispatchEvent(new Event("konami-activated")),window.unlockAchievement&&window.unlockAchievement("konami");const n=getCurrentLanguage(),e=translations.konami[n],s=document.createElement("div");s.className="konami-modal",s.innerHTML=`
        ...
        <div class="max-w-7xl mx-auto px-6 lg:px-12">
            ...
            `,document.body&&document.body.appendChild(i)}}catch{}}},__arcadeStorageKey="site_played_games_v1",__safeJsonParse=(r,i)=>{try{return JSON.parse(r)}catch{return i}},__getPlayedGames=()=>{try{const r=localStorage.getItem(__arcadeStorageKey),i=__safeJsonParse(r,{});return i&&typeof i=="object"?i:{}}catch{return{}}},__setPlayedGames=r=>{try{localStorage.setItem(__arcadeStorageKey,JSON.stringify(r||{}))}catch{}},__normalizePath=r=>{try{return(r||"/").replace(/\/+$/,"")||"/"}catch{return"/"}},__getCurrentGameId=()=>{try{const r=document.body&&document.body.getAttribute("data-arcade-achievements-filter");if(r&&/^mini_/.test(r))return r.replace(/^mini_/,"");if(r&&/^arcade_/.test(r))return r.replace(/^arcade_/,"");const i=__normalizePath(window.location.pathname||"/"),t=i.match(/^\/hobbies-games\/(.+)$/);if(t&&t[1])return t[1].replace(/\.html$/i,"");const o=i.split("/").pop()||"";return o.endsWith(".html")?o.replace(/\.html$/i,""):null}catch{return null}},__markGamePlayed=r=>{if(r)try{const i=__getPlayedGames();i[r]={lastPlayedAt:Date.now()},__setPlayedGames(i)}catch{}},__hashString=r=>{let i=2166136261;for(let t=0;t<r.length;t++)i^=r.charCodeAt(t),i=Math.imul(i,16777619);return i>>>0},__mulberry32=r=>{let i=r>>>0;return function(){i+=1831565813;let t=Math.imul(i^i>>>15,1|i);return t^=t+Math.imul(t^t>>>7,61|t),((t^t>>>14)>>>0)/4294967296}},__shuffleInPlace=(r,i)=>{for(let t=r.length-1;t>0;t--){const o=Math.floor(i()*(t+1));[r[t],r[o]]=[r[o],r[t]]}return r},__GAME_CATALOG=[{id:"snake",href:"/snake.html",emoji:"\u{1F40D}",title:"Snake",subtitle:"Classic growth game"},{id:"breaker",href:"/breaker.html",emoji:"\u{1F9F1}",title:"Block Breaker",subtitle:"Smash the bricks"},{id:"2048",href:"/2048.html",emoji:"\u{1F9E9}",title:"2048",subtitle:"Merge the numbers"},{id:"invaders",href:"/invaders.html",emoji:"\u{1F47E}",title:"Space Invaders",subtitle:"Defend the earth"},{id:"racer",href:"/hobbies-games/racer.html",emoji:"\u{1F3CE}\uFE0F",title:"Racer",subtitle:"Fast reflex racing"},{id:"oh-flip",href:"/hobbies-games/oh-flip.html",emoji:"\u{1F938}",title:"Oh Flip",subtitle:"Timing + tricks"},{id:"onoff",href:"/hobbies-games/onoff.html",emoji:"\u26A1",title:"ON/OFF",subtitle:"Switch-based puzzle"},{id:"1024-moves",href:"/hobbies-games/1024-moves.html",emoji:"\u{1F9E0}",title:"1024 Moves",subtitle:"Move-limited strategy"},{id:"back-attacker",href:"/hobbies-games/back-attacker.html",emoji:"\u{1F6E1}\uFE0F",title:"Back Attacker",subtitle:"Survive the attacks"},{id:"nano-wirebot",href:"/hobbies-games/nano-wirebot.html",emoji:"\u{1F916}",title:"Nano Wirebot",subtitle:"Precision platforming"},{id:"off-the-line",href:"/hobbies-games/off-the-line.html",emoji:"\u{1F9F7}",title:"Off The Line",subtitle:"Don\u2019t cross the line"},{id:"pizza-undelivery",href:"/hobbies-games/pizza-undelivery.html",emoji:"\u{1F355}",title:"Pizza Undelivery",subtitle:"Fast food chaos"},{id:"the-matr13k",href:"/hobbies-games/the-matr13k.html",emoji:"\u{1F9EC}",title:"The Matr13k",subtitle:"Pattern puzzle"},{id:"triangle-back-to-home",href:"/hobbies-games/triangle-back-to-home.html",emoji:"\u{1F53A}",title:"Triangle: Back to Home",subtitle:"Geometry adventure"},{id:"xx142-b2exe",href:"/hobbies-games/xx142-b2exe.html",emoji:"\u{1F9EA}",title:"XX142-B2EXE",subtitle:"Experimental arcade"}],__renderSuggestionGrid=(r,i)=>{if(!r)return;const t=i&&i.count?i.count:6,o=i&&i.currentId?i.currentId:null,n=__getPlayedGames(),e=Date.now(),s=__GAME_CATALOG.filter(T=>T&&T.id&&T.href&&T.id!==o),d=s.filter(T=>!n[T.id]),h=s.filter(T=>!!n[T.id]),m=Math.floor(e/864e5),C=parseInt(sessionStorage.getItem("site_suggest_nonce")||"0",10)||0;sessionStorage.setItem("site_suggest_nonce",String(C+1));const D=m*1e3+C+__hashString(String(window.location.pathname||"/")),v=__mulberry32(D);__shuffleInPlace(d,v),h.sort((T,A)=>{const a=n[T.id]&&n[T.id].lastPlayedAt?n[T.id].lastPlayedAt:0,$=n[A.id]&&n[A.id].lastPlayedAt?n[A.id].lastPlayedAt:0;return a-$}),__shuffleInPlace(h,v);const _=[];for(const T of d){if(_.length>=t)break;_.push(T)}for(const T of h){if(_.length>=t)break;_.push(T)}const p="flex flex-col items-center p-4 bg-white/5 rounded-xl hover:bg-white/10 transition-all group border border-white/5 hover:border-white/20",f="text-4xl mb-3 group-hover:scale-110 transition-transform";r.innerHTML=_.map(T=>`
        <a href="${T.href}" class="${p}" data-game-id="${T.id}">
            <div class="${f}">${T.emoji||"\u{1F3AE}"}</div>
            <div class="font-bold text-sm">${T.title||T.id}</div>
            <div class="text-xs opacity-60 mt-1">${T.subtitle||""}</div>
        </a>
    `).join("")},__initDynamicGameSuggestions=()=>{try{const r=__getCurrentGameId();r&&__markGamePlayed(r);const i=new Set;document.querySelectorAll('a[class*="bg-white/5"][class*="rounded-xl"][class*="hover:bg-white/10"]').forEach(t=>{const o=t.closest(".grid");o&&i.add(o)}),i.forEach(t=>{const o=t.querySelectorAll("a");!o||o.length<4||__renderSuggestionGrid(t,{count:6,currentId:r})})}catch{}},init=()=>{console.log("%c Designed by Estivan Ayramia ","background: #212842; color: #e1d4c2; padding: 4px; border-radius: 4px;"),document.readyState==="loading"?document.addEventListener("DOMContentLoaded",()=>{__ensureStandardEnglishChrome(),initDarkMode(),initAriaCurrent(),initMobileMenu(),__initDynamicGameSuggestions(),loadGSAPAndInit(),initSmoothScroll(),initFormValidation(),initLazyLoading(),initScrollToTop(),initPdfPreviews(),initAchievements(),initKonamiCode(),initPWA(),initAnalytics(),initPerformanceMonitoring(),initPhase2()}):(__ensureStandardEnglishChrome(),initDarkMode(),initAriaCurrent(),initMobileMenu(),__initDynamicGameSuggestions(),loadGSAPAndInit(),initSmoothScroll(),initFormValidation(),initLazyLoading(),initScrollToTop(),initPdfPreviews(),initAchievements(),initKonamiCode(),initPWA(),initAnalytics(),initPerformanceMonitoring(),initPhase2())};init(),document.addEventListener("DOMContentLoaded",()=>{const r="https://portfolio-chat.eayramia.workers.dev/chat",i="/assets/docs/Estivan-Ayramia-Resume.pdf",t="https://www.linkedin.com/in/estivanayramia",n={logistics:{title:"Logistics System",summary:"A systems-focused project centered on execution, coordination, and operational clarity.",img:"/assets/img/project-logistics.jpg",link:"/projects/logistics"},conflict:{title:"Conflict Playbook",summary:"A practical framework for navigating conflict with structure, empathy, and outcomes.",img:"/assets/img/project-conflict.jpg",link:"/deep-dive#conflict"},discipline:{title:"Discipline Routine",summary:"A repeatable routine and mindset system for sustainable discipline and follow-through.",img:"/assets/img/project-discipline.jpg",link:"/projects/discipline"},website:{title:"Portfolio Website",summary:"The site you are on, built for speed, clarity, and a clean browsing experience.",img:"/assets/img/og-image.png",link:"/"}},e={widget:document.getElementById("chat-widget"),window:document.getElementById("chat-window"),header:document.getElementById("chat-header"),messages:document.getElementById("chat-messages"),input:document.getElementById("chat-input"),sendBtn:document.getElementById("send-btn"),toggleBtn:document.getElementById("chat-toggle"),closeBtn:document.getElementById("close-chat"),bubble:document.getElementById("welcome-bubble"),chipsContainer:document.getElementById("chat-chips"),suggestionsBtn:document.getElementById("suggestions-btn"),suggestionsContainer:document.querySelector('[data-chat-suggestions="container"]'),suggestionsToggle:document.querySelector('[data-chat-suggestions-toggle="button"]'),suggestionsClose:null};(function(){try{if(window.CSS&&CSS.supports&&CSS.supports("animation-timeline","scroll()"))return}catch{}const u=document.querySelector(".scroll-progress");if(!u)return;let c=!1;function b(){const w=document.documentElement,y=window.scrollY||w.scrollTop||0,S=Math.max((w.scrollHeight||document.body.scrollHeight||0)-window.innerHeight,0),g=S>0?Math.min(1,Math.max(0,y/S)):0;u.style.setProperty("--scroll-scale",g),c=!1}const L=function(){c||(c=!0,requestAnimationFrame(b))};window.addEventListener("scroll",L,{passive:!0}),window.addEventListener("resize",L,{passive:!0}),requestAnimationFrame(b)})();const s=document.documentElement.lang||"en";s==="ar"&&e.widget?(e.widget.style.left="1rem",e.widget.style.right="auto",e.bubble&&(e.bubble.style.left="1rem",e.bubble.style.right="auto")):e.widget&&(e.widget.style.right="1rem",e.widget.style.left="auto",e.bubble&&(e.bubble.style.right="1rem",e.bubble.style.left="auto"));let d=[],h=!1,m=null,C=!1;const D=`savonie_history:v1:${s||"en"}`,v=50;function _(){try{const l=[],u=window.location.pathname||"/";l.push(`path: ${u}`),l.push(`title: ${document.title||""}`);const c=Array.from(document.querySelectorAll("h1, h2")).map(L=>(L.textContent||"").trim()).filter(Boolean).slice(0,10);c.length&&(l.push("headings:"),c.forEach(L=>l.push(`- ${L}`)));const b=l.join(`
`);return b.length>3500?b.slice(0,3500):b}catch{return`${window.location.pathname||"/"} | ${document.title||""}`}}try{const l=sessionStorage.getItem(D);l&&(d=JSON.parse(l),d.forEach(u=>{if(u&&u.kind==="card"){E(u.cardId);return}if(!u||u.kind!=="text")return;const c=document.createElement("div"),b="bg-[#212842] text-white rounded-tr-none self-end ml-auto",L="bg-white text-[#362017] rounded-tl-none border border-[#362017]/5 self-start";c.className=`p-3 rounded-lg shadow-sm max-w-[85%] mb-3 text-sm leading-relaxed ${u.sender==="user"?b:L}`,u.sender==="bot"?c.replaceChildren(U(u.text)):c.textContent=u.text,e.messages?.appendChild(c)}),setTimeout(()=>{e.messages&&(e.messages.scrollTop=e.messages.scrollHeight)},100))}catch{}if(d.length===0){const l=document.documentElement.lang||"en",u=translations.chat.welcome[l]||"Hello! I am Savonie. Ask me anything about Estivan.";R(u,"bot",!1)}if(e.chipsContainer){const l=document.documentElement.lang||"en",u=translations.chat.defaultChips[l]||translations.chat.defaultChips.en;H(u)}C=!0;const p=parseInt(sessionStorage.getItem("savonie_bubble_count")||"0");p<2&&setTimeout(()=>{e.window?.classList.contains("hidden")&&d.length===0&&(e.bubble?.classList.remove("opacity-0","translate-y-4"),e.bubble?.classList.add("opacity-100","translate-y-0"),sessionStorage.setItem("savonie_bubble_count",(p+1).toString()))},2500),e.toggleBtn?.addEventListener("click",x),e.closeBtn?.addEventListener("click",x),e.sendBtn?.addEventListener("click",N),e.input?.addEventListener("keydown",l=>{l.key!=="Enter"||l.target&&l.target.tagName==="TEXTAREA"&&l.shiftKey||(l.preventDefault(),N())});function f(l){if(!e.suggestionsContainer){console.log("[Savonie DEBUG] setSuggestionsVisible called but no suggestions container");return}l?(e.suggestionsContainer.classList.remove("savonie-suggestions-hidden"),e.suggestionsContainer.removeAttribute("hidden"),e.suggestionsContainer.style.display="flex"):(e.suggestionsContainer.classList.add("savonie-suggestions-hidden"),e.suggestionsContainer.setAttribute("hidden","true"),e.suggestionsContainer.style.display="none"),console.log("[Savonie DEBUG] setSuggestionsVisible ->",l,"classes:",e.suggestionsContainer.className)}function T(){if(!e.suggestionsContainer){console.log("[Savonie DEBUG] No suggestions container found on this page");return}e.suggestionsToggle?e.suggestionsToggle.addEventListener("click",()=>{const u=e.suggestionsContainer.classList.contains("savonie-suggestions-hidden")||e.suggestionsContainer.hasAttribute("hidden")||e.suggestionsContainer.style.display==="none";console.log("[Savonie DEBUG] Lightbulb clicked, nextVisible =",u),f(u)}):console.log("[Savonie DEBUG] No suggestions toggle (lightbulb) found"),console.log("[Savonie DEBUG] attachSuggestionHandlers complete")}T(),e.chipsContainer&&e.chipsContainer.querySelectorAll(".chip-btn").forEach(l=>{l.addEventListener("click",()=>{e.input&&(e.input.value=l.textContent,N())})});const A=document.getElementById("mic-btn");let a=null,$=!1;if(A&&("webkitSpeechRecognition"in window||"SpeechRecognition"in window)){const l=window.SpeechRecognition||window.webkitSpeechRecognition;a=new l,a.continuous=!1,a.interimResults=!1,a.lang=document.documentElement.lang||"en-US",a.onstart=()=>{$=!0,A.classList.add("listening"),A.setAttribute("aria-label","Listening...")},a.onend=()=>{$=!1,A.classList.remove("listening"),A.setAttribute("aria-label","Voice input")},a.onresult=u=>{const c=u.results[0][0].transcript;if(e.input&&c){e.input.value=c;try{e.input.focus({preventScroll:!0})}catch{e.input.focus()}}},a.onerror=u=>{console.warn("Speech recognition error:",u.error),$=!1,A.classList.remove("listening")},A.addEventListener("click",()=>{$?a.stop():a.start()})}else A&&(A.style.display="none");function Y(l){const u=[],c=[...l].reverse().find(y=>y.sender==="user")?.text?.toLowerCase()||"",b=[...l].reverse().find(y=>y.sender==="bot")?.text?.toLowerCase()||"",L=q(c),w=translations.chat.contextualSuggestions;return c.includes("skill")||c.includes("technology")||c.includes("expertise")||c.includes("habilidad")||c.includes("tecnolog\xEDa")||c.includes("experiencia")||c.includes("\u0645\u0647\u0627\u0631\u0629")||c.includes("\u062A\u0643\u0646\u0648\u0644\u0648\u062C\u064A\u0627")||c.includes("\u062E\u0628\u0631\u0629")?u.push(...w[L]?.skills||["What projects have you worked on?","Tell me about your experience","What are you learning currently?"]):c.includes("background")||c.includes("experience")||c.includes("career")||c.includes("fondo")||c.includes("experiencia")||c.includes("carrera")||c.includes("\u062E\u0644\u0641\u064A\u0629")||c.includes("\u062E\u0628\u0631\u0629")||c.includes("\u0645\u0633\u064A\u0631\u0629")?u.push(...w[L]?.background||["What are your main skills?","Tell me about your education","What industries have you worked in?"]):c.includes("project")||c.includes("work")||c.includes("portfolio")||c.includes("proyecto")||c.includes("trabajo")||c.includes("portafolio")||c.includes("\u0645\u0634\u0631\u0648\u0639")||c.includes("\u0639\u0645\u0644")||c.includes("\u0645\u062D\u0641\u0638\u0629")?u.push(...w[L]?.projects||["Can you show me your code?","What technologies did you use?","How long did it take to build?"]):c.includes("contact")||c.includes("reach")||c.includes("email")||c.includes("contacto")||c.includes("alcanzar")||c.includes("correo")||c.includes("\u0627\u062A\u0635\u0627\u0644")||c.includes("\u0627\u0644\u0648\u0635\u0648\u0644")||c.includes("\u0628\u0631\u064A\u062F")?u.push(...w[L]?.contact||["Are you available for freelance work?","What's your typical response time?","Do you work remotely?"]):c.includes("education")||c.includes("study")||c.includes("learn")||c.includes("educaci\xF3n")||c.includes("estudio")||c.includes("aprender")||c.includes("\u062A\u0639\u0644\u064A\u0645")||c.includes("\u062F\u0631\u0627\u0633\u0629")||c.includes("\u062A\u0639\u0644\u0645")?u.push(...w[L]?.education||["What certifications do you have?","What's your favorite programming language?","How do you stay updated with technology?"]):b.includes("project")||b.includes("work")||b.includes("proyecto")||b.includes("trabajo")||b.includes("\u0645\u0634\u0631\u0648\u0639")||b.includes("\u0639\u0645\u0644")?u.push(...w[L]?.projectResponse||["Can you tell me more about that project?","What challenges did you face?","What did you learn from it?"]):b.includes("skill")||b.includes("technology")||b.includes("habilidad")||b.includes("tecnolog\xEDa")||b.includes("\u0645\u0647\u0627\u0631\u0629")||b.includes("\u062A\u0643\u0646\u0648\u0644\u0648\u062C\u064A\u0627")?u.push(...w[L]?.skillResponse||["How did you learn that?","Have you used it in projects?","What's your proficiency level?"]):l.length<4&&u.push(...w[L]?.early||["What are your main skills?","Tell me about your background","What projects are you proud of?"]),u.slice(0,3)}function q(l){return l?/[\u0600-\u06FF]/.test(l)?"ar":/\b(qué|como|dónde|cuándo|por qué|está|son|tiene|trabajo|habilidades?|experiencia|proyecto|contacto)\b/i.test(l)?"es":"en":"en"}function W(l){const u=document.createDocumentFragment();if(!l)return u;const c=y=>{try{const S=String(y).trim();if(S.startsWith("/"))return S;const g=new URL(S);return g.protocol!=="http:"&&g.protocol!=="https:"?null:g.toString()}catch{return null}},b=(y,S)=>{const g=document.createElement("a");g.href=y;const k=y.startsWith("/");return g.target=k?"_self":"_blank",k||(g.rel="noopener noreferrer"),g.className="text-[#212842] underline hover:text-[#362017] font-medium",g.textContent=S,g},L=(y,S)=>{const g=/\[([^\]]+)\]\(([^)\s]+)\)|\bhttps?:\/\/[^\s<]+/g,k=String(S);let I=0,M;for(;(M=g.exec(k))!==null;){if(M.index>I&&y.appendChild(document.createTextNode(k.slice(I,M.index))),M[1]&&M[2]){const P=c(M[2]);P?y.appendChild(b(P,M[1])):y.appendChild(document.createTextNode(M[0]))}else{const P=c(M[0]);P?y.appendChild(b(P,M[0])):y.appendChild(document.createTextNode(M[0]))}I=g.lastIndex}I<k.length&&y.appendChild(document.createTextNode(k.slice(I)))},w=String(l).split(/\n/);for(let y=0;y<w.length;y++)L(u,w[y]),y<w.length-1&&u.appendChild(document.createElement("br"));return u}function F(l){const u=document.createElement("template");u.innerHTML=String(l||"");const c=new Set(["P","BR","STRONG","EM","CODE","PRE","UL","OL","LI","A","BLOCKQUOTE"]),b=w=>{if(!w)return null;const y=String(w).trim();if(y.startsWith("/"))return y;try{const S=new URL(y);return S.protocol==="http:"||S.protocol==="https:"?S.toString():null}catch{return null}},L=w=>{const y=Array.from(w.childNodes);for(const S of y)if(S.nodeType===Node.ELEMENT_NODE){const g=S,k=g.tagName,I=k==="A"?g.getAttribute("href"):null;if(!c.has(k)){const P=document.createTextNode(g.textContent||"");g.replaceWith(P);continue}const M=Array.from(g.attributes);for(const P of M)g.removeAttribute(P.name);if(k==="A"){const P=b(I);if(!P){const z=document.createTextNode(g.textContent||"");g.replaceWith(z);continue}g.setAttribute("href",P),P.startsWith("/")?g.setAttribute("target","_self"):(g.setAttribute("target","_blank"),g.setAttribute("rel","noopener noreferrer")),g.className="text-[#212842] underline hover:text-[#362017] font-medium"}L(g)}};return L(u.content),u.content}function U(l){const u=String(l||""),c=typeof window<"u"&&window.marked&&typeof window.marked.parse=="function"?window.marked:null;if(!c)return W(u);const b=u.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;");try{const L=c.parse(b);return F(L)}catch{return W(u)}}window.__savonieXssSelfTest=function(){const u=["<img src=x onerror=alert(1)>","[bad](javascript:alert(1))","[ok](https://example.com)","https://example.com/test?x=<script>alert(1)<\/script>",`Line 1
Line 2 with https://example.com`].map(c=>{const b=document.createElement("div");return b.appendChild(W(c)),b.innerHTML});return console.log("[Savonie] XSS self-test rendered HTML:",u),u};function H(l){if(!e.chipsContainer)return;if(e.chipsContainer.innerHTML="",!l||l.length===0){f(!1);return}const u=["Projects","View Projects","Projects & Case Studies","View projects"],c=["Resume","Download Resume","View Resume","Get resume"],b=["Contact","Email","Email Estivan","Contact Estivan"],L=["LinkedIn","Open LinkedIn"];l.forEach(y=>{const S=document.createElement("button");S.className="chip-btn text-xs bg-white border border-[#212842]/20 text-[#212842] px-3 py-1 rounded-full hover:bg-[#212842] hover:text-white transition-colors",S.textContent=y,S.addEventListener("click",()=>{if(u.includes(y)){window.location.href="/projects.html";return}if(c.includes(y)){try{window.open(i,"_blank","noopener")}catch{}return}if(b.includes(y)){window.location.href="/contact.html";return}if(L.includes(y)){try{window.open(t,"_blank","noopener")}catch{}return}if(y==="Continue reading..."){N("Continue",m);return}e.input&&(e.input.value=y,N())}),e.chipsContainer.appendChild(S)});const w=document.createElement("button");w.className="chip-close-btn text-xs text-[#362017]/60 hover:text-[#362017] px-2 py-1 ml-2 transition-colors",w.setAttribute("data-chat-suggestions-close","button"),w.innerHTML="\xD7",w.title="Hide suggestions",w.addEventListener("click",y=>{y.preventDefault(),y.stopPropagation(),console.log("[Savonie DEBUG] Suggestions close X clicked, hiding suggestions"),f(!1)}),e.chipsContainer.appendChild(w),e.suggestionsClose=w,f(!0)}function x(){const l=e.window?.classList.contains("hidden"),u=document.documentElement.dir==="rtl";if(l?(e.window?.classList.remove("hidden"),e.window?.classList.add("flex"),typeof clarity=="function"&&clarity("event","chat_open"),typeof gtag=="function"&&gtag("event","chat_open",{event_category:"Chatbot"})):(e.window?.classList.remove("flex"),e.window?.classList.add("hidden"),typeof clarity=="function"&&clarity("event","chat_close"),typeof gtag=="function"&&gtag("event","chat_close",{event_category:"Chatbot"})),!e.window?.classList.contains("hidden")){if(l){const c=e.widget?.getBoundingClientRect();if(c){let y=c.left/16,S=c.top/16-31.25-1;y+20>window.innerWidth/16&&(y=window.innerWidth/16-20-1),y<1&&(y=1),S<1&&(S=1),e.window.style.position="fixed",e.window.style.left=`${y}rem`,e.window.style.top=`${S}rem`,e.window.style.right="auto",e.window.style.zIndex="10000"}else e.window.style.position="",e.window.style.left="",e.window.style.top="",e.window.style.right="",e.window.style.zIndex=""}e.bubble&&(e.bubble.style.display="none"),setTimeout(()=>{try{e.input?.focus({preventScroll:!0})}catch{e.input?.focus&&e.input.focus()}e.messages&&(e.messages.scrollTop=e.messages.scrollHeight)},100)}}async function j(){if(navigator.onLine)return!0;try{const l=new AbortController,u=setTimeout(()=>l.abort(),3e3),c=await fetch("/favicon.ico",{method:"HEAD",cache:"no-cache",signal:l.signal});return clearTimeout(u),c.ok}catch{return!1}}async function N(l=null,u=null){if(!e.input)return;const c=typeof l=="string"?l:e.input.value.trim();if(!c||h)return;if(h=!0,typeof gtag=="function"&&gtag("event","chat_question",{event_category:"Chatbot",event_label:"User Asked Question"}),typeof clarity=="function"&&clarity("event","chat_question"),!await j()){R(c,"user"),l||(e.input.value=""),R("You appear to be offline. Please check your connection and try again.","bot"),h=!1;return}R(c,"user"),l||(e.input.value="");const L=R("Thinking...","bot",!0),w=3e4,y=2;let S=null,g=null;for(let k=0;k<=y;k++){const I=new AbortController,M=setTimeout(()=>I.abort(),w);try{const P=await fetch(r,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({message:c,pageContent:_(),language:s,previousContext:u||null}),signal:I.signal});if(clearTimeout(M),console.log("[Chat Debug] Fetch completed. Status:",P.status,"OK:",P.ok),!P.ok){try{const O=await P.json();if(O&&O.errorType){g=O,S=null;break}}catch{}if(P.status>=500||P.status===503||P.status===504){if(S={type:"server",status:P.status},k<y){await new Promise(O=>setTimeout(O,1e3*(k+1)));continue}}else if(P.status===429){S={type:"rate_limit"};break}else{S={type:"client",status:P.status};break}}g=await P.json(),console.log("[Chat Debug] Response parsed successfully:",g),S=null;break}catch(P){if(clearTimeout(M),P.name==="AbortError"){if(S={type:"timeout"},k<y)continue}else if(S={type:"network",message:P.message},k<y){await new Promise(O=>setTimeout(O,1e3*(k+1)));continue}}}if(S){B(L);let k;switch(S.type){case"timeout":k="The request took too long. The AI service might be busy. Please try again in a moment.";break;case"rate_limit":k="Too many requests. Please wait a moment before sending another message.";break;case"server":k="The AI service is temporarily unavailable. Please try again in a few seconds.";break;case"network":k="Connection lost. Please check your internet connection and try again.";break;default:k="Something went wrong. Please try again."}R(k,"bot"),h=!1;return}if(B(L),console.log("[Chat Debug] Processing response. Data structure:",{hasData:!!g,hasErrorType:!!(g&&g.errorType),hasReply:!!(g&&g.reply)}),g&&g.errorType){let k="Something went wrong. Please try again.",I=!1,M=0;if(g.errorType==="RateLimit"?k="Too many requests. Please wait a moment before trying again.":g.errorType==="BadRequest"?k="Please rephrase your question and try again.":g.errorType==="UpstreamError"?k="The AI service is temporarily unavailable. Please try again in a moment.":g.errorType==="UpstreamBusy"?(k="The AI service is experiencing high demand. Retrying automatically in 30 seconds...",I=!0,M=3e4):g.errorType==="AuthError"?k="The AI service is having configuration issues. Please try again later or explore projects directly.":g.errorType==="Timeout"?k="The request timed out. Please try again with a shorter question.":g.errorType==="OfflineMode"&&(k=null),k&&R(k,"bot"),g.errorType!=="OfflineMode"){g.chips&&Array.isArray(g.chips)&&e.chipsContainer&&H(g.chips),I&&!l&&setTimeout(()=>{sendMessage(c,!0)},M),h=!1;return}}if(console.log("[Chat Debug] About to check reply. data.reply exists:",!!g.reply,"Value:",g.reply?g.reply.substring(0,100)+"...":"undefined"),g.reply&&(g.reply=g.reply.replace(/\n?\s*\{\s*"(reply|chips|action|card|errorType)"[\s\S]*$/,"").trim(),R(g.reply,"bot")),g.truncated&&(g.continuation_hint||g.reply)?(m=g.continuation_hint||g.reply.slice(-800),g.chips||(g.chips=[]),g.chips=g.chips.filter(k=>k!=="Continue reading..."),g.chips.unshift("Continue reading...")):m=null,g.chips&&Array.isArray(g.chips)&&e.chipsContainer&&H(g.chips),g.action){if(g.action==="download_resume")try{window.open(i,"_blank","noopener")}catch{const I=document.createElement("a");I.href=i,I.target="_blank",I.rel="noopener noreferrer",I.download="Estivan-Ayramia-Resume.pdf",I.style.display="none",document.body.appendChild(I),I.click(),document.body.removeChild(I)}else if(g.action==="email_link")window.location.href="mailto:hello@estivanayramia.com";else if(g.action==="open_linkedin")try{window.open(t,"_blank","noopener")}catch{}}if(g.card&&E(g.card),!g.chips&&d.length>0){const k=Y(d);k.length>0&&e.chipsContainer&&H(k)}h=!1}function R(l,u,c=!1){if(!e.messages)return;const b=document.createElement("div");b.id=c?"loading-msg":"";const L="bg-[#212842] text-white rounded-tr-none self-end ml-auto",w="bg-white text-[#362017] rounded-tl-none border border-[#362017]/5 self-start";if(b.className=`p-3 rounded-lg shadow-sm max-w-[70%] mb-3 text-sm leading-relaxed ${u==="user"?L:w}`,e.messages.appendChild(b),u==="bot"&&!c){let y=0;b.textContent="";const S=setInterval(()=>{y<l.length?(b.textContent+=l[y],y++,e.messages.scrollTop=e.messages.scrollHeight):(clearInterval(S),b.replaceChildren(U(l)),e.messages.scrollTop=e.messages.scrollHeight)},12)}else u==="bot"?b.replaceChildren(U(l)):b.textContent=l;return!c&&C&&(d.push({kind:"text",text:l,sender:u}),d.length>v&&(d=d.slice(d.length-v)),sessionStorage.setItem(D,JSON.stringify(d))),e.messages.scrollTop=e.messages.scrollHeight,b.id}function E(l){if(!e.messages||!n[l])return;const u=n[l],c=document.createElement("div");c.className="bg-white rounded-lg shadow-md overflow-hidden border border-[#362017]/10 mb-3 max-w-[85%] self-start";const b=document.createElement("div");b.className="p-3";const L=document.createElement("h4");L.className="font-semibold text-[#212842] mb-1",L.textContent=u.title;const w=document.createElement("p");w.className="text-xs text-[#362017]/80 mb-3 leading-relaxed",w.textContent=u.summary||"";const y=document.createElement("a");if(y.href=u.link,y.className="inline-block bg-[#212842] text-white px-4 py-2 rounded-lg text-sm hover:bg-[#362017] transition-colors",y.textContent="View",b.appendChild(L),u.summary&&b.appendChild(w),b.appendChild(y),u.img){const S=document.createElement("img");S.src=u.img,S.alt=u.title,S.className="w-full h-32 object-cover",S.addEventListener("error",()=>{try{S.remove()}catch{}}),c.appendChild(S)}c.appendChild(b),e.messages.appendChild(c),e.messages.scrollTop=e.messages.scrollHeight,C&&(d.push({kind:"card",cardId:l}),d.length>v&&(d=d.slice(d.length-v)),sessionStorage.setItem(D,JSON.stringify(d)))}function B(l){const u=document.getElementById(l);u&&u.remove()}if(e.header&&e.window){let l=!1,u,c,b,L;const w=document.documentElement.dir==="rtl";e.header.style.cursor="move",e.header.addEventListener("mousedown",y=>{if(y.target.closest("#close-chat"))return;l=!0,u=y.clientX,c=y.clientY;const S=e.window.getBoundingClientRect();if(b=S.left,L=S.top,e.header.style.cursor="grabbing",document.body.style.userSelect="none",e.window.style.position!=="fixed"){if(e.window.style.position="fixed",w){const g=window.innerWidth-S.right;e.window.style.right=`${g}px`,e.window.style.left="auto"}else e.window.style.left=`${b}px`;e.window.style.top=`${L}px`,e.window.style.zIndex="10000"}}),document.addEventListener("mousemove",y=>{if(!l)return;y.preventDefault();const S=y.clientX-u,g=y.clientY-c,k=e.window.offsetWidth,I=e.window.offsetHeight,M=10;if(w){let O=window.innerWidth-b-k-S;O=Math.max(M,Math.min(O,window.innerWidth-k-M)),e.window.style.right=`${O}px`,e.window.style.left="auto"}else{let O=b+S;O=Math.max(M,Math.min(O,window.innerWidth-k-M)),e.window.style.left=`${O}px`,e.window.style.right="auto"}let P=L+g;P=Math.max(M,Math.min(P,window.innerHeight-I-M)),e.window.style.top=`${P}px`}),document.addEventListener("mouseup",()=>{l&&(l=!1,e.header.style.cursor="move",document.body.style.userSelect="")})}document.addEventListener("keydown",l=>{l.key==="Escape"&&!e.window?.classList.contains("hidden")&&x(),(l.ctrlKey||l.metaKey)&&l.key==="k"&&(l.preventDefault(),x())})}),document.addEventListener("DOMContentLoaded",()=>{const r=()=>{const t=document.createElement("div");t.className="rounded-xl border border-chocolate/20 bg-white/40 overflow-hidden p-8 text-center";const o=document.createElement("p");return o.className="text-sm text-chocolate/70",o.textContent="Inline PDF preview may be blocked by hosting or browser settings. Use the buttons below to open or download the deck.",t.appendChild(o),t},i=(t,o)=>{if(!t||!o||t.dataset.pdfLoaded)return;t.innerHTML="";const n=document.createElement("div");n.className="py-12 text-sm text-chocolate/60",n.textContent="Attempting to load inline preview\u2026",t.appendChild(n);const e=document.createElement("iframe");e.src=o,e.title="PDF preview",e.style.width="100%",e.style.height="480px",e.style.border="0",e.loading="lazy";let s=!1;const d=setTimeout(()=>{s=!0,console.log("PDF load timeout - assuming success");try{n.remove()}catch{}t.contains(e)||t.appendChild(e),t.dataset.pdfLoaded="true"},5e3),h=()=>{clearTimeout(d);try{e.remove()}catch{}t.innerHTML="",t.appendChild(r()),t.dataset.pdfLoaded="false"};e.addEventListener("load",()=>{clearTimeout(d);try{try{n.remove()}catch{}t.contains(e)||t.appendChild(e),t.dataset.pdfLoaded="true"}catch{h()}}),e.addEventListener("error",h),t.appendChild(e)};document.querySelectorAll(".preview-toggle").forEach(t=>{const o=t.closest("section"),n=o&&o.querySelector(".preview-panel");let e=null;o&&(e=o.querySelector('a[href$=".pdf"]')||o.querySelector('a[href*=".pdf?"]'));const s=e?e.getAttribute("href"):null;n&&s&&i(n,s),t.addEventListener("click",()=>{if(!n)return;n.classList.toggle("hidden");const d=!n.classList.contains("hidden");t.textContent=d?"Hide preview":"Show preview",typeof clarity=="function"&&clarity("event",d?"pdf_preview_show":"pdf_preview_hide"),typeof gtag=="function"&&gtag("event",d?"pdf_preview_show":"pdf_preview_hide",{event_category:"PDF"}),d&&!n.dataset.pdfLoaded&&s&&i(n,s)})})});
